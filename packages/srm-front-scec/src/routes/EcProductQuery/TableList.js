...
export default class TableList extends Component {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        title: intl.get('scec.ecCategoryCatalog.model.ecCategoryCatalog.catalogId').d('集团目录'),
      ...
      {
        title: intl.get('scec.common.model.ecproductCode').d('电商账号'),
        dataIndex: 'userName',
        width: 100,
      },
      {
