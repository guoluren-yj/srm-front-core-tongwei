...
@cacheComponent({ cacheKey: '/scec/ec-product-query/list' })
        ...
        <React.Fragment>
          <Form layout="inline" className="more-fields-form">
                    ...
                    rules: [
                      {
                        required: true,
                        message: intl
                          .get('scec.ecProductQuery.model.choose.ecProductName')
                          .d('请选择电商名称'),
                      },
                    ],
                  })(
            ...
            <Row gutter={12} style={{ display: display ? 'none' : 'block' }}>
              ...
              <Col span={6}>
                <Form.Item
                  label={intl.get('scec.common.model.ecproductCode').d('电商账号')}
                  {...formlayout}
                >
                  {getFieldDecorator('userName')(
                    <Lov code="SCEC.EC_CLIENT_USER_NAME" queryParams={{ tenantId }} />
                  )}
                </Form.Item>
              </Col>
            </Row>
