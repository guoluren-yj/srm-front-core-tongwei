    ...
    return (
      <Form layout="inline" className="more-fields-form">
        ...
        <Row gutter={12} style={{ display: display ? 'none' : 'block' }}>
          ...
          <Col span={6}>
            <FormItem
              label={intl.get('scec.ecMaterielMapping.model.mappingStatus').d('映射状态')}
              {...formLayout}
            >
          ...
          <Col span={6}>
            <FormItem label={intl.get(`${modelPrompt}.ecCategory`).d('分类')} {...formLayout}>
