/**
 * EcCategoryPlatformCatalog -平台目录映射 -form
 * @date: 2019-1-30
...
@CacheComponent({ cacheKey: '/scec/ec-category-platform-catalog' })
    ...
    return (
      <Form layout="inline" className="more-fields-form">
        <Row gutter={12}>
          ...
          <Col span={6}>
            <FormItem label={intl.get(`${modelPrompt}.catalog`).d('平台目录')} {...formLayout}>
              {getFieldDecorator('catalogId')(<Lov code="SCEC.PLATFORM.CATALOG" />)}
            </FormItem>
          </Col>
