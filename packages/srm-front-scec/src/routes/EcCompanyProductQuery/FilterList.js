/**
 * EcCompanyProductQuery -公司电商商品查询 - form页
 * @date: 2019-6-26
...
@cacheComponent({ cacheKey: `/scec/ec-company-product-query` })
                    ...
                    rules: [
                      {
                        ...
                        message: intl.get('hzero.common.validation.notNull', {
                          name: intl
                            .get(`scec.ecCategoryPlatformCatalog.model.e-commerceName`)
                            .d('电商名称'),
                        }),
                      },
                    ],
                ...
                >
                  {getFieldDecorator('ecCategoryId', {
                    rules: [
                      {
                        ...
                        message: intl.get('hzero.common.validation.notNull', {
                          name: intl
                            .get(`scec.ecCategoryPlatformCatalog.model.ecCategory`)
                            .d('电商分类'),
                        }),
                      },
                    ],
                    ...
                    <Lov
                      ...
                      queryParams={{ ecPlatformCode: getFieldValue('ecPlatformCode') }}
