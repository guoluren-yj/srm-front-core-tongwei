...
import { Form, Button, Input, Row, Col, InputNumber, Select } from 'hzero-ui';
...
@CacheComponent({ cacheKey: '/scec/goods-approve/list' })
            ...
            <Row gutter={12}>
              ...
              <Col span={6} className="search-btn-more">
                <Form.Item>
                  ...
                  >
                    {intl.get(`${promptKey}.more.inquire`).d('更多查询')}
                  </Button>
                  <Button
                    style={{ display: display ? 'none' : 'inline-block' }}
                    onClick={() => this.toggleForm()}
                  >
                    {intl.get(`${promptKey}.close.inquire`).d('收起查询')}
                  </Button>
