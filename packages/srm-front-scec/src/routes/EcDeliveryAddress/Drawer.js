...
export default class Drawer extends PureComponent {
  ...
  render() {
    ...
    return (
      ...
      >
        <FormItem
          label={intl.get('scec.ecAcquirerAddress.entity.roles.type').d('类型')}
          {...formLayout}
        >
          {getFieldDecorator('ownerType', { initialValue: 'PERSON' })}
          {getFieldDecorator('ownerTypeMeaning', { initialValue: '个人' })(<Input disabled />)}
        </FormItem>
        <FormItem
