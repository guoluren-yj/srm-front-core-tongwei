/**
 * EcPlatformCategory -平台目录维护 -form
 *
 * @date: 2019-2-2
...
@CacheComponent({ cacheKey: '/scec/ec-platform-category' })
    ...
    return (
      <Form layout="inline" className="more-fields-form">
        <Row gutter={12}>
          <Col span={6}>
            <FormItem
              label={intl.get('scec.ecPlatformCategory.model.catalogCode').d('目录编码')}
              {...formLayout}
            >
          ...
          <Col span={6} className="search-btn-more">
            <FormItem>
              ...
              <Button type="primary" htmlType="submit" onClick={this.fetchEcPlatformCategory}>
