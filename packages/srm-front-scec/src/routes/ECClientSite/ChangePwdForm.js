  ...
  render() {
    ...
    return (
      <Modal
        ...
        title={intl.get('scec.ecClientSite.model.ecClientSite.passwordchange').d('密码修改')}
      ...
      >
        <React.Fragment>
          <FormItem label={intl.get('scec.ecClientSite.model.ecClientSite.password').d('密码')} {...formLayout}>
          ...
          <FormItem label={intl.get('scec.ecClient.model.ecClient.form.clientSecret').d('密钥')} {...formLayout}>
