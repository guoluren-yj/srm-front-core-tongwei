/**
 * ecCategoryCompanyCatalog -公司目录映射 -form
 * @date: 2019-1-30
...
@CacheComponent({ cacheKey: '/scec/ec-category-company-catalog' })
    ...
    return (
      <Form layout="inline" className="more-fields-form">
        <Row gutter={12}>
          ...
          <Col span={6}>
            <FormItem
              label={intl.get('scec.ecCategoryCompanyCatalog.model.catalog').d('公司目录')}
              {...formLayout}
            >
              {getFieldDecorator('catalogId')(
                <Lov code="SCEC.COM.CATALOG" queryParams={{ companyId }} />
              )}
            </FormItem>
          </Col>
