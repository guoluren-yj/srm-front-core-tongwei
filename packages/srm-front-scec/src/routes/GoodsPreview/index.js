...
export default class GoodsPreview extends React.Component {
  ...
  onMouseMove(e) {
    ...
    // const scrollTop =
    //   gbWrapper && gbWrapper.scrollTop || document.body.scrollTop || document.documentElement.scrollTop;
    // const scrollLeft =
    //   gbWrapper && gbWrapper.scrollLeft || document.body.scrollLeft || document.documentElement.scrollLeft;
  ...
  render() {
    const { productImageList = [], detailUrl, is7ToReturn, attributeDetails = [] } = this.state;
