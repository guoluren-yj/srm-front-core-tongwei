/**
 * goodsMaitainService - 电商平台-商品维护 - service
 * @date: 2019-1-14
...
export async function fetchGoodsList(params) {
  ...
  return request(`${SRM_SCEC}/v1/${tenantId}/maintain-products`, {
    method: 'GET',
    query: param,
  });
}
...
export async function saveGoodsInfo(params) {
  return request(`${SRM_SCEC}/v1/${tenantId}/product`, {
    method: 'POST',
    body: params,
  });
}
...
export async function fetchCatalogue(params) {
  return request(`${SRM_SCEC}/v1/${tenantId}/catalogs/linkage`, {
    method: 'GET',
    query: params,
  });
}
...
export async function fetchGoodsCateLogs(params) {
  const param = parseParameters(params);
  return request(`${SRM_SCEC}/v1/${tenantId}/catalogs/${params.companyId}/level-3`, {
    method: 'GET',
    query: param,
  });
}
...
export async function updateCateLog(params) {
  return request(`${SRM_SCEC}/v1/${tenantId}/product/update-catalog/${params.catalogId}`, {
    method: 'PUT',
...
export async function importSourcingList(params) {
  return request(`${SRM_SCEC}/v1/${tenantId}/product/${params.createdParty}/import-source`, {
    method: 'POST',
...
export async function fetchComapnyCurrency(params) {
  return request(`${SRM_MDM}/v1/${tenantId}/currency/company-currency`, {
    method: 'GET',
    query: params,
  });
}
...
export async function deleteAttribute(params) {
  return request(`${SRM_SCEC}/v1/${tenantId}/product-attribute`, {
    method: 'DELETE',
    body: params,
  });
}
