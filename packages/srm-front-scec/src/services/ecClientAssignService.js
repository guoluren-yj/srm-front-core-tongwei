...
import { SRM_SCEI, SRM_SCEC } from '_utils/config';
...
export async function fetchECClientAssign(params) {
  return request(`${SRM_SCEI}/v1/${organizationId}/ec-company-assigns/list`, {
    method: 'GET',
    query: params,
  });
}
...
export async function save(params) {
  return request(`${SRM_SCEI}/v1/${organizationId}/ec-company-assigns`, {
    method: 'POST',
    body: params,
  });
}
