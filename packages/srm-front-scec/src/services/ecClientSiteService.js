...
export async function fetchECClientSite(params) {
  return request(`${SRM_SCEC}/v1/ec-clients/list`, {
    method: 'GET',
    query: params,
  });
}
...
export async function activateAccount(params) {
  return request(`${SRM_SCEC}/v1/ec-clients/check`, {
    method: 'POST',
    body: params,
  });
}
...
export async function saveECClientSite(params) {
  return request(`${SRM_SCEC}/v1/ec-clients`, {
    method: 'POST',
    body: params,
  });
}
...
export async function changePwd(params) {
  return request(`${SRM_SCEC}/v1/ec-clients/modify-password`, {
    method: 'POST',
    body: params,
  });
}
