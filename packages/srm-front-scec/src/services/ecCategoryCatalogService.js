/**
 * ecCategoryCatalog - 电商分类映射租户目录 - service
 * @date: 2019-1-25
 ...
 * @returns
 */
export async function fetchEcCategoryCatalog(params) {
  const param = parseParameters(params);
  return request(`${SRM_SCEC}/v1/${organizationId}/category-catalog-maps`, {
    method: 'GET',
    query: param,
  });
}
