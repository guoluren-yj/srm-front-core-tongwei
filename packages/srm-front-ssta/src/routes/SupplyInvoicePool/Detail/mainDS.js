...
const formDs = () => ({
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'string',
      label: intl.get('ssta.costSheet.model.costSheet.supname').d('销方名称'),
    },
    {
      name: 'supUnifiedSocialCode',
      type: 'string',
      label: intl.get('ssta.costSheet.model.costSheet.suptaxcode').d('销方税号'),
    },
    {
      name: 'supAccount',
      type: 'string',
    ...
    },
    {
      name: 'companyName',
      type: 'string',
      label: intl.get('ssta.costSheet.model.costSheet.buyername').d('购方名称'),
    },
    {
      name: 'purUnifiedSocialCode',
      type: 'string',
      label: intl.get('ssta.costSheet.model.costSheet.purtaxCode').d('购方税号'),
    },
    {
      name: 'purAccount',
      type: 'string',
...
const tableDs = () => ({
  ...
  fields: [
    ...
    },
    {
      name: 'taxRate',
      type: 'number',
      label: intl.get('ssta.costSheet.model.costSheet.invoietaxRate').d('税率'),
    },
    {
      name: 'taxAmount',
      type: 'number',
