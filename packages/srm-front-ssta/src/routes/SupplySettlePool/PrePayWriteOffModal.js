...
import { prePayWriteOffDS } from '../../stores/SupplySettlePoolDS';

const PrePayWriteOffModal = (props) => {
  const { settleHeaderId, customizeTable, settleLineId, history } = props;
  ...
  return (
    <div>
      {customizeTable(
        { code: 'SSTA.SUPPLY_POOL_RECORD.PEYPAYMENT_BOX' },
        <Table
          columns={columns}
