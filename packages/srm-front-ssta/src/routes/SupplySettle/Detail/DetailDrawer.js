...
import { detailDS as detailDs, configDS as configDs } from '../../../stores/SupplySettlePoolDS';
  ...
  return (
    <Spin dataSet={detailDS}>
      <Tabs activeKey={activeKey} animated onChange={handleTabChange}>
        <TabPane
          tab={intl.get('ssta.supplySettle.view.title.settleMainInfo').d('结算主信息')}
          key="main"
        >
          <Card
            bordered={false}
            className={DETAIL_CARD_CLASSNAME}
            title={intl.get('ssta.supplySettle.view.title.transactionParty').d('交易方信息')}
          >
            {customizeForm(
          ...
          <Card
            bordered={false}
            className={DETAIL_CARD_CLASSNAME}
            title={intl.get('ssta.supplySettle.view.title.transactionAmount').d('交易金额信息')}
          >
            {customizeForm(
              {
                code:
          ...
          <Card
            bordered={false}
            className={DETAIL_CARD_CLASSNAME}
            title={intl.get('ssta.supplySettle.view.title.transactionAffair').d('交易事务信息')}
          >
            {customizeForm(
              {
        ...
        <TabPane
          tab={intl.get('ssta.supplySettle.view.title.settleRunInfo').d('结算执行信息')}
          key="run"
        >
          <Card
            bordered={false}
            className={DETAIL_CARD_CLASSNAME}
            title={intl.get('ssta.supplySettle.view.title.billInfo').d('对账信息')}
          >
            <Form dataSet={detailDS} columns={3} useColon={false} labelLayout="vertical">
          ...
          <Card
            bordered={false}
            className={DETAIL_CARD_CLASSNAME}
            title={intl.get('ssta.supplySettle.view.title.billHeaderInfo').d('开票信息')}
          >
            <Form dataSet={detailDS} columns={3} useColon={false} labelLayout="vertical">
          ...
          <Card
            bordered={false}
            className={DETAIL_CARD_CLASSNAME}
            title={intl.get('ssta.supplySettle.view.title.paymentInfo').d('付款信息')}
          >
            <Form dataSet={detailDS} columns={3} useColon={false} labelLayout="vertical">
              ...
              {/* <Output name="invoiceOccupiedTaxAmount" /> */}
        ...
        <TabPane
          tab={intl.get('ssta.supplySettle.view.title.settleStrategyInfo').d('结算策略信息')}
          key="strategy"
        >
          <Card
            bordered={false}
            className={DETAIL_CARD_CLASSNAME}
            title={intl.get('ssta.supplySettle.view.title.settleDataRules').d('结算数据规则')}
          >
            <Form dataSet={detailDS} columns={3} useColon={false} labelLayout="vertical">
          ...
          <Card
            bordered={false}
            className={DETAIL_CARD_CLASSNAME}
            title={intl.get('ssta.supplySettle.view.title.billRules').d('结算单规则')}
          >
            <Form dataSet={detailDS} columns={3} useColon={false} labelLayout="vertical">
