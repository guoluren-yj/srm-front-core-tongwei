...
const PrepaymentAddModal = (props) => {
  ...
  useEffect(() => {
    ...
    prepaymentAddDS.setQueryParameter('supplierSiteId', topRecord.get('supplierSiteId'));
  ...
  return (
    <>
      ...
      <div className="ssta-body-footer">
        <Button onClick={handleSave} color="primary" disabled={isEmpty(prepaymentAddDS.selected)}>
