...
import { DataSet, Modal, ModalContainer, Button } from 'choerodon-ui/pro';
...
import { addModalDS as tableDs } from '../../../stores/PurchaseSettleDS';
import Styles from '@/routes/common.less';
import MultiTextFilter from '@/routes/Components/MultiTextFilter';

const AddModal = (props) => {
  const { addLine, headerData, documentType = 'INVOICE', customizeTable, modal } = props;
  ...
  const code =
    documentType === 'INVOICE'
      ? 'SSTA.PURCHASE_SETTLE_DETAIL.ADD.INVOICE'
      : 'SSTA.PURCHASE_SETTLE_DETAIL.PAYMENT.ADD.LIST';
  const filterCode =
    documentType === 'INVOICE'
      ? 'SSTA.PURCHASE_SETTLE_DETAIL.SEARCH_ADD_INV'
      : 'SSTA.PURCHASE_SETTLE_DETAIL.SEARCH_ADD_PAY';
