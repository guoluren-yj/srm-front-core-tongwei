...
import { invPoolHeaderDS, invPoolLineDS } from '@/stores/NewPurchaseSettleDS';
import Styles from '@/routes/common.less';
import CommonForm from './CommonForm';
import { Store } from '../Detail/StoreProvider';

const customizeUnitCodes = {
  basic: 'SSTA.PURCHASE_SETTLE_DETAIL.TAX_INVOICE.POOL_VIEW.BASIC', // 采购方结算单详情-开票-税务发票-选择发票池-查看-基本信息
  purchase: 'SSTA.PURCHASE_SETTLE_DETAIL.TAX_INVOICE.POOL_VIEW.PURCHASE', // 采购方结算单详情-开票-税务发票-选择发票池-查看-购方信息
  supply: 'SSTA.PURCHASE_SETTLE_DETAIL.TAX_INVOICE.POOL_VIEW.SUPPLY', // 采购方结算单详情-开票-税务发票-选择发票池-查看-销方信息
  other: 'SSTA.PURCHASE_SETTLE_DETAIL.TAX_INVOICE.POOL_VIEW.OTHER', // 采购方结算单详情-开票-税务发票-选择发票池-查看-其他信息
};

const otherCustomizeUnitCodes = {
  line: 'SSTA.PURCHASE_SETTLE_DETAIL.TAX_INVOICE.POOL_VIEW.NEWLINE', // 采购方结算单详情-开票-税务发票-选择发票池-查看-发票行
};
