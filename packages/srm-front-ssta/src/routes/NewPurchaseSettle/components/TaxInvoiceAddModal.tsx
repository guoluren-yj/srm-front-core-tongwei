...
import { taxInvHeaderDS, taxInvLineDS } from '../../../stores/NewPurchaseSettleDS';
import commonStyles from '../../common.less';

const lineUnitCodes = {
  add: 'SSTA.PURCHASE_SETTLE_DETAIL.TAX_INVOICE.LINE_CREATE',
  edit: 'SSTA.PURCHASE_SETTLE_DETAIL.TAX_INVOICE.HEAD_EDIT.LINE_CREATE',
};
const headUnitCodes = {
  add: 'SSTA.PURCHASE_SETTLE_DETAIL.TAX_INVOICE_ADD',
  edit: 'SSTA.PURCHASE_SETTLE_DETAIL.TAX_INVOICE_EDIT',
};
