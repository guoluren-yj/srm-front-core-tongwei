...
const FilterDrawer = (props) => {
  ...
  React.useEffect(() => {
    ...
    reconDs.setQueryParameter('customizeUnitCode', 'SSTA.PURCHASE_SETTLE_DETAIL.LINE_BILL_RECORD');
    invoiceDs.setQueryParameter('customizeUnitCode', 'SSTA.PURCHASE_SETTLE_DETAIL.LINE_INV_RECORD');
    payDs.setQueryParameter('customizeUnitCode', 'SSTA.PURCHASE_SETTLE_DETAIL.LINE_PAY_RECORD');
    detailDS.query();
            ...
            <div className={Styles['ssta-detailDrawer-content']}>
              ...
              >
                <TabPane key={Number(infoIsTable) === 1 ? 'mainFinal' : 'mainRecord'}>
                  {customizeTable(
                    { code: 'SSTA.PURCHASE_SETTLE_DETAIL.LINE_BILL_RECORD' },
            ...
            <div className={Styles['ssta-detailDrawer-content']}>
              ...
              >
                <TabPane key={Number(statusIsTable) === 1 ? 'statusFinal' : 'statusRecord'}>
                  {customizeTable(
                    { code: 'SSTA.PURCHASE_SETTLE_DETAIL.LINE_INV_RECORD' },
                    <Table
            ...
            <div className={Styles['ssta-detailDrawer-content']}>
              ...
              >
                <TabPane key={Number(paymentIsTable) === 1 ? 'paymentFinal' : 'paymentRecord'}>
                  {customizeTable(
                    { code: 'SSTA.PURCHASE_SETTLE_DETAIL.LINE_PAY_RECORD' },
                    <Table
                      columns={payColumns}
                      dataSet={payDs}
                      queryBar="none"
...
export default compose(
  formatterCollections({
    code: ['ssta.purchaseSettlePool', 'ssta.supplySettlePool'],
  }),
  withCustomize({
    unitCode: [
      'SSTA.PURCHASE_SETTLE_DETAIL.MASTER_INFO_DETAIL',
      ...
      'SSTA.PURCHASE_SETTLE_DETAIL.TRADING_PARTY',
      'SSTA.PURCHASE_SETTLE_DETAIL.TRADING.AFFAIRSINFO',
      'SSTA.PURCHASE_SETTLE_DETAIL.LINE_BILL_RECORD',
      'SSTA.PURCHASE_SETTLE_DETAIL.LINE_INV_RECORD',
      'SSTA.PURCHASE_SETTLE_DETAIL.LINE_PAY_RECORD',
