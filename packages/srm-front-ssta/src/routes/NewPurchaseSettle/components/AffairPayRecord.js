...
import { recordDS as recordDs } from '@/stores/PurchaseSettlePoolDS';
import Styles from '@/routes/common.less';
import PrePayWriteOffModal from '../../PurchaseSettlePool/PrePayWriteOffModal';
...
const Record = (props) => {
  ...
  const handlePrePayWriteOff = (record) => {
    Modal.open({
      drawer: true,
      title: intl.get(`ssta.purchaseSettle.button.prePayWriteOffRecordLine`).d('预付款核销记录'),
      closable: true,
