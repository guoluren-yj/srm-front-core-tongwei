...
import { Form, Output, DataSet, Spin, Tabs } from 'choerodon-ui/pro';
      ...
      <Tabs activeKey={activeKey} animated onChange={handleTabChange}>
          ...
          >
            {customizeForm(
              ...
              <Form dataSet={detailDS} columns={3} useColon={false} labelLayout="vertical">
                ...
                <Output name="deliverQuantity" renderer={amountLocalRender} />
        ...
        >
          <Card
            bordered={false}
            className={DETAIL_CARD_CLASSNAME}
            title={intl.get('ssta.reconciliationWorkbench.view.title.billHeaderInfo').d('对账信息')}
          >
            {customizeForm(
              { code: 'SSTA.PURCHASER_BILL_DETAIL_DRAWER.BILL_INFO' },
              <Form dataSet={detailDS} columns={3} useColon={false} labelLayout="vertical">
          ...
          <Card
            ...
            className={DETAIL_CARD_CLASSNAME}
            title={intl
              .get('ssta.reconciliationWorkbench.view.title.invoiceHeaderInfo')
              .d('开票信息')}
          >
            {customizeForm(
              { code: 'SSTA.PURCHASER_BILL_DETAIL_DRAWER.INVOICE_INFO' },
              <Form dataSet={detailDS} columns={3} useColon={false} labelLayout="vertical">
          ...
          <Card
            ...
            className={DETAIL_CARD_CLASSNAME}
            title={intl
              .get('ssta.reconciliationWorkbench.view.title.paymentHeaderInfo')
              .d('付款信息')}
          >
            {customizeForm(
              { code: 'SSTA.PURCHASER_BILL_DETAIL_DRAWER.PAYMENT_INFO' },
              <Form dataSet={detailDS} columns={3} useColon={false} labelLayout="vertical">
