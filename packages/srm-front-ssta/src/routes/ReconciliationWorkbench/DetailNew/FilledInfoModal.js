...
const billCodes = {
  CONFIRM: 'SSTA.PURCHASER_BILL_DETAIL.PRE_CONFIRM',
  RETURN: 'SSTA.PURCHASER_BILL_DETAIL.PRE_RETURN',
  CANCEL: 'SSTA.PURCHASER_BILL_DETAIL.PRE_CANCEL',
};
