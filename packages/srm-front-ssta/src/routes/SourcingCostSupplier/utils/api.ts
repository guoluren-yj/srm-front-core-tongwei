...
export const QueryListUrlMap: Record<ActiveKey, string> = {
  [ActiveKey.TenderAll]: `${apiPrefix}/tender-feess/supplier/page-all`,
  [ActiveKey.TenderInv]: `${apiPrefix}/tender-feess/supplier/page-invoice-able`,
  [ActiveKey.TenderPay]: `${apiPrefix}/tender-feess/supplier/page-payment-able`,
  [ActiveKey.TenderDownload]: `${apiPrefix}/tender-feess/supplier/page-download-able`,
  [ActiveKey.DepositAll]: `${apiPrefix}/deposits/supplier/page-all`,
  [ActiveKey.DepositPay]: `${apiPrefix}/deposits/supplier/page-payment-able`,
  [ActiveKey.DepositReturn]: `${apiPrefix}/deposits/supplier/page-return-able`,
  [ActiveKey.ServiceAll]: `${apiPrefix}/server-feess/supplier/page-all`,
  // [ActiveKey.ServicePay]: `${apiPrefix}/server-feess/supplier/page-payment-able`,
  // [ActiveKey.ServiceInv]: `${apiPrefix}/server-feess/supplier/page-invoice-able`,
};
 ...
 * @returns {object} fetch Promise
 */
export async function getTenderFeePayUrl(params) {
  return request(`${apiPrefix}/tender-feess/payment-application`, {
    method: 'GET',
    query: filterNullValueObject(params),
  });
}
