...
export const payStatusConfirmOtherCode = 'SSTA.DEPOSIT_DETAIL_PUR.PAY_STATUS_CONFIRM_OTHER';
...
const PayStatusConfirm = withCustomize({
  ...
  const remoteVisable = remote ? remote.process('SSTA.SOURCING_COST_PUR_CUX.DEPOSIT_MODAL_FORM_MID_VISABLED', true) : true;
