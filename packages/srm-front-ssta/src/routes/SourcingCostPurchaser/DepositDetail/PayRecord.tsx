...
const PayRecord = () => {
  ...
  const { payRecordDs, workflowBatch, customizeTable, remote, } = useContext<StoreValueType>(Store);
  ...
  const columns = useMemo<ColumnProps[]>(() => {
    ...
    const newColumns = remote ? remote.process('SSTA.DEPOSIT_DETAIL_PUR_CUX.PAY_RECORD_TABLE_COLUMNS', preColumns, {
      payRecordDs,
    }) : preColumns;
