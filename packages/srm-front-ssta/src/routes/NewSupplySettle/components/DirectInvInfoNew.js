    ...
    return [
      {
        ...
        customizeOptions: {
          ...
          code: 'SSTA.SUPPLY_SETTLE_DETAIL.PAY_DIR_BILL_INFO.BASIC',
        },
      },
      {
        key: 'buyer',
        ...
        customizeOptions: {
          ...commonCustomizeOptions,
          code: 'SSTA.SUPPLY_SETTLE_DETAIL.PAY_DIR_BILL_INFO.BUYER',
        },
      },
      {
        key: 'seller',
        ...
        customizeOptions: {
          ...commonCustomizeOptions,
          code: 'SSTA.SUPPLY_SETTLE_DETAIL.PAY_DIR_BILL_INFO.SELLER',
        },
      },
      {
        key: 'ticket',
        ...
        customizeOptions: {
          ...commonCustomizeOptions,
          code: 'SSTA.SUPPLY_SETTLE_DETAIL.PAY_DIR_BILL_INFO.TICKET',
        },
      },
      // {
      //   key: 'other',
      ...
      //   customizeOptions: {
      //     ...commonCustomizeOptions,
      //     code: 'STA.SUPPLY_SETTLE_DETAIL.PAY_DIR_BILL_INFO.OTHER',
      //   },
      // },
    ];
  }, [
