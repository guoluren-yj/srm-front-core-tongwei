...
import { taxInvPoolHeaderDS, taxInvPoolLineDS } from '../../../stores/NewSupplySettleDS';

import commonStyles from '../../common.less';


const headUnitCodes = {
  add: 'SSTA.SUPPLY_SETTLE_DETAIL.ADVANCE_TAXINVOICE_ADD',
  edit: 'SSTA.SUPPLY_SETTLE_DETAIL.ADVANCE_TAXINVOICE_UPDATE',
};
const lineUnitCodes = {
  add: 'SSTA.SUPPLY_SETTLE_DETAIL.ADVANCE_TAXINVOICE_LINE_CREATE',
  edit: 'SSTA.SUPPLY_SETTLE_DETAIL.ADVANCE_TAXINVOICE_LINE_EDIT',
};
