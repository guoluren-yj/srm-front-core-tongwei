...
const formDs = () => ({
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'string',
      bind: 'supplierCompanyLov.displayValue',
    },
    {
    ...
    },
    {
      ...
      type: 'object',
      label: intl
        .get('ssta.supplySettlePool.model.supplySettlePool.purOrganizationIdLov')
        .d('采购组织'),
      ignore: 'always',
      noCache: true,
    ...
    },
    {
      ...
      type: 'object',
      label: intl
        .get('ssta.supplySettlePool.model.supplySettlePool.invOrganizationLov')
        .d('库存组织'),
      ignore: 'always',
...
const tableDs = () => ({
  ...
  transport: {
    ...
    submit: ({ data }) => {
      return {
        url: `/ssta/v1/${organizationId}/charge-lines/batch/save?customizeUnitCode=SSTA.COST_SHEET_SUP_DETAIL.TRANSACTIONDETAIL,SSTA.COST_SHEET_SUP_DETAIL.TRANSACTION_DETAIL_SEARCH`,
        data,
        method: 'PUT',
      };
    },
...
export { formDs, tableDs, lineTableDs, filledInfoDs, sourceDocumentDS };
