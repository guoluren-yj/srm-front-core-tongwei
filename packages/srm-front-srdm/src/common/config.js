...
export const SRM_MALL_HOST = `${process.env.SRM_MALL_HOST}`;
...
// HGMS-BEGIN
export const HZERO_PDM = '/hpdm';
// SRDM-BEGIN
export const HZERO_SRDM = '/srdm';
...
export const VERSION_IS_OP = `${process.env.PLATFORM_VERSION}` === 'SAAS';
