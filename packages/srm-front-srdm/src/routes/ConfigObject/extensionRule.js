...
export function configObjectDSConfig(configObjectDSConfig) {
  return configObjectDSConfig;
}

// eslint-disable-next-line no-shadow
export function syncProductionDSConfig(syncProductionDSConfig) {
  return syncProductionDSConfig;
}
