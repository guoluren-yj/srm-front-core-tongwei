...
!(function (t, e) {
        ...
        i(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              for (var r = e || t.pipe || 'default', i = void 0, o = void 0; r; )
                void 0 !== n.nextAfterChildren &&
                  ...
                  (i = r),
                  (r = null),
                  n && n.next && ((n = n.next), (r = o.nextPipe || n.pipe || i));
        ...
        i(t, [
          {
            ...
            value: function (t) {
              ...
              for (var e = this.debug, r = this.filters.length, i = t, o = 0; o < r; o++) {
                var a = this.filters[o];
                if (
                  (e && this.log('filter: ' + a.filterName),
                  a(i),
                  'object' === (void 0 === i ? 'undefined' : n(i)) && i.exiting)
                ) {
                  i.exiting = !1;
                  break;
                }
          ...
          },
          {
            ...
            value: function (t, e) {
              return (
                ...
                this.children
                  ? ((this.children[this.children.length - 1].next = t), this.children.push(t))
                  : ((this.children = [t]),
  ...
  function p(t) {
    ...
    var e,
      r = {};
    for (var i in t) Object.prototype.hasOwnProperty.call(t, i) && (r[i] = p(t[i]));
    return r;
  }
  var v = (function (t) {
      function e(t, n) {
              ...
              if (
                ...
                var e =
                  'function' == typeof this.options.cloneDiffValues
                    ? this.options.cloneDiffValues
                    : p;
                'object' === n(t[0]) && (t[0] = e(t[0])), 'object' === n(t[1]) && (t[1] = e(t[1]));
              }
        ...
        if (void 0 !== t.left)
          if (void 0 !== t.right) {
            ...
            (t.leftType = null === t.left ? 'null' : n(t.left)),
              ...
              t.leftType === t.rightType && 'boolean' !== t.leftType && 'number' !== t.leftType
                ? ('object' === t.leftType && (t.leftIsArray = m(t.left)),
                  'object' === t.rightType && (t.rightIsArray = m(t.right)),
  ...
  function w(t) {
    if (t && t.children) {
      for (var e = t.children.length, n = void 0, r = t.result, i = 0; i < e; i++)
        void 0 !== (n = t.children[i]).result && ((r = r || {})[n.childName] = n.result);
    ...
    if (!t.leftIsArray && 'object' === t.leftType) {
      ...
      for (e in t.left)
        Object.prototype.hasOwnProperty.call(t.left, e) &&
          ((r && !r(e, t)) || ((n = new v(t.left[e], t.right[e])), t.push(n, e)));
      for (e in t.right)
        Object.prototype.hasOwnProperty.call(t.right, e) &&
          ((r && !r(e, t)) ||
            (void 0 === t.left[e] && ((n = new v(void 0, t.right[e])), t.push(n, e))));
      t.children && 0 !== t.children.length ? t.exit() : t.setResult(void 0).exit();
    }
  }
  (x.filterName = 'trivial'), (w.filterName = 'collectChildren'), (k.filterName = 'objects');
  var j = function (t) {
  ...
  var A = function (t) {
    if (t && t.children && !t.delta._t) {
      for (var e = t.children.length, n = void 0, r = 0; r < e; r++)
        (n = t.children[r]),
          Object.prototype.hasOwnProperty.call(t.left, n.childName) && void 0 === n.result
            ? delete t.left[n.childName]
            : t.left[n.childName] !== n.result && (t.left[n.childName] = n.result);
  ...
  function M(t) {
    if (t && t.children && !t.delta._t) {
      for (var e = t.children.length, n = void 0, r = {}, i = 0; i < e; i++)
        r[(n = t.children[i]).childName] !== n.result && (r[n.childName] = n.result);
      t.setResult(r).exit();
    }
  }
  ...
  var R = function (t, e, n, r) {
    ...
    C = function (t, e, n, r) {
      var i = r || {},
        o = (function (t, e, n, r) {
          for (
            var i = e.length, o = n.length, a = { sequence: [], indices1: [], indices2: [] };
            0 !== i && 0 !== o;
          ...
          (function (t, e, n, r) {
            var i = t.length,
              ...
              s = void 0,
              f = [i + 1];
            for (a = 0; a < i + 1; a++) for (f[a] = [o + 1], s = 0; s < o + 1; s++) f[a][s] = 0;
    ...
    P =
      'function' == typeof Array.prototype.indexOf
        ...
        : function (t, e) {
            for (var n = t.length, r = 0; r < n; r++) if (t[r] === e) return r;
            return -1;
          };
    ...
    return (
      'number' == typeof r
        ? ((o.hashCache1 = o.hashCache1 || []),
          void 0 === (l = o.hashCache1[r]) && (o.hashCache1[r] = l = f(a, r)))
        : (l = f(a)),
      void 0 !== l &&
        ('number' == typeof i
          ? ((o.hashCache2 = o.hashCache2 || []),
            void 0 === (h = o.hashCache2[i]) && (o.hashCache2[i] = h = f(s, i)))
          : (h = f(s)),
        void 0 !== h && l === h)
    );
  }
  var T = function (t) {
    if (t.leftIsArray) {
      ...
      for (; r + n < l && r + n < h && D(s, f, l - 1 - r, h - 1 - r, e); )
        (o = l - 1 - r), (a = h - 1 - r), (u = new v(t.left[o], t.right[a])), t.push(u, a), r++;
      var c = void 0;
      if (n + r !== l)
        if (n + r !== h) {
          ...
          for (c = c || { _t: 'a' }, i = n; i < l - r; i++)
            P(g.indices1, i - n) < 0 && ((c['_' + i] = [s[i], 0, 0]), y.push(i));
          var m = !0;
          ...
          for (c = c || { _t: 'a' }, i = n; i < l - r; i++) c['_' + i] = [s[i], 0, 0];
          t.setResult(c).exit();
        }
      else {
  ...
  var F = function (t) {
    if (t.nested) {
      if ('a' === t.delta._t) {
        var e = void 0,
          n = void 0;
        for (e in t.delta) '_t' !== e && ((n = new y(t.delta[e])), t.push(n, e));
        t.exit();
      }
    } else
      3 === t.delta[2] &&
        ((t.newName = '_' + t.delta[1]),
        t.setResult([t.delta[0], parseInt(t.childName.substr(1), 10), 3]).exit());
  };
  F.filterName = 'arrays';
  ...
  function V(t) {
    if (t && t.children && 'a' === t.delta._t) {
      for (var e = t.children.length, n = void 0, r = { _t: 'a' }, i = 0; i < e; i++) {
        var o = (n = t.children[i]).newName;
        void 0 === o && (o = L(t.delta, n.childName, n.result)),
      ...
      ((function (t) {
        ...
        (e.prototype.diff_main = function (t, e, n, r) {
              ...
              switch (i[o][0]) {
                ...
                case 0:
                  if (a >= 1 && s >= 1) {
                    ...
                    for (var h, u = (h = this.diff_main(f, l, !1, n)).length - 1; u >= 0; u--)
                      i.splice(o, 0, h[u]);
                    o += h.length;
                  }
                  (s = 0), (a = 0), (f = ''), (l = '');
          ...
          (e.prototype.diff_bisect_ = function (t, e, n) {
            ...
            (f[a + 1] = 0), (l[a + 1] = 0);
            for (
              var u = r - i, c = u % 2 != 0, d = 0, p = 0, v = 0, g = 0, y = 0;
              ...
              for (var m = -y + d; m <= y - p; m += 2) {
                for (
                  var _ = a + m,
                    b =
                      (A = m == -y || (m != y && f[_ - 1] < f[_ + 1]) ? f[_ + 1] : f[_ - 1] + 1) -
                      m;
                  A < r && b < i && t.charAt(A) == e.charAt(b);
                ...
                if (((f[_] = A), A > r)) p += 2;
                  ...
                  if ((k = a + u - m) >= 0 && k < s && -1 != l[k])
                    if (A >= (w = r - l[k])) return this.diff_bisectSplit_(t, e, A, b, n);
                }
              }
              for (var x = -y + v; x <= y - g; x += 2) {
                for (
                  var w,
                    k = a + x,
                    j =
                      (w = x == -y || (x != y && l[k - 1] < l[k + 1]) ? l[k + 1] : l[k - 1] + 1) -
                      x;
                  w < r && j < i && t.charAt(r - w - 1) == e.charAt(i - j - 1);
                ...
                if (((l[k] = w), w > r)) g += 2;
                  ...
                  if ((_ = a + u - x) >= 0 && _ < s && -1 != f[_]) {
                    var A;
                    b = a + (A = f[_]) - _;
                    if (A >= (w = r - w)) return this.diff_bisectSplit_(t, e, A, b, n);
                  }
                }
              }
            }
          ...
          (e.prototype.diff_halfMatch_ = function (t, e) {
            ...
            function o(t, e, n) {
              for (
                var r, o, a, s, f = t.substring(n, n + Math.floor(t.length / 4)), l = -1, h = '';
                -1 != (l = e.indexOf(f, l + 1));

              ) {
                var u = i.diff_commonPrefix(t.substring(n), e.substring(l)),
                  c = i.diff_commonSuffix(t.substring(0, n), e.substring(0, l));
                h.length < c + u &&
          ...
          (e.prototype.diff_cleanupSemantic = function (t) {
            for (
              var e = !1, n = [], r = 0, i = null, o = 0, a = 0, s = 0, f = 0, l = 0;
              o < t.length;

            )
              0 == t[o][0]
                ? ((n[r++] = o), (a = f), (s = l), (f = 0), (l = 0), (i = t[o][1]))
                : (1 == t[o][0] ? (f += t[o][1].length) : (l += t[o][1].length),
                  i &&
                ...
                o++;
            for (
              e && this.diff_cleanupMerge(t), this.diff_cleanupSemanticLossless(t), o = 1;
              o < t.length;
              ...
              if (-1 == t[o - 1][0] && 1 == t[o][0]) {
                ...
                c >= d
                  ? (c >= h.length / 2 || c >= u.length / 2) &&
                    (t.splice(o, 0, [0, u.substring(0, c)]),
                    (t[o - 1][1] = h.substring(0, h.length - c)),
                    (t[o + 1][1] = u.substring(c)),
                    o++)
                  : (d >= h.length / 2 || d >= u.length / 2) &&
                    (t.splice(o, 0, [0, h.substring(0, d)]),
                    (t[o - 1][0] = 1),
                    (t[o - 1][1] = u.substring(0, u.length - d)),
                    (t[o + 1][0] = -1),
                    (t[o + 1][1] = h.substring(d)),
                    o++),
                  o++;
              }
              o++;
          ...
          (e.prototype.diff_cleanupSemanticLossless = function (t) {
            function n(t, n) {
              ...
              return u || c ? 5 : l || h ? 4 : o && !s && f ? 3 : s || f ? 2 : o || a ? 1 : 0;
            }
          ...
          (e.prototype.diff_cleanupEfficiency = function (t) {
            for (
              var e = !1, n = [], r = 0, i = null, o = 0, a = !1, s = !1, f = !1, l = !1;
              o < t.length;

            )
              0 == t[o][0]
                ? (t[o][1].length < this.Diff_EditCost && (f || l)
                    ? ((n[r++] = o), (a = f), (s = l), (i = t[o][1]))
                    : ((r = 0), (i = null)),
                  (f = l = !1))
                : (-1 == t[o][0] ? (l = !0) : (f = !0),
                  i &&
                    ((a && s && f && l) ||
                      (i.length < this.Diff_EditCost / 2 && a + s + f + l == 3)) &&
                    (t.splice(n[r - 1], 0, [-1, i]),
                    (t[n[r - 1] + 1][0] = 1),
                    r--,
                    (i = null),
          ...
          (e.prototype.match_bitap_ = function (t, e, n) {
            ...
            -1 != s &&
              ((a = Math.min(o(0, s), a)),
              -1 != (s = t.lastIndexOf(e, n + e.length)) && (a = Math.min(o(0, s), a)));
            var f,
              l,
              h = 1 << (e.length - 1);
            s = -1;
            for (var u, c = e.length + t.length, d = 0; d < e.length; d++) {
              for (f = 0, l = c; f < l; )
                o(d, n + l) <= a ? (f = l) : (c = l), (l = Math.floor((c - f) / 2 + f));
              c = l;
              ...
              for (var y = v; y >= p; y--) {
                ...
                if (
                  ((g[y] =
                    0 === d
                      ? ((g[y + 1] << 1) | 1) & m
                      : (((g[y + 1] << 1) | 1) & m) | ((u[y + 1] | u[y]) << 1) | 1 | u[y + 1]),
                  g[y] & h)
                ) {
                  var _ = o(d, y - 1);
                  if (_ <= a) {
          ...
          (e.prototype.patch_make = function (t, n, r) {
            var i, o;
            if ('string' == typeof t && 'string' == typeof n && void 0 === r)
              (i = t),
                (o = this.diff_main(i, n, !0)).length > 2 &&
                  (this.diff_cleanupSemantic(o), this.diff_cleanupEfficiency(o));
            else if (t && 'object' == typeof t && void 0 === n && void 0 === r)
              (o = t), (i = this.diff_text1(o));
            else if ('string' == typeof t && n && 'object' == typeof n && void 0 === r)
              (i = t), (o = n);
            else {
              if ('string' != typeof t || 'string' != typeof n || !r || 'object' != typeof r)
                throw new Error('Unknown call format to patch_make.');
              (i = t), (o = r);
            }
            if (0 === o.length) return [];
            for (
              var a = [], s = new e.patch_obj(), f = 0, l = 0, h = 0, u = i, c = i, d = 0;
              d < o.length;
              d++
            ) {
              var p = o[d][0],
              ...
              switch ((f || 0 === p || ((s.start1 = l), (s.start2 = h)), p)) {
                case 1:
                  (s.diffs[f++] = o[d]),
                    (s.length2 += v.length),
                    (c = c.substring(0, h) + v + c.substring(h));
                  break;
                case -1:
                  (s.length1 += v.length),
                    (s.diffs[f++] = o[d]),
                    (c = c.substring(0, h) + c.substring(h + v.length));
                  break;
                case 0:
                  v.length <= 2 * this.Patch_Margin && f && o.length != d + 1
                    ? ((s.diffs[f++] = o[d]), (s.length1 += v.length), (s.length2 += v.length))
            ...
            for (var r = 0, i = [], o = 0; o < t.length; o++) {
              ...
              if (
                (l.length > this.Match_MaxBits
                  ? -1 != (a = this.match_main(e, l.substring(0, this.Match_MaxBits), f)) &&
                    (-1 ==
                      (h = this.match_main(
                        e,
                        l.substring(l.length - this.Match_MaxBits),
                        f + l.length - this.Match_MaxBits
                      )) ||
                      a >= h) &&
                    (a = -1)
                  : (a = this.match_main(e, l, f)),
                -1 == a)
              )
                ...
                l ==
                  (s =
                    -1 == h
                      ? e.substring(a, a + l.length)
                      : e.substring(a, h + this.Match_MaxBits)))
              )
                e = e.substring(0, a) + this.diff_text2(t[o].diffs) + e.substring(a + l.length);
              else {
                var u = this.diff_main(l, s, !1);
                if (
                  l.length > this.Match_MaxBits &&
                  this.diff_levenshtein(u) / l.length > this.Patch_DeleteThreshold
                )
                  i[o] = !1;
                else {
                  ...
                  for (var c, d = 0, p = 0; p < t[o].diffs.length; p++) {
                    var v = t[o].diffs[p];
                    0 !== v[0] && (c = this.diff_xIndex(u, d)),
                      1 === v[0]
                        ? (e = e.substring(0, a + c) + v[1] + e.substring(a + c))
                        : -1 === v[0] &&
                          (e =
                            e.substring(0, a + c) +
                            e.substring(a + this.diff_xIndex(u, d + v[1].length))),
                      -1 !== v[0] && (d += v[1].length);
                  }
                }
              }
              ...
              if (!(t[r].length1 <= n)) {
                ...
                for (var o = i.start1, a = i.start2, s = ''; 0 !== i.diffs.length; ) {
                  ...
                  for (
                    f.start1 = o - s.length,
                      f.start2 = a - s.length,
                      '' !== s && ((f.length1 = f.length2 = s.length), f.diffs.push([0, s]));
                    0 !== i.diffs.length && f.length1 < n - this.Patch_Margin;
                    ...
                    1 === h
                      ? ((f.length2 += u.length),
                        ...
                        (l = !1))
                      : -1 === h && 1 == f.diffs.length && 0 == f.diffs[0][0] && u.length > 2 * n
                      ? ((f.length1 += u.length),
                        (o += u.length),
                        (l = !1),
                        f.diffs.push([h, u]),
                        i.diffs.shift())
                      : ((u = u.substring(0, n - f.length1 - this.Patch_Margin)),
                        (f.length1 += u.length),
                        (o += u.length),
                        0 === h ? ((f.length2 += u.length), (a += u.length)) : (l = !1),
                        f.diffs.push([h, u]),
                        u == i.diffs[0][1]
                          ? i.diffs.shift()
    ...
    $ = function (t) {
      if (!z) {
        ...
        z = {
          ...
          patch: function (t, n) {
            for (var r = e.patch_apply(e.patch_fromText(n), t), i = 0; i < r[1].length; i++) {
              if (!r[1][i]) new Error('text patch failed').textPatchFailed = !0;
            }
            return r[0];
          },
        };
  ...
  var K = function (t) {
      ...
      for (n = 0, e = (r = t.split('\n')).length; n < e; n++) {
        ...
        '@' === f
          ...
          : '+' === f
          ? ((r[n] = '-' + r[n].slice(1)),
            '+' === r[n - 1].slice(0, 1) && ((o = r[n]), (r[n] = r[n - 1]), (r[n - 1] = o)))
          : '-' === f && (r[n] = '+' + r[n].slice(1));
      }
      return r.join('\n');
    },
    Z = function (t) {
      t.nested || (2 === t.delta[2] && t.setResult([K(t.delta[0]), 0, 2]).exit());
    };
  Z.filterName = 'texts';
  var W = (function () {
      function t(e) {
        r(this, t),
          ...
          this.processor.pipe(new u('diff').append(w, _, q, Q, k, T).shouldHaveResult()),
          this.processor.pipe(new u('patch').append(A, B, b, J, j, S).shouldHaveResult()),
          this.processor.pipe(new u('reverse').append(M, V, x, Z, O, F).shouldHaveResult());
      }
      return (
        i(t, [
          {
        ...
        i(t, [
          ...
          },
          {
            ...
            value: function (t, e, n, r, i, o, a) {
              ...
              if (void 0 !== e || void 0 !== r) {
                ...
                try {
                  (this['format_' + f] || this.typeFormattterNotFound(t, f)).call(
                    this,
                    t,
                    e,
                    s,
                  ...
                  this.typeFormattterErrorFormatter(t, n, e, s, r, i, o),
                    'undefined' != typeof console && console.error && console.error(n.stack);
                }
              ...
              if (void 0 !== e)
                for (s in e)
                  Object.prototype.hasOwnProperty.call(e, s) &&
                    (void 0 !== t[s] || (o && void 0 !== t['_' + s]) || i.push(s));
              for (s in t)
                if (Object.prototype.hasOwnProperty.call(t, s)) {
                  var f = t[s];
                  X(f) &&
                    3 === f[2] &&
                    ((a[f[1].toString()] = { key: s, value: e && e[parseInt(s.substr(1))] }),
              ...
              for (var l = 0, h = i.length; l < h; l++) {
                ...
                if (!o || '_t' !== u) {
                  var c = o
                      ? 'number' == typeof u
                        ? u
                        : parseInt('_' === (r = u).substr(0, 1) ? r.slice(1) : r, 10)
                      : u,
                    d = l === h - 1;
                  n(u, c, a[c], d);
                }
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              } else if ('object' === (void 0 === t ? 'undefined' : n(t))) return 'node';
              return 'unknown';
            },
          },
          {
    ...
    rt = (function (t) {
      function e() {
        return (
          r(this, e), s(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments))
        );
      }
      return (
        a(e, et),
        i(e, [
          ...
          },
          {
            ...
            value: function (t, e) {
              t.out('<div class="jsondiffpatch-value jsondiffpatch-left-value">'),
                this.formatValue(t, e[0]),
                t.out('</div><div class="jsondiffpatch-value jsondiffpatch-right-value">'),
          ...
          },
          {
            ...
            value: function (t, e) {
              t.out('<div class="jsondiffpatch-value">'),
                this.formatValue(t, e[0]),
                t.out('</div><div class="jsondiffpatch-moved-destination">' + e[1] + '</div>'),
                t.out(
      ...
      !(function (t, e, n) {
        ...
        if (
          ...
          try {
            ...
            o.setAttribute('height', Math.abs(d) + 6), (r.top = -8 + (d > 0 ? 0 : d) + 'px');
            var p =
              d > 0
  ...
  var ft = Object.freeze({
            ...
            value: function (t, e) {
              ...
              for (var r = 0, i = n.length; r < i; r++) {
                ...
                for (var a = o.pieces, s = 0, f = a.length; s < f; s++) {
                  var l = a[s];
                  t.out(
                    '<span class="jsondiffpatch-textdiff-' + l.type + '">' + l.text + '</span>'
                  );
                }
                t.out('</div></li>');
              }
          ...
          },
          {
            ...
            value: function (t, e, n) {
              t.out('<table class="jsondiffpatch-annotated-delta">'),
                ...
                'array' === n &&
                  t.row('"_t": "a",', 'Array delta (member names indicate array indices)');
            },
          },
          {
            key: 'rootEnd',
    ...
    ut = {
      ...
      textdiff: function (t, e, n, r) {
        return (
          'text diff' +
          (void 0 === r ? '' : 'number' == typeof r ? ' at index ' + r : ' at property ' + ht(r)) +
            ...
            value: function (t) {
              o(
                ...
                (t.pushMoveOp = function (t) {
                  ...
                  this.result.push({ op: mt, from: e, path: this.toPath(t) });
                }),
  ...
  var Ct = {
      added: Rt('green'),
      deleted: Rt('red'),
      movedestination: Rt('gray'),
      moved: Rt('yellow'),
      unchanged: Rt('gray'),
      error: Rt('white.bgRed'),
      textDiffLine: Rt('gray'),
    },
    Et = (function (t) {
      function e() {
        r(this, e);
      ...
      return (
        ...
        i(e, [
          ...
          },
          {
            key: 'typeFormattterErrorFormatter',
            value: function (t, e) {
              t.pushColor(Ct.error), t.out('[ERROR]' + e), t.popColor();
            },
          },
          {
            key: 'formatValue',
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              for (var r = 0, i = n.length; r < i; r++) {
                var o = n[r];
                t.pushColor(Ct.textDiffLine),
                  t.out(o.location.line + ',' + o.location.chr + ' '),
                  t.popColor();
                for (var a = o.pieces, s = 0, f = a.length; s < f; s++) {
                  var l = a[s];
                  t.pushColor(Ct[l.type]), t.out(l.text), t.popColor();
                }
                r < i - 1 && t.outLine();
              }
              t.indent(-1);
          ...
          },
          {
            key: 'rootBegin',
            value: function (t, e, n) {
              t.pushColor(Ct[e]), 'node' === e && (t.out('array' === n ? '[' : '{'), t.indent());
            },
          },
          {
            key: 'rootEnd',
          ...
          },
          {
            key: 'nodeEnd',
            value: function (t, e, n, r, i, o) {
              'node' === r && (t.indent(-1), t.out('array' === i ? ']' : '}' + (o ? '' : ','))),
                o || t.outLine(),
                t.popColor();
            },
          },
          ...
          },
          {
            key: 'format_modified',
            value: function (t, e) {
              t.pushColor(Ct.deleted),
                this.formatValue(t, e[0]),
                t.popColor(),
                t.out(' => '),
                t.pushColor(Ct.added),
                this.formatValue(t, e[1]),
                t.popColor();
            },
          },
    ...
    Pt = void 0,
    Dt = function (t, e) {
      return Pt || (Pt = new Et()), Pt.format(t, e);
    };
  var Tt = Object.freeze({
    ...
    Nt = Object.freeze({ base: nt, html: ft, annotated: pt, jsonpatch: Mt, console: Tt });
  var It = void 0;
  (t.DiffPatcher = W),
    (t.formatters = Nt),
    (t.console = Tt),
