...
} from '@/services/sbid/bidEventQueryService';
    ...
    *fetchExpertsInfo({ payload }, { call, put }) {
      ...
      if (result) {
        yield put({
          type: 'updateState',
          payload: {
            scoringNoneExpert: dealDataState(result.nones),
            scoringBusinessExpert: dealDataState(result.business),
            scoringTechnologyExpert: dealDataState(result.technology),
          },
        });
      }
    },
