...
export default {
  namespace: 'demandForecastFeedback',
  ...
  effects: {
    ...
    *fetchList({ payload }, { call, put }) {
      ...
      const result = getResponse(yield call(fetchListSupplier, otherParams));
      if (result) {
        yield put({
          type: 'updateState',
          payload: {
    ...
    *fetchOperationRecordList({ payload }, { call }) {
    ...
    // fetchFeedback
    *fetchFeedback({ payload }, { call }) {
      const data = getResponse(yield call(fetchFeedback, payload));
      return data;
    },
    // fetchSupplySave
    *fetchSupplySave({ payload }, { call }) {
      const data = getResponse(yield call(fetchSupplySave, payload));
      return data;
    },
  },
  reducers: {
