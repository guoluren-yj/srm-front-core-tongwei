 ...
 */
export async function fetchHeaderConfig(params) {
  return request(`${SRM_SIEC}/v1/${organizationId}/feedback-import/table-list`, {
    method: 'GET',
    query: params,
  });
}
...
export async function validateData(params) {
  const reqUrl = `${SRM_SIEC}/v1/${organizationId}/feedback-import/data-validate`;
  return request(reqUrl, {
    method: 'POST',
    query: params,
  });
...
export async function importData(params) {
  const reqUrl = `${SRM_SIEC}/v1/${organizationId}/feedback-import/data-upload`;
  return request(reqUrl, {
    method: 'POST',
    query: params,
  });
