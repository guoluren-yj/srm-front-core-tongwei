...
export async function createQuery(params) {
  return request(`${SRM_SPUC}/v1/${organizationId}/plans/poline/supplier/list`, {
    method: 'GET',
    query: parseParameters(params),
  });
}
 ...
 * @returns {object} fetch Promise
 */
export async function releasePlan({ data, customizeUnitCode }) {
 ...
 * @returns {object} fetch Promise
 */
export async function handleSupplierSave(data) {
  return request(`${SRM_SPUC}/v1/${organizationId}/plans/batch`, {
    method: 'PUT',
    body: data,
  });
 ...
 * @returns {object} fetch Promise
 */
export async function handleSupplierRelease(data) {
  return request(`${SRM_SPUC}/v1/${organizationId}/plans/batch/publish`, {
    method: 'PUT',
    body: data,
  });
