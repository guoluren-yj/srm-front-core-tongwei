...
export default class extends React.Component {
   ...
   */
  @Bind()
  onRowSelectChange(projectForecastSelectedRowKeys, projectForecastSelectedRows) {
  ...
  render() {
              ...
              {record.$form.getFieldDecorator('supplierCompanyCode', {
                ...
                <Lov
                  ...
                  lovOptions={{
                    ...
                    displayField: 'supplierCompanyCode',
                  }}
    ...
    return (
      <React.Fragment>
        ...
        {customizeTable(
          {
            code: 'SPRM.PREDICTION_ORDER_FEEDBACK.PROJECT_LIST',
          },
