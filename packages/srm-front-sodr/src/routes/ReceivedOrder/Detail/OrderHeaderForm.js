    ...
    return customizeForm(
      {
        form,
        dataSource,
        code: 'SODR.RECEIVED_ORDER_DETAIL.HEADER',
      },
      <Form>
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT} className="read-row">
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              {getFieldDecorator('supplierId', { initialValue: dataSource.supplierId })(
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            <FormItem
              {...EDIT_FORM_ITEM_LAYOUT}
              label={intl.get(`sodr.common.model.common.supplierSiteIds`).d('供应商地点')}
            >
              {getFieldDecorator('supplierSiteId', { initialValue: dataSource.supplierSiteId })(
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT} className="read-row">
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              {getFieldDecorator('agentId', { initialValue: dataSource.agentId })(
                <span>{agentName}</span>
              )}
            </FormItem>
          </Col>
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT} className="read-row">
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              {getFieldDecorator('termsId', { initialValue: dataSource.termsId })(
                <span>{termsName}</span>
              )}
            </FormItem>
          </Col>
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            <FormItem
              {...EDIT_FORM_ITEM_LAYOUT}
              label={intl.get(`sodr.common.model.common.erpContractNum`).d('合同编号')}
            >
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT} className={classnames('last-form-item')}>
          <Col {...FORM_COL_2_LAYOUT}>
            <FormItem label={intl.get(`sodr.common.model.common.remark`).d('订单摘要')}>
