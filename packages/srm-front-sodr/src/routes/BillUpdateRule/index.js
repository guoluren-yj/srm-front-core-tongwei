...
import { Button, Drawer, Tabs, Table, Switch } from 'hzero-ui';
...
export default class BillUpdateRule extends Component {
  ...
  render() {
    ...
    return (
      <Drawer
        destroyOnClose
        title={intl.get('sodr.billUpdateRule.view.title').d('对账单价修改规则配置')}
        placement="right"
        width={1000}
        closable={false}
            ...
            return (
              <TabPane tab={item.consignmentTypeMeaning} key={item.ruleId}>
                ...
                <div className="table-list-operator">
                  ...
                  <Button icon="save" onClick={this.handleSaveDetail}>
