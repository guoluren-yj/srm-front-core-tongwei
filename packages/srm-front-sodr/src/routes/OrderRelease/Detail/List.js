...
export default class List extends Component {
  ...
  getColumns(actionKey) {
          ...
          },
          {
            ...
            render: (text, record) => {
              ...
              return (
                ...
                //   {(form) => (
                <BasicInfoListEditableCell
                  form={record.$form}
                  {...basicInfoListEditableCellProps}
                />
                //   )}
                // </EditableContext.Consumer>
              );
          ...
          },
          {
            ...
            render: (val, record) =>
              record.priceShieldFlag === 1
                ...
                : poSourcePlatform === 'ERP'
                ? formatAumont(val)
                : formatAumont(val, headerInfo.domesticTaxIncludedPrice),
          },
          {
    ...
    return actionKey !== 'partners'
      ? defaultColumns.concat(dynamicColumns.get(actionKey)).filter((i) => i)
      : dynamicColumns.get(actionKey).filter((i) => i);
  }
  ...
  render() {
    ...
    return (
      <Fragment>
        {customizeTabPane(
          {
            code: 'SODR.ORDER_PUBLISH_LINE_LIST.TAB',
          },
          <Tabs onChange={this.handleOnRadioGroupChange} className="detail-list" animated={false}>
            ...
            >
              {radioGroupValue === 'basic' &&
                customizeTable(
                  {
                    code: 'SODR.ORDER_PUBLISH_LINE_LIST.PUBLISH_LINE',
                  },
            ...
            >
              {customizeTable(
                {
                  code: 'SODR.ORDER_PUBLISH_LINE_LIST.OTHER',
                },
                <Table {...tableProps} />
              )}
            </TabPane>
