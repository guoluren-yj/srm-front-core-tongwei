...
const commonModelPrompt = 'sodr.orderEvaluation.model.common';
const viewPrompt = 'sodr.orderEvaluation.view.message';
...
export default class OperationRecord extends PureComponent {
  ...
  handleSearch(fields = {}) {
    ...
    if (
      ...
      dispatch({
        type: 'orderEvaluation/fetchOperationRecordList',
        payload: {
          page: fields,
          ...filterValues,
  ...
  handleRecordListRows(dataList) {
    ...
    dispatch({
      type: 'orderEvaluation/updateState',
      payload: {
