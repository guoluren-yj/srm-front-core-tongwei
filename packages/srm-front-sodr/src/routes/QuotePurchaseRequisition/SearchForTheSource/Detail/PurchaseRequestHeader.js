...
import styles from '@/routes/components/index.less';
      ...
      <Form>
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT} className={isCatalogue ? 'read-row' : 'writable-row'}>
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              ...
              {getFieldDecorator('companyCode', { initialValue: companyCode })}
            ...
            >
              {getFieldDecorator('ouId', {
                ...
                <Lov
                  ...
                  disabled={!isFieldTouched('companyId') && dataSource.ouId}
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              {getFieldDecorator('purchaseOrgId', {
                ...
                !isFieldTouched('companyId') && dataSource.purchaseOrgId ? (
                  <span>{purchaseOrgName}</span>
                ) : (
                  <Lov
                    code="SPFM.USER_AUTH.PURORG"
                    textValue={purchaseOrgName}
                    queryParams={{ organizationId, ouId: form.getFieldValue('ouId') || undefined }}
                    disabled={isCatalogue}
            ...
            >
              {getFieldDecorator('agentId', {
                ...
                <Lov
                  ...
                  queryParams={{
                    organizationId,
                    purchaseOrgId: form.getFieldValue('purchaseOrgId') || undefined,
                  }}
                  disabled={
                    isCatalogue ||
                    isHandCreate ||
                    otherHeadDisabled ||
                    (isContractSource && dataSource.agentId)
                  }
                />
              )}
            </FormItem>
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT}>
          ...
          {enableSupplierSiteFlag === 1 && getFieldValue('supplierId') && getFieldValue('ouId') ? (
            <Col {...FORM_COL_3_LAYOUT}>
              <FormItem label={intl.get(`sodr.common.model.common.supplierSite`).d('供应商地点')}>
                  ...
                  rules: [
                    {
                      required: true,
                      message: intl.get('hzero.common.validation.notNull', {
                        name: intl.get(`sodr.common.model.common.supplierSite`).d('供应商地点'),
                      }),
                    },
                  ],
                })(
