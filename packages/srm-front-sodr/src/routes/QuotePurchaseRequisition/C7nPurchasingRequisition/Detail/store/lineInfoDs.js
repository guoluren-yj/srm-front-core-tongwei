  ...
  fields: [
    ...
    },
    {
      ...
      dynamicProps: {
        ...
        // defaultValue: ({ dataSet, record }) => {
        //   // record.getField('internationalTelCode').getOptions(record)
        //   // dataSet.toJSONData()[0]
        //   return '+86';
        // },
      },
    },
    ...
    },
    {
      ...
      dynamicProps: {
        ...
        required: ({ record }) => (record.get('requiredFieldNames') || []).includes('contractNum'),
      },
    ...
    },
    {
      ...
      dynamicProps: {
        precision: ({ dataSet }) =>
          dataSet.getState('headerInfoDs')?.current?.get('domesticDefaultPrecision'),
      },
    },
    {
