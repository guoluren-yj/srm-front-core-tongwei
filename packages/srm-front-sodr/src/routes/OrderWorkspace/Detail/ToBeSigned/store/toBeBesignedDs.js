...
const basicInfo = () => ({
  ...
  fields: [
    ...
    },
    {
      ...
      label: intl.get('sodr.workspace.model.common.electricSignFlag').d('电签标志'),
    },
    {
...
const detailInfo = () => ({
  ...
  queryParameter: {
    ...
    camp: 2,
    sortType: 0,
    customizeUnitCode: 'SODR.WORKSPACE_TOBESIGNED_DETAIL.DETAILINFO',
  },
});
...
const partner = () => ({
  ...
  queryParameter: {
    customizeUnitCode: 'SODR.WORKSPACE_TOBERELEASED_DETAIL.PARTNER',
  },
});
...
export { basicInfo, organizationInfo, detailInfo, otherInfo, partner, receiptInfo, billingInfo };
