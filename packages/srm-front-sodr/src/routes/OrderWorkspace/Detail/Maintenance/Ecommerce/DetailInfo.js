...
const DetailInfo = (props) => {
  const { ds, customizeTable, displayDocAndDocFlow = {} } = props;
  ...
  return customizeTable(
    {
      code: 'SODR.WORKSPACE_ECOMMERCE_DETAIL.DETAILINFO',
      __force_record_to_update__: true,
    },
    <SearchBarTable
      searchCode="SODR.WORKSPACE_ECOMMERCE_DETAIL.DETAILINFO_FILTER"
      dataSet={ds}
      columns={columns()}
      selectionMode="none"
