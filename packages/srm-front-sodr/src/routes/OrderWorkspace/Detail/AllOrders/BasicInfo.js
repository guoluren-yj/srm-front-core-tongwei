...
const BasicInfo = (props) => {
  ...
  return customizeForm(
    ...
    >
      ...
      {/* {paymentPlanNum && (
        <Output name="paymentPlanNum" renderer={() => <FlexLinkModal {...flexLinkProps} />} />
      )} */}
