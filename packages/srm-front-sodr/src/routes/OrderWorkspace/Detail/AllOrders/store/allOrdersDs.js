...
const basicInfo = () => ({
  ...
  fields: [
    ...
    {
      name: 'pcNum',
      label: intl.get('sodr.workspace.model.common.pcNum').d('协议编号'),
    },
    {
...
const detailInfo = () => ({
  ...
  queryParameter: {
    poEntryPoint: 'PURCHASE_PO_DETAIL',
    camp: 1,
    sortType: 0,
    customizeUnitCode: 'SODR.WORKSPACE_ALLORDERS_DETAIL.DETAILINFO',
  },
});
...
const partner = () => ({
  ...
  queryParameter: {
    customizeUnitCode: 'SODR.WORKSPACE_ALLORDERS_DETAIL.PARTNER',
  },
});
