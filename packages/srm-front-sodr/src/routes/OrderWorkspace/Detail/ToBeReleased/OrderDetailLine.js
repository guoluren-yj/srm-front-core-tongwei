...
const DetailInfo = (props) => {
  ...
  const columns = useMemo(() => {
    const lineColumns = [
      ...
      },
      {
        ...
        //     ? '******'
        //     : parseAumont(text, record.get('defaultPrecision')),
      },
      {
        name: 'lineAmount',
        width: 120,
        ...
        //   record.get('priceShieldFlag') === 1
        //     ? '******'
        //     : parseAumont(text, record.get('financialPrecision')),
      },
      {
            ...
            <Button
              ...
              onClick={() =>
                viewCostInformation({
                  record,
                  displayPoNum,
                  lineCode: 'SODR.WORKSPACE_TOBERELEASED_DETAIL.COSTINFORMATION',
                  viewOnly: true,
                })
              }
            >
    ...
    return remotes.process('processColumns', lineColumns);
    ...
    Modal.open({
      ...
      children: (
        <Bom
          ...
          code="SODR.WORKSPACE_TOBERELEASED_DETAIL.BOM"
        />
      ),
    });
  };
  ...
  return (
    <>
      {customizeTable(
        { code: 'SODR.WORKSPACE_TOBERELEASED_DETAIL.DETAILINFO' },
        <SearchBarTable
          searchCode="SODR.WORKSPACE_TOBERELEASED_DETAIL.DETAILINFO_FILTER"
          dataSet={ds}
          columns={columns}
