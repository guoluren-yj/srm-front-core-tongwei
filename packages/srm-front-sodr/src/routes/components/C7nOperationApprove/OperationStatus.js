...
const processOperationIconMap = {
  ...
  TRANSFER: 'mode_edit', // 转交
  SIGN: 'mode_edit', // 订单签署
  APV_ACCESS_WFL: 'authorize', // 工作流审批通过
  APV_ACCESS_FUN: 'authorize', // 功能审批通过
  APV_ACCESS_OTH: 'authorize', // 外部系统审批通过
  APV_REJECT_WFL: 'authorize', // 工作流审批拒绝
  APV_REJECT_FUN: 'authorize', // 功能审批拒绝
  APV_REJECT_OTH: 'authorize', // 外部系统审批拒绝
};
