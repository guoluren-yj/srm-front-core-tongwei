...
class App extends React.Component {
  ...
  ds = new DataSet({
    ...
    fields: [
      ...
      { name: 'phone', defaultValue: '15888888888', type: 'tel', label: '手机号', required: true, regionField: 'region', },
      { name: 'region', defaultValue: '+852', type: 'object', options: this.options, valueField: 'regionCode', textField: 'regionName' },
