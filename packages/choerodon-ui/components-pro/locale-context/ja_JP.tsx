...
const locale: Locale = {
  ...
  Table: {
    ...
    all_footer_summary: 'すべてを要約する',
    checked_footer_summary: '概要を確認する',
    page_footer_summary: '現在のページのまとめです',
    footer_sum: '総計',
    edit_button: '編集',
    create_button: '追加',
    save_button: '保存する',
    ...
    selection_settings: '設定にチェックを入れます',
    show_selection_cached: 'チェックデータを記録します',
    current_page_selection: '現在のページで複数選択',
  },
  Pagination: {
    page: 'ページ',
    jump_to: 'ジャンプする:',
    ...
    patching_setting: 'スクリーニング設定です',
    patching_distinction: 'ふるい方の違いです',
    get_real_total: 'クリックして総数を照会する',
  },
  Upload: {
  ...
  Attachment: {
    ...
    attachment_remark: '添付資料の説明',
    attachment_ref_tpl: '添付ファイルを参照してください',
    drag_here: "ここにドラッグしてください",
  },
  Modal: {
    ok: 'OK',
    cancel: 'キャンセル',
  ...
  Cascader: {
    ...
    select_all: 'すべて選択',
    unselect_all: 'いや',
    disabled_select_all: 'オプションデータが大きすぎて、オールオプションは使えない',
  },
  Screening: {
    selected: '選択済み',
    pack_up: '片付け',
  ...
  Tel: {
    value_missing_no_label: '電話番号の入力をお願いします。',
    value_missing: '{label}と入力をお願いします。',
    type_mismatch_tel: '有効な電話番号の入力をお願いします。',
  },
};
