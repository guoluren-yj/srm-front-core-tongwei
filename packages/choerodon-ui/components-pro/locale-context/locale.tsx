...
export interface Locale extends DataSetLocale {
  ...
  Table: {
    ...
    all_footer_summary: string;
    checked_footer_summary: string;
    page_footer_summary: string;
    footer_sum: string,
    edit_button: string;
    ...
    show_selection_cached: string,
    current_page_selection: string;
  };
  Pagination: {
    page: string;
    jump_to: string;
    ...
    patching_setting: string;
    patching_distinction: string;
    get_real_total: string;
  };
  Upload: {
