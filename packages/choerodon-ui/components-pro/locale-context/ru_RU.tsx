...
const locale: Locale = {
  ...
  Table: {
    ...
    all_footer_summary: '全部汇总',
    checked_footer_summary: '勾选汇总',
    page_footer_summary: '当前页汇总',
    footer_sum: '总数',
    edit_button: '编辑',
    create_button: '新增',
    save_button: '保存',
    ...
    selection_settings: '勾选设置',
    show_selection_cached: '记录勾选数据',
    current_page_selection: '当前页勾选',
  },
  Pagination: {
    page: '页',
    jump_to: '跳转至:',
    ...
    patching_setting: '筛选设置',
    patching_distinction: '筛选方式区别',
    get_real_total: '点击查询总数',
  },
  Upload: {
    file_selection: '选择文件',
  ...
  Attachment: {
    ...
    download: '下载',
    attachment_remark: '附件说明',
    attachment_ref_tpl: '请参考附件',
    delete: '删除',
  ...
  Cascader: {
    ...
    select_all: '全选',
    unselect_all: '无',
    disabled_select_all: '可选数据过大，不可使用全选',
  },
  Screening: {
    selected: '已选',
    pack_up: '收起',
  ...
  Tel: {
    value_missing_no_label: '请输入电话号码',
    value_missing: '请输入{label}。',
    type_mismatch_tel: '请输入有效的电话号码。',
  },
};
