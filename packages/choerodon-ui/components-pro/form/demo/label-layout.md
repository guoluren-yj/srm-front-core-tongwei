...
````jsx
import { Form, TextField, Password, NumberField, EmailField, UrlField, DatePicker, Switch, CheckBox, Select, SelectBox, TextArea, CodeArea, Range, Icon, Button, TelField } from 'choerodon-ui/pro';
...
const App = () => {
  ...
  return (
    <>
      ...
      >
        <TelField colSpan={3} label="手机号" placeholder="请输入手机号" pattern="1[3-9]\d{9}" name="phone" help="请输入你的手机号" showHelp="tooltip" required highlight="高亮" />
