...
````jsx
import { DataSet, Form, TextField, NumberField, Password, EmailField, UrlField, DatePicker, Select, SelectBox, Switch, Lov, Button, Row, Col, TelField } from 'choerodon-ui/pro';
...
class App extends React.Component {
  ds = new DataSet({
    ...
    fields: [
      { name: 'phone', type: 'tel', label: '手机号', required: true, pattern: '^1[3-9]\\d{9}$' },
