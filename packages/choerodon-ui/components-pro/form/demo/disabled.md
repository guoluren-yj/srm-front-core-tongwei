...
````jsx
import { DataSet, Form, TextField, Password, NumberField, EmailField, UrlField, Lov, Switch, DatePicker, Select, SelectBox, Button, Menu, Dropdown, Icon, TelField } from 'choerodon-ui/pro';
  ...
  return (
    <>
      <Form header="Basic" disabled style={{ width: '4rem' }}>
        <TelField label="手机号" tooltip="overflow" defaultValue="1588888888822158888888882215888888888221588888888822" pattern="1[3-9]\d{9}" name="phone" required clearButton />
