...
````jsx
import { Form, TextField, Password, NumberField, EmailField, UrlField, DatePicker, Select, SelectBox, Button, TelField } from 'choerodon-ui/pro';
...
ReactDOM.render(
  <Form header="Custom Header">
    <TelField label="手机号" pattern="1[3-9]\d{9}" name="phone" required clearButton />
