...
import COLOR_PICKER_PLACEMENTS from './placements';
...
export default class ColorPicker extends TriggerField<ColorPickerProps> {
  ...
  gradientPopupRef: HTMLInputElement | null;
  ...
  saveGradientPopupRef = node => (this.gradientPopupRef = node);
  ...
  getPopupContent() {
    ...
    if (preset) {
      const { trigger = [Action.click], popupCls } = this.props;
      ...
      return (<div className={`${prefixCls}-popup-view-preset`}>
        ...
        <div className={`${prefixCls}-popup-view-gradient`}>
          <Trigger
            prefixCls={`${prefixCls}-gradient`}
            action={trigger}
            popupCls={popupCls}
            builtinPlacements={COLOR_PICKER_PLACEMENTS}
            popupPlacement="rightTop"
            popupContent={this.getGradientPopupContent()}
            getPopupContainer={() => this.gradientPopupRef}
          >
            <div className={`${prefixCls}-popup-picker-name`} onClick={this.onExpandChange} ref={this.saveGradientPopupRef}>
              <div>
