...
export interface TableContextValue extends TableContextProviderProps {
  ...
  aggregation?: boolean;
  aggregationCellLineBreak?: boolean | number,
...
const TableContext = getContext<TableContextValue>(Symbols.ProTableContext, {
  get tableStore(): TableStore {
    throw new Error('No tableStore in table context provider.');
  },
  get dataSet(): DataSet {
    throw new Error('No dataSet in table context provider.');
  },
  indentSize: 15,
  rowHeight: 30,
});
...
const TableContextProvider: FunctionComponent<TableContextProviderProps> = function TableContextProvider(props) {
  ...
  const value: TableContextValue = {
    ...
    aggregationCellLineBreak: tableStore.aggregationCellLineBreak,
    aggregationCellLineLimit: tableStore.aggregationCellLineLimit,
