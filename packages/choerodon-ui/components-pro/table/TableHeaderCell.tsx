...
import { ColumnAlign, ColumnLock, TableColumnResizeTriggerType, TableColumnTooltip, CellType } from './enum';
...
const TableHeaderCell: FunctionComponent<TableHeaderCellProps> = function TableHeaderCell(props) {
  ...
  const { columnResizable, headerRowHeight, props: { headerGroupExtraColumn } } = tableStore;
  const {
    headerClassName,
    headerStyle = {},
    name,
