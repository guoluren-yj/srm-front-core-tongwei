...
class App extends React.Component {
  ...
  userDs = new DataSet({
    ...
    fields: [
      ...
      { name: 'phone', type: 'tel', label: '手机', regionField: 'region' },
      { name: 'region', type: 'string', options: this.regionOptions, valueField: 'regionCode', textField: 'regionName' },
  ...
  q = () => {
    const { userDs } = this;
    userDs.query(1).then((r) => console.log(1, r));
    userDs.query(2).then((r) => console.log(2, r));
    userDs.query(3).then((r) => console.log(3, r));
  }

  qButton = (
    <Button onClick={this.q} key="addColumn">
      q
    </Button>
  );
  ...
  render() {
    ...
    return (
      <Table
        ...
        computedFooterSummary={this.computedFooterSummary}
      >
        <Column
          name="userid"
        ...
        <Column name="age" editor width={150} sortable footer={renderColumnFooter} footerSummary />
        ...
        <Column name="phone" editor lock width={200} />
