...
class App extends React.Component {
  ...
  handleCustomizedChange = (customized) => {
  ...
  render() {
    ...
    return (
      <>
      <Button onClick={this.handleCustomized}>当前customizedCode： {customizedCode}</Button>
      <Table
        customizable
        border={false}
        ...
        style={this.style}
        onCustomizedChange={this.handleCustomizedChange}
      >
        <Column header="组合">
          <Column header="子组合">
