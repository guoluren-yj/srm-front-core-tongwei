...
export default class LovView extends Component<LovViewProps> {
  ...
  handleSelect(event?: React.MouseEvent) {
    ...
    let records: Record[] = selectionMode === SelectionMode.rowbox || multiple ? 
      dataSet.selected : selectionMode === SelectionMode.treebox ?
        dataSet.treeSelected : dataSet.current ? [dataSet.current] : [];
    // 满足单选模式下，双击和勾选框选中均支持
