...
export default class ViewComponent<P extends ViewComponentProps, C extends ConfigContextValue = ConfigContextValue> extends Component<P, any> {
  ...
  constructor(props, context) {
    ...
    this.prefixCls = this.getContextProPrefixCls(props.suffixCls!, props.prefixCls, props);
  }
  ...
  componentWillReceiveProps(nextProps: P, nextContext) {
    ...
    if (this.needUpdatePrefixCls(this.props, nextProps)) {
      this.prefixCls = this.getContextProPrefixCls(nextProps.suffixCls!, nextPrefixCls, nextProps);
    }
  ...
  needUpdatePrefixCls(props: P, nextProps: P) {
    return props.prefixCls !== nextProps.prefixCls;
  }
  ...
  @autobind
  getContextProPrefixCls(suffixCls: string, customizePrefixCls?: string, _: P = this.props): string {
    const { context } = this;
