...
import { LovConfig, TimeZone } from '../interface';
import { ExportMode, FieldType, RecordStatus, AttachmentPreviewTarget } from '../data-set/enum';
...
export type AttachmentLimitCfg = { preview?: boolean; download?: boolean; remove?: boolean }
...
export type DateCode = string | undefined;
...
export interface AttachmentConfig {
  ...
  enableChunk: boolean;
  previewTarget?: AttachmentPreviewTarget | string,
  action?: AxiosRequestConfig | ((props: AttachmentActionProps) => AxiosRequestConfig);
  batchFetchCount?: AttachmentBatchFetchCount;
  imageContainer?: () => HTMLElement;
  fetchFileSize?: (props: AttachmentOption & { useChunk?: boolean }) => Promise<number>;
  fetchList?: (props: AttachmentValue & AttachmentQuery) => Promise<FileLike[]>;
  ...
  getTemplateDownloadUrl?: (props: AttachmentValue) => AttachmentTplInfo[] | Promise<AttachmentTplInfo[]>;
  ...
  attachmentLimit?: (options: {attachment: AttachmentFile, isPublic?: boolean, isAttachmentsInControl?: boolean}) => AttachmentLimitCfg;
}
...
export interface Config {
  ...
  lookupShowTextIfNotFound?: ({ name, value, record, showValueIfNotFound }: { name: string, value?: any, record?: Record, showValueIfNotFound?: boolean }) => string | undefined;
  lovBatchAxiosConfig?: (codes: string[]) => AxiosRequestConfig;
  ...
  intlFieldRequired?: boolean | { lang?: string[], options?: Intl.NumberFormatOptions };
  ...
  dateAxiosConfig?: AxiosRequestConfig | ((props: DateConfig) => AxiosRequestConfig);
  lovPatching?: () => PatchingConfig[];
  getDateShowFormat?: () => { dateFormat: string, dateTimeFormat: string, timeFormat: string, monthFormat: string };
}

export type ConfigKeys = keyof Config;

export const defaultCache: CacheOptions<string, AxiosPromise> = { maxAge: 1000 * 60 * 10, max: 100 };
