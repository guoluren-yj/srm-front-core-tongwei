...
function $formatNumber(v: number, lang: string | undefined, options: Intl.NumberFormatOptions = {}): string {
  ...
  return v.toLocaleString(normalizeLanguage(lang), {
    ...options,
    minimumFractionDigits: isNumber(minimumFractionDigits) && minimumFractionDigits > 20 ? 20 : minimumFractionDigits,
    maximumFractionDigits: isNumber(maximumFractionDigits) && maximumFractionDigits > 20 ? 20 : maximumFractionDigits,
  });
}
