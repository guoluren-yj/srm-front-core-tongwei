...
export default class Menus extends Component {
  static defaultProps = {
    ...
    isTabSelected: false,
    locale: Locale,
    singleMenuStyle: { minWidth: '3rem', maxWidth: '3rem' },
    singleMenuItemStyle: { width: '1.2rem' },
  };
  ...
  render() {
    ...
    const maxWidth = activeOptions && activeOptions.length > 2 ? activeOptions.length * 120 : singleMenuStyle.maxWidth;
    const dropdownMenuColumnStyleSingle = { ...dropdownMenuColumnStyle, ...singleMenuStyle, maxWidth };
