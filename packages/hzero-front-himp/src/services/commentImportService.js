...
export async function loadTemplate(params) {
  const { prefixPatch, code, tenantId, requestParams } = params;
...
export async function validateData(params) {
  const { sync, templateCode, prefixPatch, batch, tenantId, requestParams } = params;
  const reqUrl = sync
...
export async function importData(params) {
  const { sync, prefixPatch, templateCode, batch, tenantId, requestParams } = params;
  const reqUrl = sync
