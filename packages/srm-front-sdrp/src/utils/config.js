...
let SRM_SPCM = '/spcm';
let SRM_AMKT = '/amkt';
let SRM_DATA_PROCESS = '/sdps';
let SRM_DATA_SDAT = '/sdat';
let SRM_DATA_SDRP = '/sdrp';
...
const helpMethodAssist = {
  ...
  SRM_DATA_SDAT: { changeConfig: ['SRM_DATA_SDAT'], depBy: [] },
  SRM_DATA_SDRP: { changeConfig: ['SRM_DATA_SDRP'], depBy: [] },
};
