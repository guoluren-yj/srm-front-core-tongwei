...
export async function getChatRoomMessagesApi(params) {
  return request(`${SRM_SMBL}/v1/${getCurrentOrganizationId()}/ai-agent-message/list`, {
    method: 'GET',
    query: params,
  });
}
...
export async function sendMessageApi(params) {
  return request(`${SRM_SMBL}/v1/${getCurrentOrganizationId()}/ai-agent-message/send-message`, {
    method: 'POST',
    body: params,
  });
}
...
export async function fetchFeedBackData(params) {
  return request(`${SRM_SMBL}/v1/${getCurrentOrganizationId()}/ai-agent-message/feedback`, {
    method: 'POST',
    body: params,
  });
}
