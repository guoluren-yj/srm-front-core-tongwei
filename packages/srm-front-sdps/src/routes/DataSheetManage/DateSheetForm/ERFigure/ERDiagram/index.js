...
import EREntity, { EDGE_COLOR, GRID_SIZE, NODE_COLOR, NODE_FONT_SIZE } from './EREntity.tsx';
      ...
      const processData = data => {
        if (data && data instanceof Object && (Object.keys(data)?.length ?? 0) !== 0) {
          ...
          graph.batchUpdate(() => {
            ...
            //       tagName: 'path',
            //       attrs: {
            //         d: 'M0,5L10,5zM3,2L3,8zM7,2L7,8z',
            //         stroke: EDGE_COLOR,
            //       },
            //     },
            //     {
            ...
            //       tagName: 'text',
            //       selector: 'primaryKey',
            //       textContent: intl.get('sdps.dataSheet.view.erDiagram.primaryKey').d('主键'),
            //     },
            //     {
            //       tagName: 'text',
            //       selector: 'oneToMany',
            //       textContent: intl.get('sdps.dataSheet.view.erDiagram.oneToMany').d('一对多'),
            //     },
            //   ],
            //   attrs: {
            //     primaryKey: {
