          ...
          <Tabs animated={false} activeKey={activeKey} onChange={handleChangeTab}>
            <TabPane tab={intl.get('sdps.dataSheet.view.title.dataTable').d('数据表')} key="1">
              <LeftMenuClassify
                ...
                fetchUrl={`${SRM_DATA_PROCESS}/v1/data-table-manages/all-topic`}
                fetchTabsUrl={`${SRM_DATA_PROCESS}/v1/meta-table/meta-tables`}
            ...
            <TabPane tab={intl.get('sdps.dataSheet.view.title.tenantTab').d('租户')} key="2">
              <LeftMenu
                ...
                placeholder={intl
                  ...
                  .d('请输入租户编码、名称查询')}
                fetchUrl={`${SRM_DATA_PROCESS}/v1/data-table-manages/tenant-list`}
