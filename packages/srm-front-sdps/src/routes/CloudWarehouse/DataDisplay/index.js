...
import { getOpenService } from '@/services/dataDisplayService';
...
const DataDisplay = (props) => {
  ...
  return (
    <div className="data-display-content">
      <div className="data-display-self-header">
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <div className="data-display-self-header-title">
            {intl.get('sdps.cloudWarehouse.view.title.monitorAnalysis').d('监控与分析')}
          </div>
          {isEnhance > 0 && (
            <Popover
              content={content()}
          ...
          <div
            ...
            style={{ left: isEnhance === 0 ? '120px' : '220px' }}
          >
            ...
            <span>
              <Lov
                ...
                searchable
                placeholder={intl
                  .get('sdps.cloudWarehouse.view.title.selectTenant')
                  .d('请选择租户')}
        ...
        <div style={{ paddingRight: '10px' }}>
          <ExcelExportPro
            ...
            requestUrl={
              activeKey === '1'
                ? `${SRM_DATA_PROCESS}/v1/monitor-analysis/task-details-export`
                : `${SRM_DATA_PROCESS}/v1/monitor-analysis/file-details-export`
            }
