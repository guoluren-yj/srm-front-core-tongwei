  ...
  fields: [
    {
      ...
      type: 'object',
      noCache: true,
      lovCode: 'SDPS.DATA_DISPLAY_TENTANT_LIST',
      lovQueryAxiosConfig: () => {
        return {
          url: `${SRM_DATA_PROCESS}/v1/monitor-analysis/open-service-tenant-list`,
          method: 'GET',
        };
      },
    },
...
const FileSyncDS = () => ({
  transport: {
    read: ({ data, params }) => {
      return {
        url: `${SRM_DATA_PROCESS}/v1/monitor-analysis/seep-invoke/${data.ruleCode}`,
        params: {
          ...data,
          ...params,
        },
