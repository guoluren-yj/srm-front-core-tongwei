 ...
 * @LastEditors: yanglin
 * @LastEditTime: 2022-06-17 15:13:54
 */
...
const approvedDs = () => ({
  ...
  fields: [
    ...
    },
    {
      ...
      label: intl.get(`${commonPrompt}.cancelStatusCode`).d('头取消标识'),
    },
    {
      name: 'displayRpNum',
    ...
    read: ({ data }) => {
      return {
        ...
        data: filterNullValueObject({
          ...data,
          queryType: 'APPROVED',
          customizeUnitCode: 'SRPM.RP_PLATFORM.APPROVED_SEARCHBAR,SRPM.RP_PLATFORM.APPROVED.LIST',
        }),
      };
    },
  },
