  ...
  return (
    <div style={{ height: 'calc(100vh - 260px)' }}>
      <SearchBarTable
        ...
        dataSet={props.delieveredDS}
        columns={columns}
        customizedCode="SMODR.EC.BILL.WORKBENCH.DELIEVERED.QUERY"
        searchCode="SMOP.EC.RECORD.EC_SUB_BAR"
        searchBarConfig={{
          left: {
            render: () => (
              <TextFieldPro
                ds={props.delieveredDS}
