...
const intlPrompt = 'scux.correctionModal'; // 多语言前缀
  ...
  return {
    ...
    fields: [
      ...
      },
      {
        ...
        textField: 'itemCode',
        dynamicProps: {
          disabled: ({ record }) => Boolean(record.get('productNum')),
        },
      },
      {
        name: 'itemId',
...
function saveDetailApi(body) {
  return request(`${SRM_MARMOT}/v1/${organizationId}/marmot-api/IXTtLa4WCJR9IppN9icZ0yxlicRnyibj6QxmGNUoibic4ogk`, {
    method: 'POST',
    body,
  });
}
