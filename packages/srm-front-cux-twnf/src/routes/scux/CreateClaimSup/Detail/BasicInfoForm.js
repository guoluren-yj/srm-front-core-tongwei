...
import { getDefaultFromCompany, getDefaultFromPurOrg } from '@/services/sqam/sqamCommonService';
...
export default class BasicInfoForm extends Component {
  ...
  render() {
    ...
    const uploadModalProps = {
      ...
      attachmentUUID: headerData.attributeVarchar5 || uuid(),
      bucketName: window.$$env.PRIVATE_BUCKET || 'private-bucket',
      bucketDirectory: 'cusz-attachment-default',
    };
      ...
      <Form>
        <Row {...EDIT_FORM_ROW_LAYOUT} className="writable-row">
          ...
          <Col {...FORM_COL_2_LAYOUT}>
            <Form.Item label={intl.get(`sqam.common.model.formTitle`).d('索赔单标题')} {...EDIT_FORM_ITEM_LAYOUT}>
            ...
            <Form.Item label={intl.get(`entity.company.tag`).d('公司')} {...EDIT_FORM_ITEM_LAYOUT}>
              {!formHeaderId
                ? getFieldDecorator('companyId', {
                    ...
                    <Lov
                      code="SQAM.TENANT.CUSTOMER_COMPANIES"
            ...
            >
              {!formHeaderId
                ? getFieldDecorator('supplierCompanyId', {
                    ...
                    <Lov
                      code="SSLM.USER_AUTH.COMPANY.PARTNER"
                      disabled={!getFieldValue('companyId')}
                      onChange={(_, record = {}) => {
                        const {
            ...
            >
              {getFieldDecorator('claimTypeId', {
                ...
                <Lov
                  ...
                  lovOptions={{ valueField: 'claimTypeId', displayField: 'typeDesc' }}
                  queryParams={{ tenantId: getCurrentOrganizationId() }}
                  onChange={(_, { autoConfirmFlag, typeDesc, claimTypeId }) => {
                    registerField('autoConfirmFlag');
                    registerField('claimTypeName');
                    setFieldsValue({ autoConfirmFlag, claimTypeName: typeDesc, claimTypeId });
                  }}
                />
              )}
            </Form.Item>
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT} className="writable-row">
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item label={intl.get(`sqam.common.model.claimState`).d('索赔说明')} {...EDIT_FORM_ITEM_LAYOUT}>
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item label="供应商分类" {...EDIT_FORM_ITEM_LAYOUT}>
              {getFieldDecorator('attributeVarchar4', {
                initialValue: headerData.attributeVarchar4,
              })(<Input />)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item label="attributeVarchar5" {...EDIT_FORM_ITEM_LAYOUT}>
              {getFieldDecorator('attributeVarchar5', {
                initialValue: headerData.attributeVarchar5,
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT} className="writable-row">
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item label="供应商联系人" {...EDIT_FORM_ITEM_LAYOUT}>
              {getFieldDecorator('attributeVarchar1', {
                initialValue: headerData.attributeVarchar1,
              })(<Input />)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item label="供应商联系方式" {...EDIT_FORM_ITEM_LAYOUT}>
              {getFieldDecorator('attributeVarchar2', {
                initialValue: headerData.attributeVarchar2,
              })(<Input />)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item label="供应商邮箱" {...EDIT_FORM_ITEM_LAYOUT}>
              {getFieldDecorator('attributeVarchar3', {
                initialValue: headerData.attributeVarchar3,
              })(<Input />)}
            </Form.Item>
          </Col>
        </Row>
