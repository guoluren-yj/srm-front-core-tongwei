 ...
 */
// @withCustomize({
//   unitCode: ['SQAM.CLAIM_FORM_DETAIL.CLAIM_ITEM'],
// })
export default class ClaimProject extends PureComponent {
   ...
   */
  render() {
    const { loading, dataSource, onSearch, pagination, customizeTable, detail } = this.props;
    ...
    return (
      <Fragment>
        {customizeTable(
          {
            code: 'SQAM.CLAIM_FORM_DETAIL.CLAIM_ITEM',
          },
          <Table
            loading={loading}
            bordered
