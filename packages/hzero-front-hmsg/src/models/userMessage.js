...
import { queryFileList, queryMapIdpValue } from 'hzero-front/lib/services/api';
import {
  changeRead,
  deleteMessage,
  queryMessage,
...
export default {
  ...
  effects: {
    ...
    *init({ payload }, { call, put }) {
      ...
      if (res) {
        const { statusList, exportStatusList, platformNoticeTypeList, companyNoticeTypeList } = res;
        yield put({
          type: 'updateState',
          payload: {
            statusList,
