...
export default {
  ...
  effects: {
    ...
    *queryNoAssignPositionList({ payload }, { call }) {
      const { id, query } = payload;
      const result = yield call(queryNoAssignPositionList, id, query);
      return getResponse(result);
    },
    *queryNoAssignRoleList({ payload }, { call }) {
      const { id, query } = payload;
      const result = yield call(queryNoAssignRoleList, id, query);
      return getResponse(result);
    },
  },
  reducers: {
