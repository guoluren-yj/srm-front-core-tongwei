        ...
        <Form>
          ...
          {itemData.typeCode !== 'WEB_HOOK' && (
            <>
              <Form.Item
                label={
                  getFieldValue('typeCode') !== 'MQ'
                    ? intl.get('hmsg.common.view.accountCode').d('账户代码')
                    : intl.get('hmsg.common.view.mqMessageTopic').d('消息topic')
                }
                {...formLayout}
              >
                {getFieldDecorator('serverCode', {
                  ...
                  <Lov
                    code={getFieldValue('typeCode') !== 'MQ' ? 'HMSG.SERVER' : 'HMSG.SERVER_MQ'}
              ...
              <Form.Item
                label={
                  getFieldValue('typeCode') !== 'MQ'
                    ? intl.get('hmsg.common.view.accountName').d('账户名称')
                    : intl.get('hmsg.common.view.mqMessageName').d('消息名称')
                }
                {...formLayout}
              >
