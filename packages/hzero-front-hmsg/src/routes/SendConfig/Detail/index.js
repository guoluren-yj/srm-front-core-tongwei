...
import { filter, isNumber, isUndefined, isNil } from 'lodash';
                ...
                <Col {...FORM_COL_3_LAYOUT}>
                  ...
                  >
                    {getFieldDecorator('enabledFlag', {
                      initialValue: isCopy ? copyDetail.enabledFlag : isUndefined(match.params.id) ? 1 : header.enabledFlag,
                    })(<Switch />)}
                  </Form.Item>
                </Col>
                {!tenantRoleLevel && (
                ...
                <Col {...FORM_COL_3_LAYOUT}>
                  ...
                  >
                    {getFieldDecorator('receiveConfigFlag', {
                      initialValue:
                        isCopy ? copyDetail.receiveConfigFlag : isUndefined(match.params.id) ? 0 : header.receiveConfigFlag,
                ...
                <Col {...FORM_COL_3_LAYOUT}>
                  <Form.Item
                    ...
                    label={intl
                      ...
                      .d('角色工作台站内信屏蔽')}
                  >
                    {getFieldDecorator('roleWorkbenchShieldFlag', {
                      initialValue:
                        (isCopy
                          ? copyDetail.roleWorkbenchShieldFlag
                          : header.roleWorkbenchShieldFlag) || 0,
                    })(<Switch checkedValue={1} unCheckedValue={0} />)}
                  </Form.Item>
                </Col>
              </Row>
