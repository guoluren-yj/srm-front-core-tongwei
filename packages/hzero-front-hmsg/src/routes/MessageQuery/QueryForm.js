...
@cacheComponent({ cacheKey: '/hmsg/message-query/list' })
export default class QueryForm extends PureComponent {
  ...
  render() {
    ...
    const min = endDate
      ? moment(new Date(endDate.format('YYYY-MM-DD')).getTime() - 518400000)
      : undefined;
    const max = startDate
      ? moment(new Date(startDate.format('YYYY-MM-DD')).getTime() + 518400000)
      : undefined;
    return (
      <>
            ...
            <Col {...FORM_COL_4_LAYOUT}>
              ...
              >
                {getFieldDecorator('receiver')(
                  selectMsgType === 'WEB' ? (
                    <Lov
                      code={tenantRoleLevel ? 'HMSG.SITE.USER' : 'HMSG.SITE.USER.PLATFORM'}
                ...
                {getFieldDecorator('startDate', {
                  ...
                  <DatePicker
                    ...
                    disabledDate={currentDate =>
                      (endDate && moment(endDate).isBefore(currentDate, 'day')) ||
              ...
              >
                {getFieldDecorator('endDate', {
                  ...
                  rules: [
                    {
                      ...
                      message: intl.get('hzero.common.validation.notNull', {
                        name: intl
                          .get('hmsg.messageQuery.model.messageQuery.endDate')
                          .d('发送时间至'),
                      }),
                    },
                  ],
                  ...
                  <DatePicker
                    ...
                    disabledDate={currentDate =>
                      (startDate && moment(startDate).isAfter(currentDate, 'day')) ||
            ...
            {!tenantRoleLevel && (
              <Col {...FORM_COL_4_LAYOUT}>
                ...
                >
                  ...
                  })(<Lov code="HPFM.TENANT" textValue={tenantName} onChange={this.props.syncTenantId} />)}
                </FormItem>
              </Col>
            )}
          </Row>
