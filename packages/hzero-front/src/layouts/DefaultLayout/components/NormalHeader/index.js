    ...
    return (
      <div className={getHeaderClassName('container')}>
        ...
        <div className={getHeaderClassName('right')}>
          ...
          {!menuHidden && hasMultiLanguage && (
            <DefaultLanguageSelect
              className={classNames(
                getHeaderClassName('right', 'item'),
                getHeaderClassName('right', 'item', 'select'),
                getHeaderClassName('language', 'select')
              )}
              popupContentClassName={getHeaderClassName('language', 'select', 'popup')}
            />
          )}
          {!menuHidden && !!dataHierarchyFlag && !!isModal && isTenantRoleLevel() && (
          ...
          {!menuHidden && isTraceLog && <DefaultTraceLog dispatch={dispatch} />}
          {!menuHidden && isUed && <MarketClientButton />}
          {!menuHidden && isUed && <ThemeButton />}
          {!menuHidden && (
            <DefaultNoticeIcon
              className={classNames(
                getHeaderClassName('right', 'item'),
