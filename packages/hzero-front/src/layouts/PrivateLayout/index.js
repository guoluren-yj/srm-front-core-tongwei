...
class PrivateLayout extends React.Component {
  ...
  render() {
    const { routerData, menu = [], activeTabKey, tabs,  workbenchPermission: { workbenchFlag }, } = this.props;
    const redirectData = workbenchFlag ? [{ from: '/', to: '/swbh/role-workbench' }, { from: '/workplace', to: '/swbh/role-workbench' }] : [{ from: '/', to: '/workplace' }]; // 根目录需要跳转到工作台
    menu.forEach((item) => {
