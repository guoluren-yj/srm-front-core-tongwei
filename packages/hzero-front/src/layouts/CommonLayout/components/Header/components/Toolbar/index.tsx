...
const Toolbar: React.FC<ToolbarProps> = ({
  ...
  const dealOverrideElement: Element[] = React.useMemo(() => {
    const dealOverrideElementConfig: OverrideElements = overrideElement || {
      'language-switch': { show: true, sort: 60 },
      'tenant-select': { show: true, sort: 70 },
    ...
    return [
      ...
      },
      {
        ...
        ele: hasMultiLanguage ? (
          dealOverrideElementConfig['language-switch'].show ? (
            <DefaultLanguageSelect 
              className={getClassName('header-language-select')}
              popupContentClassName={getClassName('header-language-select-popup')}
            />
          ) : (
            false
          )
        ...
        sort: dealOverrideElementConfig['language-switch'].sort || 60,
      },
      {
        key: 'tenant-select',
        ...
        sort: dealOverrideElementConfig['tenant-select'].sort || 70,
      },
      {
