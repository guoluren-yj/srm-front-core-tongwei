...
class MainMenuItem extends React.PureComponent {
  ...
  render() {
    const { menu, activeMenus, active, hover, menuLineWrap } = this.props;
        ...
        >
          <span className={menuItemTitle.join(' ')}>
            ...
            <Tooltip
              ...
              title={menuLineWrap ? undefined : <MenuContext.Consumer>{this.renderMainMenuItemTitle}</MenuContext.Consumer>}
            >
              <span className="menu-text">
                <MenuContext.Consumer>
                  {this.renderMainMenuItemTitle}
                </MenuContext.Consumer>
              </span>
            </Tooltip>
