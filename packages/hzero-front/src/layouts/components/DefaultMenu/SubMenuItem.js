...
class SubMenuItem extends React.PureComponent {
  ...
  render() {
    const { active, hover, style, subMenu, menuLineWrap } = this.props;
      ...
      >
        ...
        >
          <Tooltip
            ...
            title={menuLineWrap ? undefined : <MenuContext.Consumer>{this.renderSubMenuItemTitle}</MenuContext.Consumer>}
          >
