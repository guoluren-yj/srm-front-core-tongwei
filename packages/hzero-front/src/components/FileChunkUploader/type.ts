import type { ModalProps as C7NModalProps } from 'choerodon-ui/pro/lib/modal/Modal';
import type { ModalProps as HzeroModalProps } from 'hzero-ui/lib/modal/Modal';
import type { ComponentType, CSSProperties, ReactComponentElement } from 'react';
