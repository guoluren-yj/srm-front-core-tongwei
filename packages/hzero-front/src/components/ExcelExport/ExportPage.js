              ...
              <Col span={12}>
                ...
                >
                  {form.getFieldDecorator('fillerType', {
                    ...
                    <Select dropdownStyle={{zIndex: 1101}}>
                ...
                <Col span={12}>
                  ...
                  >
                    {form.getFieldDecorator('async', {
                      ...
                      <Select disabled={disabledAsync || !exportAsync || !enableAsync} dropdownStyle={{zIndex: 1101}}>
                ...
                <Col span={12}>
                  ...
                  >
                    {form.getFieldDecorator('singleExcelMaxSheetNum', {
                      ...
                      <InputNumber min={1} precision={0} max={9999999} style={{ width: '138px' }} />
                    )}
                  </Form.Item>
                </Col>
              )}
