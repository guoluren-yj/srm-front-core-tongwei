 ...
 * 查询供应商缴费情况
 * @async
 * @function queryCurrentPayment
 */
export async function queryCurrentPayment(params = {}) {
...
export async function checkTenantRole(params) {
  return request(`${HZERO_IAM}/hzero/v1/users/self/check-tenant-role`, {
    method: 'GET',
    query: params,
  });
}
