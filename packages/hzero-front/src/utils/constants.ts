...
export const CURRENT_TENANT_ROLE_LANGUAGE_TIMEZONE = 'current_tenant_role_language_timeZone';
export const YQCLOUD_TABMAP = 'yqCloud_tabMap';
export const YQCLOUD_COUNT = 'yqCloud_count';
export const KICK_OUT_MSG_KEY = 'hzero-kick-single-user-out-msg';

export const GMT2ETCMap = {
  'GMT-12': 'Etc/GMT+12',
  'GMT-11': 'Etc/GMT+11',
  'GMT-10': 'Etc/GMT+10',
  'GMT-9': 'Etc/GMT+9',
