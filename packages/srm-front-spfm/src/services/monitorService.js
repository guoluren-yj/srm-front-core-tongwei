...
export async function fetchMonitorList(params) {
  ...
  return request(`${prefix}/process-srm/instance/monitor/query`, {
    method: 'POST',
    body: param,
  });
}
...
export async function stopProcess(params) {
  return request(
    `${prefix}/process/instance/monitor/end/${params.processInstanceId}?comment=${
...
export async function fetchProcessException(params) {
  return request(`${prefix}/process/instance/monitor/exception/${params.id}`, {
    method: 'GET',
  });
}

export const EXPORTURL = `${prefix}/process-srm/instance/monitor/query-export-detail?exportType=COLUMN`;
...
export function exportDetail(query = {}, option) {
  ...
  return request(
    !merge
      ? `${prefix}/process-srm/instance/monitor/query-export-detail/un-merge`
      : `${prefix}/process-srm/instance/monitor/query-export-detail`,
    {
      method: 'GET',
      query: {
        exportType: 'DATA',
 ...
 * 提交指定审批人
 */
export async function saveProcessRetry({ processInstanceId, data }) {
  return request(`${prefix}/process/instance/monitor/execute/retry`, {
    method: 'POST',
    query: {
      processInstanceId,
