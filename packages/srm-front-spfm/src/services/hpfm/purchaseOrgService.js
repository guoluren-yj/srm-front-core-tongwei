...
export async function savePurchaseOrg(params) {
  const { purchaseOrgList, organizationId, query } = params;
  return request(`${HZERO_PLATFORM}/v1/${organizationId}/purchases/organizations/batch-save`, {
    method: 'POST',
    body: purchaseOrgList,
    query,
  });
}
