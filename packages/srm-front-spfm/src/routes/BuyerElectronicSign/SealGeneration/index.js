...
import { Drawer, Tooltip } from 'hzero-ui';
import { DataSet, Form, TextField, TextArea, Select, Icon, Spin, Button } from 'choerodon-ui/pro';
...
export default class SealGeneration extends Component {
  ...
  async generateSeal() {
    ...
    // const list = this.newDs.toJSONData();
  ...
  render() {
    const { visible, otherModalProps, bucketName = DEFAULT_BUCKET_NAME } = this.props;
    ...
    return (
      <Drawer {...modalProps}>
        ...
        >
          <Button color="primary" onClick={this.generateSeal} disabled={!btnFlag}>
