...
@formatterCollections({
  code: ['spfm.enterprise', 'spfm.common'],
})
      ...
      <Form style={{ marginTop: 8, width: 720 }}>
        ...
        <FormItem wrapperCol={{ span: 14, offset: 6 }}>
          {getFieldDecorator('domesticForeignRelation', {
            ...
            <Checkbox>
              {intl.get('spfm.enterprise.view.message.domesticRelation').d('我是境内机构')}
            </Checkbox>
          )}
        </FormItem>
              ...
              rules: [
                {
                  required: true,
                  message: intl
                    .get('hzero.common.validation.requireInput', {
                      name: intl
                        .get('spfm.enterprise.model.legal.unifiedSocialCode')
                        .d('统一社会信用代码号'),
                    })
            ...
            rules: [
              {
                ...
                message: intl.get('hzero.common.validation.requireInput', {
                  name: intl.get('spfm.enterprise.model.legal.companyName').d('企业名称'),
                }),
              },
            ],
          })(
            ...
            rules: [
              {
                ...
                message: intl.get('hzero.common.validation.requireInput', {
                  name: intl.get('spfm.enterprise.model.legal.dunsCode').d('邓白氏编码'),
                }),
              },
            ],
          })(<Input style={{ width: '200px' }} />)}
              ...
              rules: [
                {
                  ...
                  message: intl.get('hzero.common.validation.requireSelect', {
                    name: intl.get('spfm.enterprise.model.legal.companyType').d('企业类型'),
                  }),
                },
              ],
            })(
              ...
              rules: [
                {
                  required: true,
                  message: intl.get('hzero.common.validation.requireSelect', {
                    name: intl.get('spfm.enterprise.model.legal.taxpayerType').d('纳税人标识'),
                  }),
                },
              ],
            })(
                ...
                rules: [
                  {
                    ...
                    message: intl.get('hzero.common.validation.requireSelect', {
                      name: intl
                        .get('spfm.enterprise.model.legal.registeredCountryId')
                        .d('注册地址'),
                    }),
                  },
                ],
                ...
                {getFieldDecorator('registeredRegionId', {
                  ...
                  <Cascader
                    ...
                    placeholder={intl.get('hzero.common.validation.requireSelect', {
                      name: intl
                        .get('spfm.enterprise.model.legal.registeredRegionId')
                        .d('注册地址'),
                    })}
                    showSearch={{
            ...
            rules: [
              {
                required: true,
                message: intl.get('hzero.common.validation.requireInput', {
                  name: intl.get('spfm.enterprise.model.legal.addressDetail').d('详细地址'),
                }),
              },
            ],
          })(<Input />)}
            ...
            rules: [
              {
                required: true,
                message: intl.get('hzero.common.validation.requireInput', {
                  name: intl.get('spfm.enterprise.model.legal.legalRepName').d('法定代表人'),
                }),
              },
            ],
          })(<Input style={{ width: '200px' }} />)}
            ...
            rules: [
              {
                required: true,
                message: intl.get('hzero.common.validation.requireInput', {
                  name: intl.get('spfm.enterprise.view.message.registeredCapital').d('注册资本'),
                }),
              },
            ],
          })(<InputNumber style={{ width: '100px' }} precision={0} min={0} />)}
          <span style={{ paddingLeft: '12px' }}>
            {intl.get('spfm.common.currency.ten.thousand').d('万元')}
          </span>
        </FormItem>
        <FormItem
          {...formItemLayout}
            ...
            rules: [
              {
                required: true,
                message: intl.get('hzero.common.validation.requireSelect', {
                  name: intl.get('spfm.enterprise.model.legal.buildDate').d('成立日期'),
                }),
              },
            ],
