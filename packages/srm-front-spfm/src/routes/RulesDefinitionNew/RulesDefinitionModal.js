...
const RulesDefinitionModal = observer((props = {}) => {
  ...
  const renderReturnFields = () => {
    ...
    return returnFields.map(obj => {
      ...
      if (obj.lovCode) {
        Component = <Lov name={obj.name} {...basicConfig} />;
      }
      if (obj.lookupCode) {
  ...
  return (
    <div className={style['rules-definition-editor']}>
      ...
      >
        ...
        <div className="content-title" colSpan={2} style={{ marginTop: '32px' }}>
      ...
      <div className="rules-definition-editor-wrapper" style={{ marginTop: '32px' }}>
        <div className="content-title">
