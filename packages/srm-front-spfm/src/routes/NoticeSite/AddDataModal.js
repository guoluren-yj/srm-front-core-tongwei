        ...
        <Row {...SEARCH_FORM_ROW_LAYOUT}>
          <Col span={18}>
            <Row {...SEARCH_FORM_ROW_LAYOUT}>
              <Col span={12}>
                <FormItem
                  label={intl.get('spfm.notice.model.tenant.tenantNum').d('租户编码')}
                  {...formItemLayout}
                >
                  {getFieldDecorator(`tenantNum`)(<Input trim inputChinese={false} />)}
                </FormItem>
              </Col>
              <Col span={12}>
                <FormItem
                  label={intl.get('spfm.notice.model.tenant.tenantName').d('租户名称')}
                  {...formItemLayout}
                >
