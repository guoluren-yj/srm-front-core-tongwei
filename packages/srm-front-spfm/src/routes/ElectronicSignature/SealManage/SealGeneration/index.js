...
import { queryHistoryVersion } from '@/services/sealMangeService';
...
export default class SealGeneration extends Component {
  ...
  render() {
    const { visible, otherModalProps, bucketName = DEFAULT_BUCKET_NAME, remote } = this.props;
