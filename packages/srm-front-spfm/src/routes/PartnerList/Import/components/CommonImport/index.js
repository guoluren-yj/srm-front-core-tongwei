...
export default class CommentImport extends PureComponent {
        ...
        if (statusRes) {
          ...
          if (options.showMessage) {
            notification.success({
              ...
              description: intl
                .get('himp.comment.view.message.title.currentStatus', {
  ...
  handleDownloadTemplateExcel() {
    ...
    const api = `${API_HOST}${prefixPatch}/v1/${organizationId}/ability/import/template/${code}/excel`;
  ...
  render() {
    ...
    return (
      <>
        <Header
          backPath={backPath}
          title={action || intl.get('hzero.common.title.commonImport').d('通用导入')}
        >
