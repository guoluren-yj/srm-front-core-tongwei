/**
 * MultiSelectModal -lov多选框 接收者子账户
 * @date: 2020-4-29
...
export default class SubAccountModal extends PureComponent {
  ...
  render() {
    ...
    const queryFields = [
      {
        field: 'loginName',
        label: intl.get(`hptl.portalAssign.model.portalAssign.loginName`).d('账户'),
      },
      {
        field: 'userName',
        label: intl.get('hptl.portalAssign.model.portalAssign.realName').d('用户名'),
      },
    ];
    const fieldsColumn = [
      {
        title: intl.get(`hptl.portalAssign.model.portalAssign.loginName`).d('账户'),
        dataIndex: 'loginName',
        width: 150,
      },
      {
        title: intl.get('hptl.portalAssign.model.portalAssign.realName').d('用户名'),
        dataIndex: 'userName',
        width: 150,
      },
    ];
    ...
    return (
      <Modal
        ...
        title={intl.get('hptl.portalAssign.model.portalAssign.userIdList').d('接收者子账户')}
