...
export default class CompanyLink extends PureComponent {
  ...
  render() {
    ...
    const columns = [
      {
        title: intl.get('spfm.portalAssign.model.portalAssign.description').d('链接名称'),
                  ...
                  rules: [
                    {
                      ...
                      message: intl.get('hzero.common.validation.notNull', {
                        name: intl
                          .get('spfm.portalAssign.model.portalAssign.description')
                          .d('链接名称'),
                      }),
                    },
                  ],
      ...
      {
        title: intl.get('spfm.portalAssign.model.portalAssign.secondLinkUrl').d('二级门户域名地址'),
        dataIndex: 'linkUrl',
        width: 300,
        render: (text, record) => {
          if (['update', 'create'].includes(record._status)) {
                  ...
                  rules: [
                    {
                      ...
                      message: intl.get('hzero.common.validation.notNull', {
                        name: intl
                          .get('spfm.portalAssign.model.portalAssign.secondLinkUrl')
                          .d('二级门户域名地址'),
                      }),
                    },
                  ],
