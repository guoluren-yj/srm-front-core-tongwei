  ...
  return {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        lookupCode: 'SPFM.RELTABLE._COMPONENT_ORG',
      },
      {
        name: 'lov',
        type: 'object',
      ...
      },
      {
        ...
        computedProps: {
          disabled: ({ record }) =>
            ['upload', 'multiUpload'].includes(record.get('_component')) || record.get('__unique'),
        },
      },
      {
        name: 'disabled',
        ...
        computedProps: {
          disabled: ({ record }) => ['upload', 'multiUpload'].includes(record.get('_component')),
        },
      },
      {
        name: '__unique',
        ...
        computedProps: {
          disabled: ({ record }) =>
            !!record.get('multiple') ||
            ['upload', 'multiUpload'].includes(record.get('_component')),
        },
      },
      {
        ...
        computedProps: {
          disabled: ({ record }) =>
            ['upload', 'multiUpload', 'richText'].includes(record.get('_component')),
        },
      },
      {
        name: '__isHidden',
    ...
    events: {
      ...
      update: ({ record, name, value }) => {
        ...
        if (name === '__unique') {
          ...
          record.getField('required').set('disabled', value);
        }
      },
    },
  };
