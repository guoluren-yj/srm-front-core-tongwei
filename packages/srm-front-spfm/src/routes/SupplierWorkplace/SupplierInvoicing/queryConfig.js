      ...
      systemFilters: [
        {
          ...
          allFields: [
            ...
            type === 'supplier' && {
              customComparisonSet: ['='],
              fieldAlias: 'payStatus',
              fieldCode: 'payStatus',
              fieldEditable: 1,
              fieldName: intl.get(`spfm.supplierInvoic.model.payStatus`).d('支付状态'),
              fieldVisible: 1,
              lovInfo: { displayField: 'meaning', valueField: 'value' },
              modelCode: 'payStatus',
              proDefaultFlag: 0,
              ...
              widget: {
                ...
                linkNewWindow: 0,
                lovInfo: { displayField: 'meaning', valueField: 'value' },
                sourceCode: 'AMKT.SUPPLIER_PAY_STATUS',
                // lookupUrl: `${SRM_PLATFORM}/v1/${organizationId}/supplier-payment/queryAmktLov?lovCode=AMKT.TICKET_STATUS`,
              },
              gridSeq: 1,
              sortedFlag: 0,
            ...
            type === 'buyer' && {
              ...
              widget: {
                ...
                axiosConfig: {
                  method: 'GET',
                  url: `${SRM_PLATFORM}/v1/${organizationId}/supplier-payment/supplier-list?coreTenantCode=${
                    getCurrentUser().tenantNum
                  }`,
                },
