 ...
 * @param {Object} params 参数
 */
export async function updateRelTableData(tableCode, params, option) {
  const newParams = {
    ...params,
 ...
 * @param {Object} params 参数
 */
export async function getScriptLibraryRelTableData(params) {
  const { tableCode, ...queryParams } = params;
  return request(`${SRM_ADAPTOR}/v1/rel-table-records/${tableCode}/independent-script`, {
    method: 'GET',
    query: queryParams,
  });
}
