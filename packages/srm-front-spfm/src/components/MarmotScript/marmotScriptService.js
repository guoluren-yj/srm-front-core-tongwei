...
// 常用语法获取
export async function getCommonGrammar() {
  return request(`/ssc/v1/document/grammar`, {
    method: 'GET',
  });
}
 ...
 * @returns
 */
export async function getSourceCodeService(params = '') {
  return request(`/ssc/v1/source/common-js?path=${params}`, {
    method: 'GET',
    responseType: 'text',
  });
}
