  ...
  return (
    <div className="treeNameStyle">
      <Tree
        ...
        renderer={({ record }) => (
          <Tooltip placement="right" title={`【${record.get('name')}】-【${record.get('code')}】`}>
            <div className="boxContent">
              <div style={{ color: 'black' }}>
                ...
                />
                <span className="boxContent-text">{record.get('name')}</span>
              </div>
              <div className="boxContent-text" style={{ marginLeft: '20px' }}>
                {record.get('code')}
              </div>
            </div>
          </Tooltip>
