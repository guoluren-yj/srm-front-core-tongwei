/**
 * externalSystemAssign - 外部系统分配 - medal
 * @date: 2018-12-17
...
import {
  ...
  // saveESService,
  // fetchESInfo,
} from '@/services/externalSystemAssignService';

export default {
  namespace: 'externalSystemAssign',
  state: {
    esInfo: {}, // 外部系统信息
    pagination: {}, // 外部系统分页信息
    // 外部系统列表数据
  ...
  effects: {
    ...
    *fetchCompanyData({ payload }, { call, put }) {
      ...
      const data = getResponse(response);
      const res = yield call(queryCheckedCompany, payload);
