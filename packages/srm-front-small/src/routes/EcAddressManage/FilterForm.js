...
@CacheComponent({ cacheKey: '/small/ec-address-manage/list' })
        ...
        <Form layout="inline" className="more-fields-form">
          <Row gutter={12}>
            <Col span={6}>
              <Form.Item
                {...formLayout}
                label={intl.get('small.ecAddressManage.model.Ec.platform.coding').d('电商平台编码')}
              >
            ...
            <Col span={6}>
              <Form.Item
                {...formLayout}
                label={intl.get('small.ecAddressManage.Ec.platform.name').d('电商平台名称')}
              >
