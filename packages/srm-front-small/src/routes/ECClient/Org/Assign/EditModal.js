    ...
    return (
      ...
      >
        <Form>
          <FormItem
            {...formLayout}
            label={intl.get('small.assign.model.assign.companyNum').d('公司编码')}
          >
              ...
              rules: [
                {
                  ...
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('small.assign.model.assign.companyNum').d('公司编码'),
                  }),
                },
              ],
            })(<Input trim disabled />)}
          ...
          <FormItem
            {...formLayout}
            label={intl.get('small.assign.model.assign.companyName').d('公司名称')}
          >
              ...
              rules: [
                {
                  required: true,
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('small.assign.model.assign.companyName').d('公司名称'),
                  }),
                },
              ],
            })(
          ...
          <FormItem
            {...formLayout}
            label={intl.get('small.assign.model.assign.currencyName').d('默认币种')}
          >
              ...
              rules: [
                {
                  required: true,
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('small.assign.model.assign.currencyName').d('默认币种'),
                  }),
                },
              ],
            })(
          ...
          <FormItem
            {...formLayout}
            label={intl.get('small.assign.model.assign.uomName').d('默认计量单位')}
          >
              ...
              rules: [
                {
                  required: true,
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('small.assign.model.assign.uomName').d('默认计量单位'),
                  }),
                },
              ],
            })(
