...
export default function LevelTable(props) {
  ...
  const textMap = {
    1: intl.get('sdat.riskScanConfig.view.tag.lowRisk').d('低风险'),
    2: intl.get('sdat.riskScanConfig.view.tag.middleRisk').d('中风险'),
    3: intl.get('sdat.riskScanConfig.view.tag.highRisk').d('高风险'),
  };
