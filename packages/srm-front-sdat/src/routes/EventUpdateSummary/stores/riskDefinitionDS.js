...
const DefinitionListDS = () => ({
  transport: {
    ...
    destroy: ({ data }) => {
      return {
        url: `${SRM_DATA_SDAT}/v1/event-generate-monitor/batch-delete`,
        data,
        method: 'POST',
      };
    },
...
const AccountListDS = () => ({
  ...
  transport: {
    read: ({ data, params }) => {
      ...
      return {
        url: `${HZERO_IAM}/hzero/v1/users/have/company/paging`,
        params: {
          ...data,
          ...params,
        },
...
const AccountViewListDS = () => ({
  ...
  transport: {
    read: ({ data, params }) => {
      return {
        url: `${SRM_DATA_SDAT}/v1/event-generate-monitor/query-person`,
        params: {
          ...data,
          ...params,
        },
...
export { DefinitionListDS, RatioFormDS, AccountListDS, AccountViewListDS };
