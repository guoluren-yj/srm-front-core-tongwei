...
import { Form, Output, Spin, Attachment, DataSet } from 'choerodon-ui/pro';
...
import {
  ...
  fetchMonitorMsg,
  // fetchSupplierMsg,
} from '@/services/eventUpdateSumService';

import { AttachmentDS } from '../stores/eventUpdateSummaryDS';
...
export default function RiskIncidentDetail(props) {
  const { dataSet, localRecord, tenantId = '', userId = '' } = props;
  ...
  //       path,
  //       pathname: path,
  //       search: `?companyId=${companyId}&partnerTenantId=${partnerTenantId}&supplierCompanyId=${supplierCompanyId}&tenantId=${
  //         obj?.tenantId ?? ''
  //       }&pageType=readOnly`,
  //     },
  //     match: {
