...
import { fetchLevelChartData } from '@/services/riskWorkPlaceService';
...
export default function RiskLevelDistribution(props) {
  ...
  useEffect(() => {
    const dom = document.getElementById('risk-workplace-risk-level-distribution-chart-panel');
    refreshChart();
  ...
  const refreshChartResize = () => {
    if (riskLevelDistributionChart) {
      const heig = document.getElementById('sdat-risk-level-distribution-chart').height;
      const wid = document.getElementById('sdat-risk-level-distribution-chart').width;
  ...
  const refreshChart = () => {
    riskLevelDistributionNode = document.getElementById('sdat-risk-level-distribution-chart');
  ...
  return (
    <>
      <div
        ...
        id="risk-workplace-risk-level-distribution-chart-panel"
      >
        <span
          style={{
            fontSize: '16px',
      ...
      <div
        id="sdat-risk-level-distribution-chart"
        style={{
          // minWidth: '160px',
          minHeight: '160px',
          flex: '1 1 auto',
