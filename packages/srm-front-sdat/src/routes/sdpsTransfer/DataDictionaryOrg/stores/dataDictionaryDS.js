...
const DataFormDS = () => ({
  transport: {
    read: ({ data, params }) => {
      return {
        url: `${SRM_DATA_SDAT}/v1/${organizationId}/meta-table/${data.metaId}`,
        params: {
          ...data,
          ...params,
        },
...
const ColumnsAttrDS = () => ({
  transport: {
    read: ({ data, params }) => {
      return {
        url: `${SRM_DATA_SDAT}/v1/${organizationId}/meta-table/columns`,
        params: {
          ...data,
          ...params,
        },
...
const SubHistoryDS = () => ({
  ...
  transport: {
    read: ({ data, params }) => {
      return {
        url: `${SRM_DATA_SDAT}/v1/${organizationId}/data-table-manages/table-op-history`,
        params: {
          ...data,
          ...params,
        },
...
const LovDS = () => ({
  ...
  transport: {
    read: ({ data, params }) => {
      return {
        url: `${SRM_DATA_SDAT}/v1/${organizationId}/data-table-manages/topic-subscribe-table-list`,
        params: {
          ...data,
          ...params,
        },
  ...
  fields: [
    ...
    //   name: 'selectTable',
    //   type: 'object',
    //   lovCode: 'SDAT.DATATABLE_TOPIC_SUBSCRIPTION',
    //   textField: 'topicName',
    //   noCache: true,
    //   multiple: true,
    //   lovQueryAxiosConfig: () => {
