...
import { getTaskStatistics, getDataList } from '@/services/sdpsTransfer/dataDisplayService';
    ...
    <>
      <div className="monitor-area">
        ...
        <DataCard
          ...
          totalTitle={`${statisData?.syncSuccessRows ?? 0} ${intl
      ...
      <div style={{ padding: '8px' }}>
        ...
        <div style={{ marginTop: '8px', height: `calc(100vh - 465px)`, paddingBottom: '10px' }}>
          <Table
            size="small"
            customizable
            customizedCode="SDAT.CLOUD_WARE_HOUSE_PLATFORM"
            dataSet={listDS}
            queryBar="none"
            columns={columns()}
