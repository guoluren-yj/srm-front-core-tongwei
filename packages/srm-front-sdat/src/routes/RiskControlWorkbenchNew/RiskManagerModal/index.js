    ...
    <div className={styles['risk-manager-modal']}>
      <div className={styles['risk-manager-modal-left']}>
        <div style={{ fontWeight: '600', fontSize: '16px' }}>
          {intl
            .get('sdat.riskNewDefinition.view.title.selectBroadcasterPerson')
            .d('选择风险广播人')}
        </div>
        <div style={{ marginTop: '16px', height: 'calc(100vh - 170px)' }}>
          <Table {...tableProps} />
        </div>
      </div>
      <div>
        ...
        >
          {intl.get('sdat.riskNewDefinition.view.message.selectCount', { name: uniList.length })}
        </div>
