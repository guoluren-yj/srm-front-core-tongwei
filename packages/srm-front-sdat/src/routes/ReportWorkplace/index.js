...
export default class ReportConfig extends React.Component {
  ...
  async componentDidMount() {
    ...
    drawPanelWidth = document.getElementById('workplace-card-config-col')?.offsetWidth ?? 0; // 获取画板宽度
  }
          ...
          .then((res) => {
            ...
            if (getResponse(res)) {
              ...
              _self.setState(
                ...
                () => {
                  drawPanelWidth =
                    document.getElementById('workplace-card-config-col')?.offsetWidth ?? 0; // 获取画板宽度
                  _self.forceUpdate();
                }
              );
  ...
  render() {
    ...
    const modalWidth = document.getElementById('workplace-card-select-col-5')?.clientWidth ?? 306;
          ...
          >
            <DndProvider backend={HTML5Backend}>
              <Row>
                ...
                {setting ? (
                  <Col span={5} id="workplace-card-select-col-5">
                    <CardScrollComp
                      setting={setting}
