...
export default function BasicForm({ companyDetail }) {
  return (
    <div className={styles['rick-scan-basic-form']}>
      ...
      <Row style={{ border: '1px solid #E5E7EC', borderTop: 'unset', lineHeight: '32px' }}>
        ...
        <Col span={8} style={{ display: 'flex' }}>
          ...
          <div className={styles['risk-scan-form-item']}>{companyDetail?.stdRegistCapi ?? ''}</div>
        </Col>
        ...
        <Col span={8} style={{ display: 'flex' }}>
          ...
          <div className={styles['risk-scan-form-item']}>{companyDetail?.stdActualCapi ?? ''}</div>
        </Col>
      </Row>
      ...
      <Row style={{ border: '1px solid #E5E7EC', borderTop: 'unset', display: 'flex' }}>
        <Col span={24} style={{ display: 'flex', alignItems: 'center' }}>
          <div
            ...
            style={{ display: 'flex', alignItems: 'center', height: '100%', marginRight: '-16px' }}
          >
