...
import { fetchApproveDetail } from '@/services/riskNewWorkPlaceService'; // fetchDynamicDetail
...
@formatterCollections({
  code: ['sdat.riskControl', 'sdat.monitorStuff', 'sdat.riskDefinition', 'sdat.eventStuff'],
})
      ...
      <Spin spinning={loading}>
        <div style={{ backgroundColor: '#f4f5f7', padding: '8px' }}>
          ...
          >
            ...
            <Form dataSet={this.disposalDS} columns={2} labelLayout="float">
