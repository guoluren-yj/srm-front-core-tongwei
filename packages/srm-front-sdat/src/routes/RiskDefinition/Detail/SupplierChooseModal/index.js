...
const CompanyChooseModal = (props) => {
  ...
  useEffect(() => {
    ...
    companyLovDS.addEventListener('batchUnSelect', batchUnSelect);
    ...
    return () => {
      ...
      companyLovDS.removeEventListener('batchUnSelect', batchUnSelect);
      companyLovDS.data = [];
  ...
  useEffect(() => {
    ...
    // }
    companyLovDS.setQueryParameter('parentCategoryId', 0);
    companyLovDS.query();
  }, [selectedIds]);
