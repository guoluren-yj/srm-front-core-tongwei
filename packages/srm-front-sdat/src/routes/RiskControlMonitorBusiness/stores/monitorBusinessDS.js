...
const MonitorListDS = () => ({
  ...
  fields: [
    ...
    {
      label: intl.get('sdat.monitorBusiness.model.addMonitorTime').d('添加监控时间'),
      name: 'addMonitorTime',
      type: 'dateTime',
    },
    {
    ...
    {
      label: intl.get('sdat.monitorBusiness.model.isCooperate').d('是否合作'),
      name: 'cooperationFlag',
      type: 'string',
      lookupCode: 'SDAT.WORKBENCH_COOPERATION_FLAG',
    },
  ],
  events: {},
});
