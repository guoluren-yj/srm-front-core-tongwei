...
export async function fetchPagePermission(params) {
  return request(
    `${SRM_DATA_SDAT}/v1/${getCurrentOrganizationId()}/diligence-report/risk-order-open`,
    {
      method: 'GET',
      query: {
        ...params,
...
export async function fetGenerateReport(params) {
  return request(
    `${SRM_DATA_SDAT}/v1/${getCurrentOrganizationId()}/diligence-report/risk-report-order`,
    {
      method: 'POST',
      body: params,
    }
