...
export async function getTaskStatistics(params) {
  return request(`${SRM_DATA_SDAT}/v1/monitor-analysis/latest-task-statistics`, {
    method: 'GET',
    query: params,
  });
}
...
export async function getDataList(params) {
  return request(`${SRM_DATA_SDAT}/v1/monitor-analysis/task-details-list`, {
    method: 'GET',
    query: params,
  });
}
...
export async function getOpenService(params) {
  return request(`${SRM_DATA_SDAT}/v1/monitor-analysis/get-open-service`, {
    method: 'GET',
    query: params,
  });
}
...
export async function getStatisticsData(params) {
  return request(`${SRM_DATA_SDAT}/v1/monitor-analysis/seep-invoke/${params.ruleCode}`, {
    method: 'GET',
    query: params,
  });
}
...
//   return request(`${SRM_DATA_SDAT}/v1/monitor-analysis/open-file-service`, {
//     method: 'GET',
//     query: params,
//     responseType: 'text',
//   });
