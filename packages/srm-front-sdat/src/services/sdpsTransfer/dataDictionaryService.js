...
export async function getPendingCount(params) {
  return request(`${SRM_DATA_SDAT}/v1/${organizationId}/meta-table/pending-count`, {
    method: 'GET',
    query: params,
  });
}
...
export async function getRejectedCount(params) {
  return request(`${SRM_DATA_SDAT}/v1/${organizationId}/meta-table/reject-count`, {
    method: 'GET',
    query: params,
  });
}
...
export async function getAllCount(params) {
  return request(`${SRM_DATA_SDAT}/v1/${organizationId}/meta-table/subscribed-count`, {
    method: 'GET',
    query: params,
  });
}
...
export async function getMetaConfig(params) {
  return request(`${SRM_DATA_SDAT}/v1/${organizationId}/meta-table/config/${params.metaId}`, {
    method: 'GET',
    query: params,
  });
}
...
export async function saveSubscribeTopic(params) {
  return request(`${SRM_DATA_SDAT}/v1/${organizationId}/data-table-manages/subscribe-topic`, {
    method: 'POST',
    body: params,
  });
}
 ...
 * @returns
 */
export async function fetchTenantMessage(params) {
  return request(`${SRM_DATA_SDAT}/v1/common-platform/${organizationId}/tenant-info`, {
    method: 'GET',
    query: params,
  });
}
