...
export async function getCompanyList(params) {
  return request(`${SRM_DATA_SDAT}/v1/${tenantId}/credit-qcc/unzip-company-list`, {
    headers: {
      ...header,
    },
    method: 'GET',
...
export async function fetchReMining(params) {
  return request(`${SRM_DATA_SDAT}/v1/${tenantId}/relation-mining-record/relation-mining`, {
    headers: {
      ...header,
    },
    method: 'POST',
...
export async function fetchRelationMining(params) {
  return request(`${SRM_DATA_SDAT}/v1/${tenantId}/credit-qcc/enterprise-relation-mining`, {
    headers: {
      ...header,
    },
    method: 'POST',
