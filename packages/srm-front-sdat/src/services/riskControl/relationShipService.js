...
import { getResponse, getRequestId, getAccessToken } from 'utils/utils'; // getAccessToken
...
export async function fetchExportPath(params) {
  const url = `${SRM_DATA_SDAT}/v1/${tenantId}/credit-qcc/enterprise-relation-export?fillerType=single-sheet&async=false&singleSheetMaxRow=1048575&singleExcelMaxSheetNum=5&exportType=DATA&ids=2&ids=3`;
