...
module.exports = {
  ...
  hzeroMS: {
    exposes: {
      './lib/routers/RiskControlMonitorBusiness': './src/routes/RiskControlMonitorBusiness',
      './lib/routers/RiskSupplierBlack': './src/routes/RiskControlWorkbench/SupplierBlacklistManage',
      './lib/routers/RiskDefiniton/Detail': './src/routes/RiskDefinition/Detail',
      './lib/routers/RiskDefiniton': './src/routes/RiskDefinition',
    },
  },
};
