...
import 'components/Lov/index.less';
import { queryLovData } from 'hzero-front/lib/services/api';
...
class LovModal extends React.Component {
  ...
  queryData(pagination = {}) {
    ...
    const { pageSize, lovCode, lovTypeCode, queryFields = [] } = this.props.lov;
    let { queryUrl } = this.props.lov; // /hmde/v1/{organizationId}/tables/{appId}/list
    const { queryParams = {}, queryUrlPro } = this.props;
    if (queryUrlPro) {
      queryUrl = queryUrlPro;
    }
