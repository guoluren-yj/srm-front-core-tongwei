...
const TLoaderMsg = new Map([
  ['pullingMsg', intl.get('hzero.common.view.load.pullingMsg').d('下拉刷新')],
  ['pullingEnoughMsg', intl.get('hzero.common.view.load.pullingEnoughMsg').d('松开刷新')],
  ['refreshingMsg', intl.get('hzero.common.view.load.refreshingMsg').d('正在刷新...')],
  ['refreshedMsg', intl.get('hzero.common.view.load.refreshedMsg').d('刷新成功')],
  ['loadingMsg', intl.get('hzero.common.view.load.loadingMsg').d('正在加载...')],
  ['btnLoadMore', intl.get('hzero.common.view.load.btnLoadMore').d('点击加载更多')],
]);
    ...
    const footer = hasMore ? (
      <div className="tloader-footer">
        <div className="tloader-btn" onClick={this.loadMore}>
          {TLoaderMsg.get('btnLoadMore')}
        </div>
        <div className="tloader-loading">
          <i className="ui-loading" />
          {TLoaderMsg.get('loadingMsg')}
        </div>
      </div>
    ) : null;
...
export default formatterCollections({ code: ['hzero.common'] })(Tloader);
