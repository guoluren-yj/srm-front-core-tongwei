...
import ModalContainer, { registerContainer } from 'hzero-front/lib/components/Modal/ModalContainer';
import { ModalContainer as C7nModalContainer } from 'choerodon-ui/pro';
import Authorized from 'hzero-front/lib/components/Authorized/WrapAuthorized';
import PermissionProvider from 'hzero-front/lib/components/Permission/PermissionProvider';

import LocalProviderAsync from 'hzero-front/lib/utils/intl/LocaleProviderAsync';
import { dynamicWrapper } from 'hzero-front/lib/utils/router';
import { initIoc } from 'hzero-front/lib/utils/iocUtils';
