...
import { Form, Input, Modal, Popconfirm, Spin, Tabs, Tag, Button } from 'hzero-ui';
...
import Upload from 'hzero-front/lib/components/Upload/UploadButton';
import intl from 'hzero-front/lib/utils/intl';
import { BKT_HITF } from 'hzero-front/lib/utils/config';
...
export default class EditModal extends Component {
  ...
  render() {
    ...
    const { rawValue, selectedRowKeys, batchDeleteLoading } = this.state;
