          ...
          <Col span={5}>
            <FormItem
              ...
              label={
                <QuestionPopover
                  text={intl
                    .get('hitf.services.model.services.interfaceContextDigest')
                    .d('路由摘要')}
                  message={intl
                    .get('hitf.services.model.services.interfaceContextDigestTip')
                    .d('v2p版本接口透传路由上下文信息base64摘要')}
                  iconStyle={{ marginLeft: 2, textIndent: 0, marginTop: 4 }}
                />
              }
            >
              {getFieldDecorator(
                'interfaceContextDigest',
                {}
