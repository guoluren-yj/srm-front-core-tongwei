...
const platformResData = () => ({
  fields: [
    ...
    },
    {
      name: 'module',
      type: FieldType.string,
      label: intl.get(`scux.interfaceFlowControl.model.interfaceFlowControl.module`).d('所属模块'),
    ...
    read: () => {
      return {
        url: isTenantRoleLevel()
          ? `${SRM_INTERFACE}/v1/${getCurrentOrganizationId()}/request-limit-cnf/single`
          : `${SRM_SIFC}/v1/request-limit-cnf/single`,
        method: 'GET',
      };
    },
  },
