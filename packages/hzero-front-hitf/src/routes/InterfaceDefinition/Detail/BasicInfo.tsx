...
import { DataSet, Form, TextField, TextArea, Select, Lov, Row, Col, IntlField } from 'choerodon-ui/pro';
...
const BasicInfo: React.FC<BasicInfoProps> = ({ formDs, serviceType, editFlag }) => {
  ...
  return (
    <div className={styles['basic-info']}>
      <Form labelLayout={LabelLayout.float} dataSet={formDs}>
        <Row gutter={16}>
          <Col span={6}>
            <TextField name="interfaceCode" restrict={/[\u4e00-\u9fa5]/g} disabled={editFlag} />
          </Col>
          <Col span={6}>
            <IntlField name="interfaceName" />
          </Col>
          <Col span={6}>
            <Lov name="tenantLov" disabled={isTenantRoleLevel()} />
          </Col>
        </Row>
        <Row gutter={16}>
          <Col span={6}>
