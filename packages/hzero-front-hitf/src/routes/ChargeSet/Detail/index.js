...
import { getResponse, getCurrentOrganizationId, isTenantRoleLevel } from 'hzero-front/lib/utils/utils';
 ...
 */
@formatterCollections({ code: ['hzero.common', 'hitf.chargeSet', 'hitf.chargeGroup'] })
      ...
      <>
        ...
        <Content>
          <Card
            ...
            title={<h3>{intl.get('hzero.common.view.baseInfo').d('基本信息')}</h3>}
          >
