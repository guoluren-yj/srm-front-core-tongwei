 ...
 */
@formatterCollections({ code: ['hzero.common', 'hitf.chargeSet', 'hitf.purchase'] })
@withProps(
  () => {
    // 接口/服务计费设置头 数据源
          ...
          <Table
            ...
            columns={[
              ...
              },
              {
                ...
                align: 'center',
                renderer: ({ value, record }) =>
                  TagRender(value, CHARGE_TYPE_TAGS, record.get('typeMeaning')),
              },
              {
                name: 'serverCode',
                width: 240,
              ...
              },
              {
                ...
                align: 'center',
                renderer: ({ value, record }) =>
                  TagRender(value, CHARGE_SET_STATUS_TAGS, record.get('statusMeaning')),
              },
              {
