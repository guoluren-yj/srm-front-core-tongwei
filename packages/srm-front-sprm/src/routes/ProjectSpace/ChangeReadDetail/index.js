...
const Index = function Index(props) {
  ...
  const headerUnitCode = 'SIEC.PROJECT_CHANGE.BASEINFO,SIEC.PROJECT_CHANGE.ATTACH';
  const taskUnitCode = 'SIEC.PROJECT_CHANGE.TASK,SIEC.PROJECT_CHANGE.TASK_FILTER';
  const purListUnitCode = 'SIEC.PROJECT_CHANGE.PUR_LIST,SIEC.PROJECT_CHANGE.PUR_FILTER';
