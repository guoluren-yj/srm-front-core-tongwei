 ...
 * @version:
 * @Author: yanglin
 * @Date: 2022-05-31 11:59:52
 * @LastEditors: yanglin
 * @LastEditTime: 2023-01-10 11:38:01
 */
...
export default class CommonImportRoute extends React.Component {
  constructor(props) {
    ...
    const {
      ...
      historyButton = 'true',
      refreshButton = 'true',
    } = modal ? props : queryString.parse(search);
    this.state = {
      sync, // 是否是同步的接口
      auto, // 是否是 同步自动的接口
      ...
      code: modal ? props.code : params.code,
      action,
      actionParams,
      key,
      historyButton,
      refreshButton,
      isShowImportDataButton: isShowImportDataButton === 'true',
    };
  }
  ...
  render() {
    ...
    return (
      <CommonImport
        ...
        isShowImportDataButton={isShowImportDataButton}
      />
    );
  }
}
