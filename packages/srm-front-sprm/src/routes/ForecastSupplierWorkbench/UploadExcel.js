...
export default class UploadExcel extends React.Component {
  ...
  @Bind()
  beforeUpload(file) {
    const { param = {}, success = (e) => e, tenantId, templateHeaderId, remote } = this.props;
    ...
    const body = remote.process('SPRM_FORECAST_UPLOAD_EXCEL_BODY', formData, {remoteThis: this})

    request(url, {
      method: 'POST',
      query: { ...param, templateHeaderId },
      body,
      responseType: 'text',
    })
      .then((res) => {
