  ...
  const HeaderBtn = observer(() => {
    ...
    return (
      <>
        {customizeBtnGroup(
          {
            code: 'SIEC.MOULD_REQ_SUPPLIER.BTN',
            pro: true,
          },
          <DynamicButtons
            buttons={headerButtons}
            permiisSuppliersions={
              supplierUrlFlag
                ? [
                    {
    ...
    <Fragment>
      ...
      <Content>
        <div style={{ height: 'calc(100vh - 200px)' }}>
          {customizeTable(
            {
              code: 'SIEC.MOULD_REQ_SUPPLIER.LIST',
              dataSet: lineDs,
            },
            <SearchBarTable
              style={{ maxHeight: `calc(100vh - 200px)` }}
              searchCode="SIEC.MOULD_REQ_SUPPLIER.SEARCH"
              dataSet={lineDs}
              cacheState
              columns={lineColumns}
              searchBarConfig={{
                ...
                fieldProps: {
                  companyId: { lovPara: { supplierTenantId: getUserOrganizationId() } },
                },
...
export default compose(
  ...
  withCustomize({
    unitCode: [
      'SIEC.MOULD_REQ_SUPPLIER.SEARCH',
      'SIEC.MOULD_REQ_SUPPLIER.LIST',
      'SIEC.MOULD_REQ_SUPPLIER.BTN',
    ],
  })
)(Index);
