...
export default class PlanSheet extends Component {
  ...
  onJumpDetail(record) {
    ...
    history.push({
      pathname: `/scux/qwkj/plan-sheets/detail/${record.planHeaderId}`,
    });
  }
          ...
          {radioTab === 'list' ? (
            <Fragment>
              <Button
                ...
                disabled={
                  isArray(selectedCreateRowKeys) &&
                  isEmpty(selectedCreateRowKeys) &&
                  selectedCreateRowKeys.length !== 1
                }
              >
              ...
              <ExcelExport
                ...
                requestUrl={`${SRM_CUSTOMIZATION}/v1/${tenantId}/cux/qwkj/schedule/create-query/export`}
              />
              <ExcelExport
