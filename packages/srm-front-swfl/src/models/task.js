...
export default {
  ...
  state: {
    ...
    userPagination: {},
    fileCount: null,
    queryParameter: {}, // 列表页查询条件
    quickReplyArr: [], // 快捷回复查询值
    replyValueNew: '', // 快捷回复值
    replyQueryFlag: false, // 是否查询过快捷回复
    approvalActionTooltipMap: {}, // 操作按钮气泡提示
    approvalActionSeqMap: {},
    msgTabCloseFlag: 0, // 1-关闭，0-不关闭，默认为0
  },
  effects: {
  ...
  reducers: {
    ...
    updateQuickReplyArr(state, { payload }) {
      return {
        ...state,
        quickReplyArr: payload,
        replyQueryFlag: true,
      };
    },
    updateReplyValueNew(state, { payload }) {
      return {
        ...state,
        replyValueNew: payload,
      };
    },
