...
import { Popover, Spin, Table, Checkbox, Icon } from 'hzero-ui';
    ...
    return (
      ...
      >
        <div
          ...
          name="svgDiv"
          style={{
            width: BigNumber.isBigNumber(grapINfo.width)
              ? grapINfo.width.toNumber()
              : grapINfo.width,
            height: BigNumber.isBigNumber(grapINfo.height)
