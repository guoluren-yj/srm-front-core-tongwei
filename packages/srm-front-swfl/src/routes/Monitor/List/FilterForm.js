              ...
              <React.Fragment>
                <Row>
                  ...
                  <Col {...FORM_COL_3_LAYOUT}>
                    <Form.Item
                      label={intl.get('hwfp.monitor.model.process.ID').d('流程标识')}
                ...
                <Row style={{ display: display ? 'none' : 'block' }}>
                  <Col {...FORM_COL_3_LAYOUT}>
                    <Form.Item
                      label={intl.get('hwfp.monitor.model.process.description').d('流程描述')}
                      {...SEARCH_FORM_ITEM_LAYOUT}
                    >
                  ...
                  <Col span={8}>
                    ...
                    >
                      {getFieldDecorator('startedAfter', {
                        initialValue: moment().subtract(6, 'months'),
                      })(
                        <DatePicker
                          format={dateFormat}
                          placeholder=""
                          disabledDate={(currentDate) =>
                            (getFieldValue('startedBefore') &&
                              moment(getFieldValue('startedBefore')).isBefore(
                                currentDate,
                                'day'
                              ))
                          }
