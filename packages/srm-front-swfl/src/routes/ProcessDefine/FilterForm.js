...
export default class FilterForm extends PureComponent {
   ...
   */
  render() {
    const { isSiteFlag, processDefineSourceTypes, form, customizeFilterForm } = this.props;
    const { getFieldDecorator } = form;
    if (isSiteFlag) {
      return (
        <Form layout="inline" className="more-fields-search-form">
          <Row {...SEARCH_FORM_ROW_LAYOUT} type="flex" gutter={24} align="top">
            <Col span={18}>
    ...
    return customizeFilterForm(
      { code: 'HWFP.PROCESS_DEFINITION.QUERY', form, expand: true },
      <Form layout="inline" className="more-fields-search-form">
        <Row {...SEARCH_FORM_ROW_LAYOUT} gutter={24} align="bottom">
          <Col span={18}>
            <Row {...SEARCH_FORM_ROW_LAYOUT} gutter={24} align="bottom">
              <Col span={8}>
                <Form.Item
                ...
                >
                  {getFieldDecorator('category')(
                    <Lov code="HWFP.PROCESS_CATEGORY" queryParams={{ tenantId: organizationId }} />
                  )}
                </Form.Item>
              </Col>
              <Col span={8}>
                ...
                >
                  {getFieldDecorator('key')(
                    <Input typeCase="upper" trim={false} trimAll inputChinese={false} />
                  )}
                </Form.Item>
              </Col>
              <Col span={8}>
            ...
            <Row {...SEARCH_FORM_ROW_LAYOUT} type="flex" gutter={24} align="bottom">
              ...
              <Col span={8}>
                ...
                >
                  {getFieldDecorator('processDefineSource')(
                    <Select allowClear>
                      {processDefineSourceTypes.map((type) => (
