...
export default class ListTable extends Component {
  ...
  changeDetail(record) {
    ...
    const tabKey = `/hwfp/carbon-copy-task/detail/:id-${processDefinitionKey}`;
    this.getWindow()
      ...
      .then(() => {
        ...
        this.getWindow().openTab({
          title: `${processName}`,
          key: tabKey,
          path: `/hwfp/carbon-copy-task/detail/${encryptId}`,
          icon: 'edit',
          closable: true,
          state: {
            approveFormParams: {
    ...
    // openTab({
    //   title: `${processName}`,
    //   key: `/hwfp/carbon-copy-task/detail/${encryptId}`,
    //   path: `/hwfp/carbon-copy-task/detail/${encryptId}`,
    //   icon: 'edit',
    //   closable: true,
    //   state: {
