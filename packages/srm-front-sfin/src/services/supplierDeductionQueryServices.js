...
export async function queryList(params) {
  ...
  return request(`${SRM_FINANCE}/v1/${organizationId}/supplier-deduction/list/page`, {
    method: 'GET',
    query,
  });
}
...
export async function save(body) {
  return request(`${SRM_FINANCE}/v1/${organizationId}/supplier-deduction/list/batch-update`, {
    method: 'POST',
    body,
  });
}

export async function back(body) {
  return request(`${SRM_FINANCE}/v1/${organizationId}/supplier-deduction/list/batch-back`, {
    method: 'POST',
    body,
  });
}
