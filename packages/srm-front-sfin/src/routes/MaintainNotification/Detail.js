...
export default class CreateDetail extends PureComponent {
  ...
  handleSave() {
    ...
    //   return;
    // }
    if (!isEmpty(infDataSource) && isEmpty(tableDate)) {
      this.tabChange('inf');
      return;
    }
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Header
          backPath={backPath}
          title={intl.get(`${promptCode}.view.message.title.MaintainNotification`).d('开票单维护')}
        >
          {isCreator && (
            <React.Fragment>
              ...
              {['INFORM_REJECTED', 'DISAPPROVED'].includes(billStatus) && (
              ...
              >
                <div style={{ marginBottom: 16, textAlign: 'right' }}>
                  <PermissionButton
                    ...
                    permissionList={[
                      {
                        code: `srm.finance.purchase-bill.inform-update.ps.button.detailline.delete`,
                        type: 'button',
                      },
                    ]}
                  >
                  ...
                  <PermissionButton
                    ...
                    permissionList={[
                      {
                        code: `srm.finance.purchase-bill.inform-update.ps.button.detailline.create`,
                        type: 'button',
                      },
                    ]}
                  >
