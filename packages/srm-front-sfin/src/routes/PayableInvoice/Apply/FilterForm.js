          ...
          <Col span={18}>
            <Row>
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`${promptCode}.model.payableInvoice.displayTrxNumber`)
                    .d('事务编号')}
                >
            ...
            <Row style={{ display: expandForm ? 'block' : 'none' }}>
              ...
              <Col span={8}>
                ...
                >
                  {getFieldDecorator('srmPoNum')(<Input />)}
                </FormItem>
              </Col>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`${promptCode}.model.payableInvoice.invoiceTypeCode`)
                    .d('发票类型')}
                >
              ...
              <Col span={8}>
                <Form.Item
                  label={intl
                    .get(`${promptCode}.model.payableInvoice.deliverTimeFrom`)
                    .d('妥投日期从')}
                  {...formItemLayout}
                >
                  {getFieldDecorator('deliverTimeFrom')(
                    <DatePicker
                      disabledDate={(currentDate) =>
                        getFieldValue('deliverTimeTo') &&
                        moment(getFieldValue('deliverTimeTo')).isBefore(currentDate, 'day')
                      }
                      format={dateFormat}
                      placeholder=""
                    />
              ...
              <Col span={8}>
                <Form.Item
                  label={intl
                    .get(`${promptCode}.model.payableInvoice.deliverTimeT`)
                    .d('妥投日期至')}
                  {...formItemLayout}
                >
                  {getFieldDecorator('deliverTimeTo')(
                    <DatePicker
                      disabledDate={(currentDate) =>
                        getFieldValue('deliverTimeFrom') &&
                        moment(getFieldValue('deliverTimeFrom')).isAfter(currentDate, 'day')
                      }
                      format={dateFormat}
                      placeholder=""
                    />
