...
@withCustomize({
  unitCode: ['SFIN.INVOICE_SUPPLIER_LIST.LINE', 'SFIN.INVOICE_SUPPLIER_LIST.INVOICE_FILTER'],
})
...
export default class InvoiceLineTab extends Component {
  ...
  componentDidMount() {
    ...
    this.handleSearch(pagination.supplierInvoice);
  }
  ...
  render() {
    ...
    const tableProps = {
      loading,
      dataSource: list.supplierInvoice && list.supplierInvoice.content,
      columns,
      rowSelection,
      bordered: true,
      rowKey: 'invoiceLineId',
      onChange: this.handleSearch,
      pagination: pagination.supplierInvoice,
    ...
    return (
      <Fragment>
        {customizeFilterForm(
          {
            code: 'SFIN.INVOICE_SUPPLIER_LIST.INVOICE_FILTER',
            form,
            expand,
          },
        ...
        {customizeTable(
          {
            code: 'SFIN.INVOICE_SUPPLIER_LIST.LINE', // 单元编码，必传
          },
