...
const remoteProcessCode = 'SFIN_INVOICE_CREATE_PURCHASER_DETAIL_VALIDATE';
const remoteOcrTitleCode = 'SFIN_INVOICE_CREATE_PURCHASER_DETAIL_CUX.OCR_TITLE';
const remoteBtnCreateCode = 'SFIN_INVOICE_CREATE_PURCHASER_DETAIL_CUX.CREATE_SHOW_FLAG';

@remote({
  code: 'SFIN_INVOICE_CREATE_PURCHASER_DETAIL',
  name: 'remote',
})
...
export default class CreateDetail extends Component {
            ...
            dispatch({
              ...
              if (res) {
                ...
                const remoteRes = remoteProps.process(
                  'SFIN_INVOICE_CREATE_PURCHASER_DETAIL.BTNS_SAVE',
                  true
                );
  ...
  render() {
    ...
    console.log(cancelAsyncPushFlag);
    const {
      form,
      dispatch,
      loading = false,
