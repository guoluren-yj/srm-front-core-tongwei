...
@withCustomize({
  unitCode: ['SFIN.BILL_SALE_LIST.DETAIL_GRID'],
})
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        width: 100,
        render: (text, record) => {
          if (record.priceShieldFlag) {
            return record.netPriceMeaning;
          } else {
            return thousandBitSeparatorDJ(text, record.pricePrecision);
          }
        },
      },
      {
      ...
      },
      {
        ...
        render: (text, record) => {
          if (record.priceShieldFlag) {
            return record.netAmountMeaning;
          } else {
            return thousandBitSeparator(text, record.amountPrecision);
          }
        },
      },
      {
      ...
      },
      {
        ...
        render: (text, record) => {
          if (record.priceShieldFlag) {
            return record.taxIncludedPriceMeaning;
          } else {
            return thousandBitSeparatorDJ(text, record.pricePrecision);
          }
        },
      },
      {
        ...
        render: (text, record) => {
          if (record.priceShieldFlag) {
            return record.taxIncludedAmountMeaning;
          } else {
            return thousandBitSeparator(text, record.amountPrecision);
          }
        },
      },
      {
        ...
        render: (text, record) => {
          if (record.priceShieldFlag) {
            return record.taxAmountMeaning;
          } else {
            return thousandBitSeparator(text, record.amountPrecision);
          }
        },
    ...
    return customizeTable(
      {
        code: 'SFIN.BILL_SALE_LIST.DETAIL_GRID',
      },
      <Table {...tableProps} />
    );
  }
