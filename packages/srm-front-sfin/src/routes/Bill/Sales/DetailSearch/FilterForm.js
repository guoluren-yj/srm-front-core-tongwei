...
@withCustomize({
  unitCode: ['SFIN.BILL_SALE_LIST.DETAIL_FILTER'],
})
...
export default class FilterForm extends PureComponent {
  ...
  render() {
    ...
    return customizeFilterForm(
      {
        code: 'SFIN.BILL_SALE_LIST.DETAIL_FILTER',
        form,
        expand: display,
      },
          ...
          <Col {...FORM_COL_3_4_LAYOUT}>
            <Row {...SEARCH_FORM_ROW_LAYOUT}>
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  {...SEARCH_FORM_ITEM_LAYOUT}
                  label={intl.get(`${promptCode}.companyName`).d('客户公司')}
                >
            ...
            <Row {...SEARCH_FORM_ROW_LAYOUT} style={{ display: display ? 'block' : 'none' }}>
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  ...
                  {...SEARCH_FORM_ITEM_LAYOUT}
                >
                  {getFieldDecorator('purchaseOrgName')(<Input />)}
                </Form.Item>
              </Col>
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  {...SEARCH_FORM_ITEM_LAYOUT}
                  label={intl.get(`${promptCode}.filter.specifications`).d('规则')}
                >
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  {...SEARCH_FORM_ITEM_LAYOUT}
                  label={intl.get(`${promptCode}.filter.model`).d('型号')}
                >
