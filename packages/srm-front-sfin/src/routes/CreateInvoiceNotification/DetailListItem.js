/*
 * @Description:创建多条开票通知子页面
 * @Date: 2020-06-17 16:21:28
...
export default class CreateDetail extends PureComponent {
  constructor(props) {
    super(props);
    const { billHeaderId, getSubPage = () => ({}), status } = props;
    let backPath;
  ...
  render() {
    ...
    const isLoading =
      saving || submitting || deleting || cancelling || loading || deleteLineLoading;
    return (
      <React.Fragment>
        <Header
          backPath={backPath}
