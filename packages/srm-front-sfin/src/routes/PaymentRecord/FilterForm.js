...
export default class FilterForm extends PureComponent {
  ...
  render() {
    ...
    return customizeFilterForm(
      {
        form,
        code: 'SFIN.PAYMENT_RECORD.LIST_FILTER_FORM',
        expand: display,
      },
          ...
          <Col span={18}>
            ...
            <Row gutter={12} style={{ display: display ? 'block' : 'none' }}>
              ...
              <Col span={8}>
                <Form.Item
                  {...formLayout}
                  label={intl.get(`sfin.payment.paymentNum`).d('SRM付款申请号')}
                >
            ...
            <Row gutter={12} style={{ display: display ? 'block' : 'none' }}>
              <Col span={8}>
                <Form.Item
                  {...formLayout}
                  label={intl
                    .get(`ssta.supplySettlePool.model.supplySettlePool.paymentRecordDateFrom`)
                    .d('付款日期从')}
                >
              ...
              <Col span={8}>
                <Form.Item
                  {...formLayout}
                  label={intl
                    .get(`ssta.supplySettlePool.model.supplySettlePool.paymentRecordDateTo`)
                    .d('付款日期至')}
                >
