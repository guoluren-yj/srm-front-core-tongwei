...
const columns = (props) => {
          ...
          if (value) {
            return (
              <Button
                funcType="link"
                color="primary"
                onClick={() => exportRender(value, record, nodeTemplateCode)}
              >
                {value}
              </Button>
            );
  ...
  const planColumns = [
        ...
        if (
          ...
          (changeMarkFlag &&
            (!isNil(change) &&
              ...
              ['CONFIRMED'].includes(record.get('lineStatus')) &&
              ['SUPPLIER'].includes(dataSet.getState('interactiveCampCode')) &&
    ...
    doubleUnitEnabled && {
      ...
      width: 110,
      renderer: ({ value }) => showBigNumber(value),
      editor: (record) => statusValidate(record) && lineDs.getState('actualQuantity'),
    },
    {
      name: 'actualQuantity',
      width: 110,
    ...
    },
    {
      ...
      editor: (record) => statusValidate(record) && lineDs.getState('quantity'),
      header:
        nodeTemplateCode === 'UNIQUE_LABEL'
          ? doubleUnitEnabled
            ? intl
    ...
    },
    {
      ...
      width: 160,
      editor: (record) => statusValidate(record) && lineDs.getState('plannedArrivalDate'),
      renderer: ({ value, record }) => {
    ...
    },
    {
      ...
      width: 160,
      editor: (record) => statusValidate(record) && lineDs.getState('confirmArrivalDate'),
      renderer: ({ value, record }) => {
    ...
    },
    {
      name: 'supplierLineRemark',
      width: 160,
      editor: (record) => statusValidate(record) && lineDs.getState('supplierLineRemark'),
      renderer: ({ value, record }) =>
        handleFieldsRender(
          value,
          record.get('changeFieldMap'),
          'supplierLineRemark',
          record.get('changingFlag'),
          statusValidate(record) && lineDs.getState('supplierLineRemark')
        ),
    },
    {
      name: 'agentName',
    ...
    },
    {
      ...
      width: 120,
      editor: (record) => statusValidate(record) && lineDs.getState('deliveryAddress'),
      renderer: ({ value, record }) =>
        handleFieldsRender(
          value,
          record.get('changeFieldMap'),
    ...
    },
    {
      name: 'receiveAddress',
      width: 120,
      editor: (record) => statusValidate(record) && lineDs.getState('receiveAddress'),
      renderer: ({ value, record }) =>
        handleFieldsRender(
          value,
          record.get('changeFieldMap'),
  ...
  const asnColumns = [
    ...
    },
    {
      name: 'unitPackageQuantity',
      width: 110,
      editor: (record) => statusValidate(record) && lineDs.getState('unitPackageQuantity'),
      renderer: ({ value, record }) => {
        const data = {
          ...record?.get(['changeFieldMap', 'changingFlag']),
    ...
    },
    {
      name: 'netWeight',
      width: 110,
      editor: (record) => statusValidate(record) && lineDs.getState('netWeight'),
      renderer: ({ value, record }) => {
        const data = { ...record?.get(['changeFieldMap', 'changingFlag']), fieldName: 'netWeight' };
        return showBigNumber(value, -1, {}, data);
      },
    },
    {
      name: 'grossWeight',
      width: 110,
      editor: (record) => statusValidate(record) && lineDs.getState('grossWeight'),
      renderer: ({ value, record }) => {
        const data = {
          ...record?.get(['changeFieldMap', 'changingFlag']),
    ...
    },
    {
      name: 'lotNum',
      width: 110,
      editor: (record) => statusValidate(record) && lineDs.getState('lotNum'),
      renderer: ({ value, record }) =>
        handleFieldsRender(
          value,
          record.get('changeFieldMap'),
    ...
    },
    {
      name: 'productionDate',
      width: 160,
      editor: (record) => statusValidate(record) && lineDs.getState('productionDate'),
      renderer: ({ value, record }) => {
    ...
    },
    {
      name: 'lotExpirationDate',
      width: 160,
      editor: (record) => statusValidate(record) && lineDs.getState('lotExpirationDate'),
      renderer: ({ value, record }) => {
    ...
    },
    {
      name: 'serialNum',
      width: 160,
      editor: (record) => statusValidate(record) && lineDs.getState('serialNum'),
      renderer: ({ value, record }) =>
        handleFieldsRender(
          value,
          record.get('changeFieldMap'),
    ...
    },
    {
      ...
      width: 120,
      editor: (record) => statusValidate(record) && lineDs.getState('purchaseLineAttachmentUuid'),
    },
    {
      ...
      editor: (record) => {
        ...
        const editFlag = statusValidate(record) && lineDs.getState('supplierLineAttachmentUuid');
