...
const affirmDS = (id, code, key, doubleUnitEnabled, nodeId) => ({
  ...
  fields: [
    ...
    },
    {
      ...
      label:
        code === 'LABEL'
          ? intl.get('slod.deliveryWorkbench.model.common.unitPackageQuantity').d('比例份数')
          : intl.get('slod.deliveryWorkbench.model.common.packages').d('件数'),
    },
    {
      name: 'packageQuantity', // 比例分数  行
      type: 'number',
      label: intl.get('slod.deliveryWorkbench.model.common.packageQuantity').d('单包装数'),
    },
    {
