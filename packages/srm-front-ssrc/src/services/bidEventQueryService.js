...
export async function uploadAttachement(params) {
  const { organizationId, bidHeaderId, archiveAttachmentUuid } = params;
  return request(`${prefix}/${organizationId}/bid/${bidHeaderId}/archive-attachment-uuid`, {
    method: 'POST',
    query: { archiveAttachmentUuid },
  });
}
...
// bid明细 进度条查询
export function fetchBidDetailProcessAll(params = {}) {
  const { organizationId, bidHeaderId, ...otherParams } = params;
  return request(`${SRM_SSRC}/v1/${organizationId}/bid/${bidHeaderId}/progress/all`, {
    method: 'GET',
    query: otherParams,
  });
}
...
// bid明细 资格预审 预审头信息
export function prequalDetailHeaderBidDetail(params = {}) {
...
// bid明细 资格预审 预审详情
export function prequalDetailBidDetail(params = {}) {
  const { organizationId, sourceFrom, sourceHeaderId, ...otherParams } = params;
  const param = parseParameters(otherParams);
...
// 明细 开标 开标详情
export function openBidDetail(params = {}) {
  const { organizationId, sourceHeaderId, ...otherParams } = params;
  const param = parseParameters(otherParams);
  return request(`${SRM_SSRC}/v1/${organizationId}/bid/${sourceHeaderId}/all-opener`, {
    method: 'GET',
    query: { ...param },
  });
}
...
// 明细 投标 投标详情
export function quotationDetailBidDetail(params = {}) {
  const { organizationId, sourceHeaderId, ...otherParams } = params;
  const param = parseParameters(otherParams);
  return request(`${SRM_SSRC}/v1/${organizationId}/bid/${sourceHeaderId}/quotation/detail`, {
    method: 'GET',
    query: { ...param },
  });
}
