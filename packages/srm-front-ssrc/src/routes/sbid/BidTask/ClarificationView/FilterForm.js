...
@cacheComponent({ cacheKey: '/ssrc/bid-task/clarification-view' })
            ...
            <Col span={18}>
              <Row>
                <Col span={8}>
                  <FormItem
                    {...formLayout}
                    label={intl.get(`ssrc.bidTask.view.question.questionNo`).d('澄清单号')}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    {...formLayout}
                    label={intl.get(`ssrc.bidTask.view.question.submittedByUserName`).d('发布人')}
                  >
              ...
              <Row style={{ display: expand ? 'none' : 'block' }}>
                <Col span={8}>
                  <FormItem
                    {...formLayout}
                    label={intl
                      .get(`ssrc.bidTask.view.question.questionSubmitDateFrom`)
                      .d('发布日期从')}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    {...formLayout}
                    label={intl
                      .get(`ssrc.bidTask.view.question.questionSubmitDateTo`)
                      .d('发布日期至')}
                  >
