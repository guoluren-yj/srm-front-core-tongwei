...
export default class TableList extends PureComponent {
  ...
  renderColumns() {
    ...
    const columns = [
      {
        title: intl.get(`ssrc.bidTask.modal.bidTask.clarifyNum`).d('澄清单号'),
      ...
      {
        title: intl.get(`ssrc.bidTask.modal.bidTask.submittedByUserName`).d('发布人'),
        dataIndex: 'submittedByUserName',
        width: 150,
      },
      {
        title: intl.get(`ssrc.bidTask.modal.bidTask.applicationDeadline`).d('发布时间'),
