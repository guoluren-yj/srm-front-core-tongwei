...
@cacheComponent({ cacheKey: '/ssrc/supplier-bid-hall/questissson-list/question' })
          ...
          <Col span={18}>
            <Row>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supplierBidQuery.questionNo`).d('问题编号')}
                >
                  {getFieldDecorator('issueFinalNum')(<Input />)}
                </FormItem>
              </Col>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supplierBidQuery.clarifyStatus`).d('状态')}
                >
            ...
            <Row style={{ display: expand ? 'none' : 'block' }}>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supplierBidQuery.submitPeople`).d('提交人')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`${promptCode}.model.supplierBidQuery.submitDateFrom`)
                    .d('提交日期从')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`${promptCode}.model.supplierBidQuery.submitDateEnd`)
                    .d('提交日期至')}
                >
