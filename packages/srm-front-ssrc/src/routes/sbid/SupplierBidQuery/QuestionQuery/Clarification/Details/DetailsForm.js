    ...
    return (
      <div className={styles['information-container']}>
        <Row className={styles['information-item']}>
          <Col span={3}>{intl.get(`${promptCode}.model.supplierBidQuery.title`).d('标题')}</Col>
        ...
        <Row className={styles['information-item']}>
          <Col span={8}>
            <Row>
              <Col span={9}>
                {intl.get(`${promptCode}.model.supplierBidQuery.clarifyNum`).d('澄清单号')}:
              </Col>
        ...
        <Row className={styles['information-item']}>
          <Col span={8}>
            <Row>
              <Col span={9}>
                {intl.get(`${promptCode}.model.supplierBidQuery.publisher`).d('发布人')}:
              </Col>
          ...
          <Col span={8}>
            <Row>
              <Col span={9}>
                {intl.get(`${promptCode}.model.supplierBidQuery.sourceNum`).d('寻源单号')}:
              </Col>
          ...
          <Col span={8}>
            <Row>
              <Col span={9}>
                {intl.get(`${promptCode}.model.supplierBidQuery.submittedDate`).d('发布时间')}:
              </Col>
