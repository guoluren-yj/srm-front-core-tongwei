...
@cacheComponent({ cacheKey: '/ssrc/supplier-bid-hall/questissson-list/clarification' })
            ...
            <Row>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`${promptCode}.model.supplierBidQuery.clarificationNo`)
                    .d('澄清单号')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supplierBidQuery.publisher`).d('发布人')}
                >
            ...
            <Row style={{ display: expand ? 'none' : 'block' }}>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`${promptCode}.model.supplierBidQuery.pubDateFrom`)
                    .d('发布日期从')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`${promptCode}.model.supplierBidQuery.pubDateEnd`)
                    .d('发布日期至')}
                >
