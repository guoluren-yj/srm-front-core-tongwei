...
@cacheComponent({ cacheKey: '/ssrc/expert-scoring/list' })
export default class FilterForm extends Component {
  ...
  @Bind()
  queryReset() {
    const { form, resetFormFields } = this.props;
    form.resetFields();
    resetFormFields();
  }
    ...
    return (
      <React.Fragment>
        {customizeFilterForm(
          {
            form,
            code: 'SSRC.EXPERT_SCORE_LIST.PENDING_FILTER_FORM',
            expand,
          },
            ...
            <Row>
              <Col span={18}>
                <Row>
                  ...
                  <Col span={8}>
                    <Form.Item
                      label={intl.get(`${promptCode}.model.expertScoring.statusing`).d('状态')}
                      {...formlayout}
                    >
                      {getFieldDecorator('sourceStatus', {
