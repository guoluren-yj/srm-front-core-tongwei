    ...
    return (
      <Fragment>
        {publicFlag ? (
          ...
          <Header
            title={intl
              .get('ssrc.acceptBidNotice.model.title.acceptNoticePreview')
              .d('中标公告预览')}
          />
        )}
        <Content>
                  ...
                  <span>
                    {formDs.current?.get('noticeDate')
                      ? `${intl
                          ...
                          .d('发布时间')}：${formDs.current?.get('noticeDate')}`
                      : null}
                  </span>
                </div>
              </div>
              ...
              <div className={styles['notice-content']}>
                ...
                >
                  ...
                  >
                    ...
                    <Output name="sourceAcceptedTotalAmount" />,
                ...
                <TopSection
                  title={intl
                    .get('ssrc.acceptBidNotice.model.acceptBidNotice.acceptInfor')
                    .d('中标信息')}
                  getHocInstance={getHocInstance}
                  className="notice-content"
                >
