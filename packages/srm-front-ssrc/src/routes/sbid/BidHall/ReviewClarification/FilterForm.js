            ...
            <Col span={18}>
              <Row>
                <Col span={8}>
                  <FormItem
                    label={intl
                      .get(`ssrc.bidHall.model.bidHall.clarifyNoticeNum`)
                      .d('澄清通知编号')}
                    {...formLayout}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    label={intl.get(`ssrc.bidHall.model.bidHall.replyStatus`).d('回复状态')}
                    {...formLayout}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    label={intl.get(`ssrc.bidHall.model.bidHall.title`).d('标题')}
                    {...formLayout}
                  >
              ...
              <Row style={{ display: display ? 'none' : 'block' }}>
                <Col span={8}>
                  <FormItem
                    label={intl.get(`ssrc.bidHall.model.bindHal.subDateFrom`).d('提交日期从')}
                    {...formLayout}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    label={intl.get(`ssrc.bidHall.model.bindHal.sutmitDateTo`).d('提交日期至')}
                    {...formLayout}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    label={intl
                      .get(`ssrc.bidHall.model.bindHal.repllyDateFrom`)
                      .d('回复截止日期从')}
                    {...formLayout}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    label={intl.get(`ssrc.bidHall.model.bindHal.replyDateTo`).d('回复截止日期至')}
                    {...formLayout}
                  >
