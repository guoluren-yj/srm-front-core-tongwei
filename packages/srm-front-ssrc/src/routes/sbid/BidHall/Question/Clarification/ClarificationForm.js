...
@connect(({ bidHall, loading }) => ({
  bidHall,
  Loading: loading.effects['bidHall/fetchEntranceList'],
  organizationId: getCurrentOrganizationId(),
}))
@cacheComponent({
  cacheKey: '/ssrc/bid-hall/inter-question/:sourceId/:bidNum/:bidTitle/:companyId',
})
          ...
          <Col span={18}>
            <Row>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`ssrc.bidHall.model.bidHall.questionNo`).d('问题编号')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`ssrc.bidHall.model.bidHall.questionState`).d('澄清类型')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`ssrc.bidHall.model.bidHall.questionSubmitter`).d('提交人')}
                >
            ...
            <Row style={{ display: expand ? 'none' : 'block' }}>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`ssrc.bidHall.model.bidHall.supplierCompany`).d('供应商')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`ssrc.bidHall.model.bidHall.questionSubmitDateFrom`)
                    .d('提交日期从')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`ssrc.bidHall.model.bidHall.questionSubmitDateTo`)
                    .d('提交日期至')}
                >
