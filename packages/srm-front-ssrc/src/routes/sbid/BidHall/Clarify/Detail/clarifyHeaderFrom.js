      ...
      <Form>
        <div className={styles['information-container']}>
          <Row className={styles['information-item']}>
            <Col span={3}>{intl.get(`ssrc.clarify.model.clarify.title`).d('标题')}</Col>
          ...
          <Row className={styles['information-item']}>
            <Col span={8}>
              <Row>
                <Col span={9}>
                  {intl.get(`ssrc.clarify.model.clarify.clarifyNum`).d('澄清单号')}:
                </Col>
            ...
            <Col span={8}>
              <Row>
                <Col span={9}>
                  {intl.get(`ssrc.clarify.model.clarify.clarifyStatus`).d('状态')}:
                </Col>
          ...
          <Row className={styles['information-item']}>
            <Col span={8}>
              <Row>
                <Col span={9}>
                  {intl.get(`ssrc.clarify.model.clarify.submittedByUserName`).d('发布人')}:
                </Col>
            ...
            <Col span={8}>
              <Row>
                <Col span={9}>
                  {intl.get(`ssrc.clarify.model.clarify.sourceNum`).d('寻源单号')}:
                </Col>
            ...
            <Col span={8}>
              <Row>
                <Col span={9}>
                  {intl.get(`ssrc.clarify.model.clarify.submittedDate`).d('发布时间')}:
                </Col>
          ...
          <Row>
            <Col span={3}>
              {intl.get(`ssrc.clarify.model.clarify.clarifyAttachment`).d('澄清函附件')}:
            </Col>
            <Col span={21}>
              {
                <Upload
