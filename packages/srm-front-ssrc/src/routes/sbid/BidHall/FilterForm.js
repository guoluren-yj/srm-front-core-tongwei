...
export default class FilterForm extends Component {
  ...
  @Bind()
  handleFormReset() {
    const { resetFormFields = null, form = {} } = this.props;
    resetFormFields();
    form.resetFields();
  }
          ...
          <Row gutter={12}>
            <Col span={18}>
              <Row>
                ...
                <Col span={8}>
                  <FormItem
                    label={intl.get(`ssrc.bidHall.model.bidHall.bidderPeople`).d('招标员')}
                    {...formLayout}
                  >
              ...
              <Row style={{ display: display ? 'none' : 'block' }}>
                ...
                <Col span={8}>
                  <Form.Item
                    label={intl.get(`ssrc.bidHall.model.supplierQuotation.bidStatus`).d('状态')}
                    {...formLayout}
                  >
                    {getFieldDecorator('bidStatusSet', {
                ...
                <Col span={8}>
                  <FormItem
                    label={intl
                      .get(`ssrc.bidHall.model.bindHal.bidCreateStartDate`)
                      .d('创建日期从')}
                    {...formLayout}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    label={intl.get(`ssrc.bidHall.model.bindHal.bidCreateEndDate`).d('创建日期至')}
                    {...formLayout}
                  >
