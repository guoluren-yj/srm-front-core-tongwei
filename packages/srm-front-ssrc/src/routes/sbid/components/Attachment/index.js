...
@remote({
  code: 'SSRC_EVALUATION_PROC_MANAGE_SCORE_SUMMARY',
  name: 'remote',
})
      ...
      <React.Fragment>
        <Row>
          {remote
            ? remote.render(
                ...
                evaluateShowType !== 'TECH' && (
                  <Col span={11}>
                    <p>
                      {intl.get(`ssrc.common.model.bidHall.businessAttachments`).d('商务附件')}：
                    </p>
                    <UploadButton
                      viewOnly={viewOnly}
                      filePreview
            ...
            : evaluateShowType !== 'TECH' && (
            <Col span={11}>
              <p>{intl.get(`ssrc.common.model.bidHall.businessAttachments`).d('商务附件')}：</p>
              <UploadButton
                viewOnly={viewOnly}
                filePreview
                multiple
          ...
          {evaluateShowType !== 'BUSS' && (
            <Col span={11}>
              <p>{intl.get(`ssrc.common.model.bidHall.techAttachments`).d('技术附件')}：</p>
              <UploadButton
                viewOnly={viewOnly}
                filePreview
                multiple
