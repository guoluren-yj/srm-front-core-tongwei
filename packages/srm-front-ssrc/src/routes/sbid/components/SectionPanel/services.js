...
// 专家评分 - 查询标段
export async function fetchExpertScoringSectionList(params = {}) {
  const { sourceProjectId, ...otherParams } = params;
  return request(
    `${prefix}/${organizationId}/evaluate-scores/rfx/section/${sourceProjectId}/scoring-list`,
    {
      method: 'GET',
      query: otherParams,
    }
...
// 专家历史评分 - 查询标段
export async function fetchExpertScoredSectionList(params = {}) {
  const { sourceProjectId, ...otherParams } = params;
  return request(
    `${prefix}/${organizationId}/evaluate-scores/rfx/section/${sourceProjectId}/scored-list`,
    {
      method: 'GET',
      query: otherParams,
    }
