    ...
    return (
      <div className={styles['information-container']}>
        <Row className={styles['information-item']}>
          <Col span={3}>{intl.get(`${promptCode}.model.supplierBid.title`).d('标题')}</Col>
        ...
        <Row className={styles['information-item']}>
          <Col span={8}>
            <Row>
              <Col span={9}>
                {intl.get(`${promptCode}.model.supplierBid.clarifyNum`).d('澄清单号')}:
              </Col>
          ...
          <Col span={8}>
            <Row>
              <Col span={9}>
                {intl.get(`${promptCode}.model.supplierBid.clarifyStatus`).d('状态')}:
              </Col>
              <Col span={15}>
        ...
        <Row className={styles['information-item']}>
          <Col span={8}>
            <Row>
              <Col span={9}>
                {intl.get(`${promptCode}.model.supplierBid.submittedByUserName`).d('发布人')}:
              </Col>
          ...
          <Col span={8}>
            <Row>
              <Col span={9}>
                {intl.get(`${promptCode}.model.supplierBid.sourceNum`).d('寻源单号')}:
              </Col>
          ...
          <Col span={8}>
            <Row>
              <Col span={9}>
                {intl.get(`${promptCode}.model.supplierBid.submittedDate`).d('发布时间')}:
              </Col>
