...
export async function fetchTabList(params) {
  return request(`${prefix}/${organizationId}/share/sup-dtl/import-structure`, {
    method: 'GET',
    query: params,
  });
}
...
export async function validateData(params) {
  const reqUrl = `${prefix}/${organizationId}/share/sup-dtl/import-validate`;
  return request(reqUrl, {
    method: 'POST',
    query: params,
  });
...
export async function importData(params) {
  const reqUrl = `${prefix}/${organizationId}/share/sup-dtl/import-data`;
  return request(reqUrl, {
    method: 'POST',
    query: params,
  });
...
export async function getSupplierList(params) {
  const reqUrl = `${prefix}/${organizationId}/rfx/off-line/quotation-detail/import/supplier`;
  return request(reqUrl, {
    method: 'POST',
    body: params,
  });
