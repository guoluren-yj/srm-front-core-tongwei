...
class Fraction {
  static create(num, den = 1) {
    if (num instanceof Fraction) {
      ...
      if (/\.(\d+)/.test(num)) {
        num *= 10 ** RegExp.$1.length;
        den *= 10 ** RegExp.$1.length;
      }
      if (/\.(\d+)/.test(den)) {
        num *= 10 ** RegExp.$1.length;
        den *= 10 ** RegExp.$1.length;
  ...
  multiply(o) {
    return new Fraction(
      (this.num || this.num === 0) && (o.num || o.num === 0) ? this.num * o.num : null,
      this.den * o.den
    );
  }
  ...
  divide(o) {
    return new Fraction(
      this.num || this.num === 0 ? this.num * o.den : null,
      o.num || o.num === 0 ? this.den * o.num : undefined
    );
  }
