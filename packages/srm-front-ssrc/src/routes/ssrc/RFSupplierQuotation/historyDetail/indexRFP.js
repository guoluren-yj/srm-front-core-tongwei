...
const unitCode = [
  ...
  `SSRC.SUPPLIER_REPLY.RFP_HISTORY.BASE_HEADER`, // 基本信息
  `SSRC.SUPPLIER_REPLY.RFP_HISTORY.BASE_FORM`, // 征询内容
  `SSRC.SUPPLIER_REPLY.RFP_HISTORY.QUOTATION_FORM`, // 供应商回复
  'SSRC.SUPPLIER_REPLY.RFP_HISTORY.QUOTATION_LINE', // 报价行
