...
@cacheComponent({ cacheKey: '/ssrc/supplier-rfx-hall/qusestion-list/maintain-form' })
          ...
          <Col span={18}>
            <Row>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supQuo.questionNo`).d('问题编号')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supQuo.clarifyStatus`).d('状态')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supQuo.questionSubmitter`).d('提交人')}
                >
            ...
            <Row style={{ display: expand ? 'none' : 'block' }}>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`${promptCode}.model.supQuo.questionSubmitDateFrom`)
                    .d('提交日期从')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`${promptCode}.model.supQuo.questionSubmitDateTo`)
                    .d('提交日期至')}
                >
