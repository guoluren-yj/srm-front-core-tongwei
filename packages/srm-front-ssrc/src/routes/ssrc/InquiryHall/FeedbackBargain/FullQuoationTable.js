...
export default class FullQuoationTable extends Component {
  ...
  render() {
    ...
    const columns = [
      {
        ...
        width: 120,
        // sorter: true,
        render: (val, record) => record.quotationLineStatusMeaning,
      },
      {
    ...
    return (
      <div style={{ marginTop: '16px' }}>
        {customizeTable(
          { code: `SSRC.${sourceKey}_HALL.BARGAIN.ALL_QUOTATION` },
          <EditTable
            bordered
            ...
            rowSelection={allLineRowSelection}
