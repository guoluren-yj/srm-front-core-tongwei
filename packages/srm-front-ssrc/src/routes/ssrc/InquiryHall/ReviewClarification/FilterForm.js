          ...
          <Row gutter={12}>
            <Col span={18}>
              <Row>
                ...
                <Col span={8}>
                  <FormItem
                    label={intl.get(`ssrc.inquiryHall.model.inquiryHall.replyStatus`).d('回复状态')}
                    {...formLayout}
                  >
              ...
              <Row style={{ display: display ? 'none' : 'block' }}>
                <Col span={8}>
                  <FormItem
                    label={intl
                      .get(`ssrc.inquiryHall.model.inquiryHall.submittedDateFrom`)
                      .d('提交日期从')}
                    {...formLayout}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    label={intl
                      .get(`ssrc.inquiryHall.model.inquiryHall.submittedDateTo`)
                      .d('提交日期至')}
                    {...formLayout}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    label={intl
                      .get(`ssrc.inquiryHall.model.inquiryHall.replyEndDateFrom`)
                      .d('回复截止日期从')}
                    {...formLayout}
                  >
                ...
                <Col span={8}>
                  <FormItem
                    label={intl
                      .get(`ssrc.inquiryHall.model.inquiryHall.replyEndDateTo`)
                      .d('回复截止日期至')}
                    {...formLayout}
                  >
