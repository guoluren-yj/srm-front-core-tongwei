...
class CreateTable extends React.Component {
  ...
  handleRowCreate() {
    const {
      ...
      quotationHeaderId,
      questionRowsPagination,
      routerParam: { issueFrom, clarifyNotifyType },
      modelName = 'inquiryHall',
    } = this.props;
    if (!quotationHeaderId) {
      notification.error({
        message: intl
          .get(`ssrc.inquiryHall.model.inquiryHall.create.myQuestion`)
          .d('请先选择供应商!'),
      });
      return;
    }
  ...
  handleRowSave() {
    const {
      ...
      quotationHeaderId,
      modelName = 'inquiryHall',
      [modelName]: { questionRowsList = [], questionRowsPagination = {} },
    } = this.props;
...
export { HOCComponent, CreateTable };
