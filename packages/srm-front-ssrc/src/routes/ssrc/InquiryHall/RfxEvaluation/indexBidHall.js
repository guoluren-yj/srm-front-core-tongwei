...
const hocRfxEvaluation = (NewComponent) => {
  return withCustomize({
    ...
    formatterCollections({
      ...
      connect(({ inquiryHallBid, bidHallBid, loading }) => ({
        inquiryHallBid,
        inquiryHall: inquiryHallBid,
        bidHallBid,
        modelName: 'inquiryHallBid',
        modelBidName: 'bidHallBid',
        fetchExpertScoreInfoLoading: loading.effects['bidHallBid/fetchExpertScoreInfo'],
        fetchScoreLineLoading: loading.effects['bidHallBid/fetchScoreLine'],
        fetchSupplierListLoading: loading.effects['inquiryHallBid/fetchSupplierList'],
        saveEvaluateSummaryLoading:
          loading.effects['inquiryHallBid/saveEvaluateSummary'] ||
          loading.effects['inquiryHallBid/saveReviewEvaluateSummary'] ||
          loading.effects['bidHallBid/saveReviewEvaluateSummary'],
        submitEvaluateSummaryLoading:
          loading.effects['inquiryHallBid/submitEvaluateSummary'] ||
          loading.effects['inquiryHallBid/submitReviewEvaluateSummary'] ||
          loading.effects['bidHallBid/submitReviewEvaluateSummary'],
        fetchIPCoincidenceRateLoading: loading.effects['inquiryHallBid/fetchIPCoincidenceRate'],
        roundBeginScoreLoading: loading.effects['inquiryHallBid/roundBeginScore'],
        beginRoundQuotationLoading: loading.effects['inquiryHallBid/beginRoundQuotation'],
        fetchRfxScoreItemLinesLoading: loading.effects['inquiryHallBid/fetchRfxScoreItemLines'],
        fetchReScoringAllLoading: loading.effects['inquiryHallBid/reScoringAll'],
