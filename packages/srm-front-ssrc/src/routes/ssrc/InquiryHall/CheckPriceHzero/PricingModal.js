      ...
      if (!err) {
        ...
        dispatch({
          ...
          payload: {
            ...
            page,
            ...values,
            customizeUnitCode: 'SSRC.INQUIRY_HALL_CHECK_PRICE.ITEM_LINE_ADD',
          },
        }).then((res) => {
        ...
        if (activeKey === 'itemLine') {
          ...
          if (isEmpty(itemQuoteLine) || !isEmpty(itemQuoteLineParams)) {
            ...
            dispatch({
              ...
              payload: {
                ...
                customizeUnitCode:
                  'SSRC.INQUIRY_HALL_CHECK_PRICE.TAB_ITEM_DTL,SSRC.INQUIRY_HALL_CHECK_PRICE.HEADER_INFO,SSRC.INQUIRY_HALL_CHECK_PRICE.ITEM_LINE_ADD',
              },
            }).then((res) => {
              if (res) {
          ...
          dispatch({
            ...
            payload: {
              ...
              objectVersionNumber: header.objectVersionNumber,
              customizeUnitCode:
                'SSRC.INQUIRY_HALL_CHECK_PRICE.TAB_SUPPLIER,SSRC.INQUIRY_HALL_CHECK_PRICE.HEADER_INFO,SSRC.INQUIRY_HALL_CHECK_PRICE.ITEM_LINE_ADD',
              ...supplierDynamicParams,
            },
          }).then((res) => {
            if (res) {
          ...
          let quoteLineParams = [];
          const newQuoteLine =
            quoteLine && getEditTableData(quoteLine, ['quotationLineId'], { force: true });
          ...
          if (isEmpty(newQuoteLine) || !isEmpty(quoteLineParams)) {
            ...
            dispatch({
              ...
              payload: {
                ...
                objectVersionNumber: header.objectVersionNumber,
                customizeUnitCode:
                  'SSRC.INQUIRY_HALL_CHECK_PRICE.TAB_ALL_QUOTATION_DETAIL,SSRC.INQUIRY_HALL_CHECK_PRICE.HEADER_INFO,SSRC.INQUIRY_HALL_CHECK_PRICE.ITEM_LINE_ADD',
              },
            }).then((res) => {
              if (res) {
                notification.success();
        ...
        if (activeKey === 'itemLine') {
          ...
          if (isEmpty(itemQuoteLine) || !isEmpty(itemQuoteLineParams)) {
            ...
            dispatch({
              ...
              payload: {
                ...
                checkPriceDTOLineList,
                customizeUnitCode:
                  'SSRC.INQUIRY_HALL_CHECK_PRICE.TAB_ITEM_DTL,SSRC.INQUIRY_HALL_CHECK_PRICE.HEADER_INFO',
              },
            }).then(() => callBack());
          }
        } else if (activeKey === 'supplierLine') {
          ...
          return dispatch({
            ...
            payload: {
              ...
              checkPriceDTOLineList,
              customizeUnitCode:
                'SSRC.INQUIRY_HALL_CHECK_PRICE.TAB_SUPPLIER,SSRC.INQUIRY_HALL_CHECK_PRICE.HEADER_INFO',
              ...supplierDynamicParams,
            },
          }).then(() => callBack());
        } else {
          ...
          if (isEmpty(newQuoteLine) || !isEmpty(quoteLineParams)) {
            ...
            return dispatch({
              ...
              payload: {
                ...
                checkPriceDTOLineList,
                customizeUnitCode:
                  'SSRC.INQUIRY_HALL_CHECK_PRICE.TAB_ALL_QUOTATION_DETAIL,SSRC.INQUIRY_HALL_CHECK_PRICE.HEADER_INFO',
              },
            }).then(() => callBack());
          }
        }
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {customizeTable(
          {
            code: 'SSRC.INQUIRY_HALL_CHECK_PRICE.ITEM_LINE_ADD',
          },
