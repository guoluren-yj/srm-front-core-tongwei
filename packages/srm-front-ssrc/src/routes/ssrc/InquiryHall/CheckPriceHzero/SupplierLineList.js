...
export default class SupplierLineList extends PureComponent {
  constructor(props) {
    super(props);
  ...
  fetchSupplierLineTableList(page = {}, rfxLineSupplierId) {
    ...
    dispatch({
      ...
      payload: {
        ...
        rfxLineSupplierId,
        rfxHeaderId,
        customizeUnitCode: 'SSRC.INQUIRY_HALL_CHECK_PRICE.TAB_SUPPLIER',
      },
    }).then((res) => {
      if (res) {
        this.setState({
      ...
      dispatch({
        ...
        dispatch({
          ...
          payload: {
            ...
            organizationId,
            path,
            customizeUnitCode: 'SSRC.INQUIRY_HALL_CHECK_PRICE.HEADER_INFO',
          },
        });
      });
    }
  ...
  saveSuggestedRemark(e, item) {
    ...
    const {
      ...
      fetchQuoteLine,
      fetchSupplierLine,
      inquiryHall: { supplierLinePagination = {}, quoteLinePagination = {} },
      match: { params, path = null },
    } = this.props;
