...
class LadderLevelCheckPrice extends Component {
  ...
  initPage = () => {
    const { record, uiType = 'c7n', getCustomizeUnitCode = noop, templateInfo } = this.props;
  ...
  // 当前供应商分类表格
  tableInfo() {
    const { customizeTable = noop, getCustomizeUnitCode = noop } = this.props;
...
export default observer(LadderLevelCheckPrice);
