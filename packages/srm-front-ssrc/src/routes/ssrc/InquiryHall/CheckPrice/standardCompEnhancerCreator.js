...
import { INQUIRY_HALL_LOWERCASE } from '@/utils/globalVariable';

const modelName = INQUIRY_HALL_LOWERCASE;
  ...
  const HOCComponent = CombineComponent({
    ...
    mixCustomize({
      ...
      unitCode: [
        ...
        'SSRC.INQUIRY_HALL_CHECK_PRICE.LADDER_INQUIRY_TABLE', // 阶梯报价-表格信息h
