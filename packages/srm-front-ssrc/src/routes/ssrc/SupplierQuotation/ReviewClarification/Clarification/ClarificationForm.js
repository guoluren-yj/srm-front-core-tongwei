...
@cacheComponent({ cacheKey: '/ssrc/supplier-rfx-hall/quedddstion-list/clarification-form' })
          ...
          <Col span={18}>
            <Row>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supQuo.clarificationNo`).d('澄清单号')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supQuo.submittedByUserName`).d('发布人')}
                >
            ...
            <Row style={{ display: expand ? 'none' : 'block' }}>
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supQuo.pubDateFrom`).d('发布日期从')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`${promptCode}.model.supQuo.pubDateEnd`).d('发布日期至')}
                >
