...
export default class DetailsForm extends React.Component {
  render() {
    const { questionInformationHeader } = this.props;
    return (
      <div className={styles['information-container']}>
        ...
        <Row className={styles['information-item']}>
          <Col span={8}>
            <Row>
              <Col span={9}>{intl.get(`${promptCode}.model.supQuo.sourceNo`).d('寻源单号')}:</Col>
        ...
        <Row className={styles['information-item']}>
          <Col span={24}>
            <Row>
              <Col span={3}>
                {intl.get(`${promptCode}.model.supQuo.questionHistory`).d('相关历史问题')}:
              </Col>
        ...
        <Row className={styles['information-item']}>
          <Col span={24}>
            <Row>
              <Col span={3}>{intl.get(`${promptCode}.model.supQuo.questionRemark`).d('备注')}:</Col>
