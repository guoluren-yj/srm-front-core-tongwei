...
const hocComponent = (Com) => {
  return compose(
    ...
    connect(({ inquiryHall, supplierQuotationInquiryNew, loading }) => ({
      inquiryHall,
      supplierQuotationInquiryNew,
      supplierQuotation: supplierQuotationInquiryNew,
      modelName: 'supplierQuotationInquiryNew',
      fetchFeedBackBarginHistoryLoading:
        loading.effects['supplierQuotationInquiryNew/fetchFeedBackBarginHistory'],
      organizationId: getCurrentOrganizationId(),
      headerLoding: loading.effects['supplierQuotationInquiryNew/fetchHeadDataList'],
      fetchLadderLevelTableLoading: loading.effects['inquiryHall/fetchLadderLevelTable'],
      queryRoundQuotationLineDetailLoading:
        loading.effects['supplierQuotationInquiryNew/queryRoundQuotationLineDetail'],
      printLoading: loading.effects['supplierQuotationInquiryNew/queryPrint'],
    })),
