...
const hocComponent = (Com) => {
  return compose(
    ...
    connect(({ inquiryHall, supplierQuotationQueryRfq, loading }) => ({
      inquiryHall,
      supplierQuotationQueryRfq,
      supplierQuotation: supplierQuotationQueryRfq,
      modelName: 'supplierQuotationQueryRfq',
      fetchFeedBackBarginHistoryLoading:
        loading.effects['supplierQuotationQueryRfq/fetchFeedBackBarginHistory'],
      organizationId: getCurrentOrganizationId(),
      headerLoding: loading.effects['supplierQuotationQueryRfq/fetchHeadDataList'],
      fetchLadderLevelTableLoading: loading.effects['inquiryHall/fetchLadderLevelTable'],
      queryRoundQuotationLineDetailLoading:
        loading.effects['supplierQuotationQueryRfq/queryRoundQuotationLineDetail'],
      printLoading: loading.effects['supplierQuotationQueryRfq/queryPrint'],
    })),
