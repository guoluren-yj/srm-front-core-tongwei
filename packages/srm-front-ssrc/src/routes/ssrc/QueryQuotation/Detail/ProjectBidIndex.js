...
const hocComponent = (Com) => {
  return compose(
    ...
    connect(({ inquiryHall, supplierQuotationProjectBid, loading }) => ({
      inquiryHall,
      supplierQuotationProjectBid,
      supplierQuotation: supplierQuotationProjectBid,
      modelName: 'supplierQuotationProjectBid',
      fetchFeedBackBarginHistoryLoading:
        loading.effects['supplierQuotationProjectBid/fetchFeedBackBarginHistory'],
      organizationId: getCurrentOrganizationId(),
      headerLoding: loading.effects['supplierQuotationProjectBid/fetchHeadDataList'],
      fetchLadderLevelTableLoading: loading.effects['inquiryHall/fetchLadderLevelTable'],
      queryRoundQuotationLineDetailLoading:
        loading.effects['supplierQuotationProjectBid/queryRoundQuotationLineDetail'],
    })),
