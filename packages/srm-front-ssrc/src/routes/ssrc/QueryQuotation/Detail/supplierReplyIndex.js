...
const hocComponent = (Com) => {
  return compose(
    ...
    connect(({ inquiryHall, supplierQuotationSupplierReply, loading }) => ({
      inquiryHall,
      supplierQuotationSupplierReply,
      supplierQuotation: supplierQuotationSupplierReply,
      modelName: 'supplierQuotationSupplierReply',
      fetchFeedBackBarginHistoryLoading:
        loading.effects['supplierQuotationSupplierReply/fetchFeedBackBarginHistory'],
      organizationId: getCurrentOrganizationId(),
      headerLoding: loading.effects['supplierQuotationSupplierReply/fetchHeadDataList'],
      fetchLadderLevelTableLoading: loading.effects['inquiryHall/fetchLadderLevelTable'],
      queryRoundQuotationLineDetailLoading:
        loading.effects['supplierQuotationSupplierReply/queryRoundQuotationLineDetail'],
      printLoading: loading.effects['supplierQuotationSupplierReply/queryPrint'],
    })),
