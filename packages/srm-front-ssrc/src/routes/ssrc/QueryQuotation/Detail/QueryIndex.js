...
const hocComponent = (Com) => {
  return compose(
    ...
    connect(({ inquiryHall, supplierQuotationInquiry, loading }) => ({
      inquiryHall,
      supplierQuotationInquiry,
      supplierQuotation: supplierQuotationInquiry,
      modelName: 'supplierQuotationInquiry',
      fetchFeedBackBarginHistoryLoading:
        loading.effects['supplierQuotationInquiry/fetchFeedBackBarginHistory'],
      organizationId: getCurrentOrganizationId(),
      headerLoding: loading.effects['supplierQuotationInquiry/fetchHeadDataList'],
      fetchLadderLevelTableLoading: loading.effects['inquiryHall/fetchLadderLevelTable'],
      queryRoundQuotationLineDetailLoading:
        loading.effects['supplierQuotationInquiry/queryRoundQuotationLineDetail'],
      printLoading: loading.effects['supplierQuotationInquiry/queryPrint'],
    })),
