          ...
          ['update', 'create'].includes(record._status) ? (
            <Form.Item>
              {record.$form.getFieldDecorator('score', {
                ...
                <Input
                  disabled={
                    record.indicateType !== 'SCORE' || prequalGroupSupplierLineStatus !== 'SUBMITED'
                  }
                />
              )}
            </Form.Item>
        ...
        render: (val, record) =>
          ['update', 'create'].includes(record._status) ? (
            <Form.Item>
              ...
              })(<Input disabled={prequalGroupSupplierLineStatus !== 'SUBMITED'} />)}
            </Form.Item>
          ) : (
            val
          ),
            ...
            <div className={styles['ladder-lever']}>
              <Form layout="inline">
                ...
                <Button
                  icon="save"
                  type="primary"
                  disabled={prequalGroupSupplierLineStatus !== 'SUBMITED'}
