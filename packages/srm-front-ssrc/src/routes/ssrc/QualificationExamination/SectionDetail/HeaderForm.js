...
export default class HeaderForm extends PureComponent {
  render() {
    ...
    return (
      <React.Fragment>
        {customizeForm(
          { code: 'SSRC_PREQUAL.HEADER2', form, dataSource },
          <Form>
            {/* <Row gutter={48} className="read-row">
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <FormItem
                  ...
                  {...EDIT_FORM_ITEM_LAYOUT}
                >
                  {getFieldDecorator('templateName')(<span>{dataSource.templateName}</span>)}
                </FormItem>
              </Col>
            </Row>
            <Row gutter={48} className="read-row">
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <FormItem
                  ...
                  {...EDIT_FORM_ITEM_LAYOUT}
                >
                  {getFieldDecorator('sourceMethod')(<span>{dataSource.sourceMethodMeaning}</span>)}
                </FormItem>
              </Col>
              <Col {...FORM_COL_3_LAYOUT}>
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                ...
                >
                  {getFieldDecorator('reviewMethod', {
                    initialValue: dataSource.reviewMethod,
