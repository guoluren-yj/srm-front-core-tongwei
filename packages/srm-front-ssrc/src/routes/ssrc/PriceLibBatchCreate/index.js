...
import { queryFormDS, listLineDS, ladderQuotationDS, applicationScopeDS } from './lineDS';
...
export default class PriceLibBatchCreate extends PureComponent {
  ...
  handleDownloadTemplateExcel() {
    ...
    const api = `${API_HOST}${SRM_SPC}/v1/${organizationId}/price-lib-mains/excel/template`;
    downloadFile({
      requestUrl: api,
      queryParams: [
