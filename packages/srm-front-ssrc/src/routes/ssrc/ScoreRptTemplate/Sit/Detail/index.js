...
export default class Detail extends Component {
          ...
          dispatch({
            ...
            if (res) {
              if (templateId) {
                ...
                dispatch(
                  routerRedux.push({
                    pathname: `/ssrc/scoreRptTemplate-site/list`,
                    search,
                  })
                );
              } else {
  ...
  viewRow(record) {
    ...
    dispatch(
      routerRedux.push({
        pathname: `/ssrc/scoreRptTemplate-site/content/${templateId}`,
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Header
          backPath="/ssrc/scoreRptTemplate-site/list"
          title={intl
        ...
        >
          <Button
            icon="save"
            loading={saveLoading || fetchLineLoading}
