...
export default class SAPFilterForm extends Component {
  constructor(props) {
    super(props);
    props.onRef(this);
    this.state = {
    ...
    return customizeFilterForm(
      {
        form,
        expand,
        code: 'SSRC.PRICE_LIB_EXPORT_ERP.SAP_FILTER_FORM',
      },
          ...
          <Col span={18}>
            ...
            <Row style={{ display: expand ? 'block' : 'none' }}>
              ...
              <Col span={8}>
                <Form.Item
                  label={intl
                    .get(`${promptCode}.model.searchResImt.erpNumber`)
                    .d('采购信息记录编号')}
                  {...formlayout}
                >
                  {getFieldDecorator('erpNumber')(<Input trim />)}
                </Form.Item>
              </Col>
            </Row>
          </Col>
