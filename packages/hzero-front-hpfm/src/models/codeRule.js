...
export default {
  ...
  effects: {
    ...
    *saveCodeRuleDetail({ payload }, { call }) {
      const response = yield call(saveCodeRuleDetail, payload);
      return getResponse(response);
    },
  },
  ...
  reducers: {
    ...
    queryDetail(state, action) {
      return {
        ...
        detail: {
          ...
          originData: {
            content: cloneDeep(action.payload.codeRuleDetailDTOList),
            pagination: createPagination(cloneDeep(action.payload)),
          },
        },
        keyValue: {
    ...
    restoreDetailData(state) {
      return {
        ...state,
        detail: {
          ...state.detail,
          data: {
            content: cloneDeep(state.detail.originData.content),
            pagination: cloneDeep(state.detail.originData.pagination),
          },
        },
      };
    },
      ...
      return {
        ...
        detail: {
          ...
          data: {
            ...
            pagination: state.detail.data.pagination,
          },
        },
      };
    },
