...
export default {
  ...
  effects: {
    ...
    *queryThemeConfig({ payload }, { call, put }) {
      const res = yield call(queryThemeConfig, payload);
      const theme = getResponse(res);
      yield put({
        type: 'updateState',
        payload: { theme },
      });
    ...
    *updateThemeConfig({ payload }, { call }) {
      const res = yield call(updateThemeConfig, payload);
      return getResponse(res);
    },
  },
  ...
  reducers: {
    ...
    updateThemeConfig(state, action) {
      return {
        ...
        theme: {
          ...state.theme,
          enableThemeConfig: action.payload.enableThemeConfig,
        },
      };
    },
  },
