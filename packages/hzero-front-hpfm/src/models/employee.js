        ...
        yield put({
          ...
          payload: {
            lov: {
              ...
              employeeGender: safeRes.employeeGender,
              idd: safeRes.idd,
            },
          },
        });
    ...
    *fetchPosition({ payload }, { call, put }) {
      ...
      if (result) {
        yield put({
          type: 'updateState',
          payload: {
            positionList: result.map((ele) => ({ ...ele, _status: 'update' })),
            ...otherProps,
          },
        });
      }
    ...
    *fetchUser({ payload }, { call, put }) {
      ...
      if (result) {
        yield put({
          type: 'updateState',
          payload: {
            userList: result.map((ele) => ({ ...ele, _status: 'update' })),
          },
        });
      }
    },
