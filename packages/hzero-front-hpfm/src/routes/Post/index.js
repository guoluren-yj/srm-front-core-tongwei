 ...
 */
@withCustomize({
  unitCode: ['SPFM.ORGANIZATION.POSITION_EDITFORM', 'SPFM.ORGANIZATION.POSITION_LISY'],
})
...
export default class Post extends Component {
  ...
  handleSearch(fields = {}) {
    ...
    dispatch({
      ...
      payload: {
        ...
        ...fields,
        sort,
        customizeUnitCode: 'SPFM.ORGANIZATION.POSITION_EDITFORM,SPFM.ORGANIZATION.POSITION_LISY',
      },
    });
  }
  ...
  render() {
    ...
    const { activePostData = {}, drawerVisible = false, cacheFormData, sort } = this.state;
    const filterProps = {
      unitCode,
      unitName,
