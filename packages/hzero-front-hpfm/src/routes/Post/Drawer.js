...
import { Modal, Form, Row, Col, Input, InputNumber } from 'hzero-ui';
...
export default class Drawer extends PureComponent {
   ...
   */
  render() {
    const { anchor, title, visible, loading, form, itemData, customizeForm } = this.props;
    ...
    return (
      ...
      >
        {customizeForm(
          {
            code: 'SPFM.ORGANIZATION.POSITION_EDITFORM',
            form,
            dataSource: itemData,
          },
          <Form>
            ...
            <Row>
              <Col span={24}>
                <Form.Item
                  label={intl
                    .get('hpfm.position.model.position.managementPositionName')
                    .d('上级岗位')}
                  {...formLayout}
                >
