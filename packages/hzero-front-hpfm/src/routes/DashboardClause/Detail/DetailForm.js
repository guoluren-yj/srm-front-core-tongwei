      ...
      <Form>
        <Row {...EDIT_FORM_ROW_LAYOUT}>
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item
              {...EDIT_FORM_ITEM_LAYOUT}
              label={intl.get(`${promptCode}.model.dashboard.menuCode`).d('条目跳转路由')}
            >
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT}>
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item
              {...EDIT_FORM_ITEM_LAYOUT}
              label={intl.get(`${promptCode}.model.dashboard.route`).d('条目后端接口')}
            >
