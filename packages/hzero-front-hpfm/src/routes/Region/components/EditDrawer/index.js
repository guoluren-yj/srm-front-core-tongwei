...
export default class Drawer extends PureComponent {
  ...
  render() {
    ...
    const {
      detail: { _token, regionCode, standardRegionCode, regionName, quickIndex },
    } = this.state;
    return (
      <Modal
        destroyOnClose
      ...
      >
        <Form>
          ...
          >
            {form.getFieldDecorator('standardRegionCode', {
              initialValue: standardRegionCode,
            })(<Input trim disabled={!isCreate} />)}
          </Form.Item>
          <Form.Item
            {...MODAL_FORM_ITEM_LAYOUT}
