...
export default class FilterSelector extends PureComponent<FilterSelectorProps, any> {
  constructor(props) {
    super(props);
    this.state = {
      listVisible: false,
  ...
  @Bind()
  renderFilterOption(filter: filterProperties = {}) {
  ...
  @Bind()
  renderFilterOptions() {
    const { filterList = [] as filterProperties[] } = this.props;
