...
export const MULTI_CONDITION = '_multi_condition_';

export const LOV_CONDITION_GROUP_INDEX = 'lov_condition_group_index';

export const LOV_QUERY_DEFAULT_FIELD = 'lov_query_default_field';