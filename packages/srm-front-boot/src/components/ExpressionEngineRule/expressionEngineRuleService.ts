...
export async function saveReturnRule (params) {
...
export async function updateReturnRule (params) {
  return request(`/marmot/v1/${currentOrganizationId}/marmot-expression-engine`, {
    method: 'PUT',
    body: params,
  });
...
export async function saveExpressionEngineRule (params) {
...
export async function updateExpressionEngineRule (params) {
  return request(`/marmot/v1/${currentOrganizationId}/marmot-expression-engine/action`, {
    method: 'PUT',
    body: params,
  });
