...
export default class CodeCompare extends React.Component {
  ...
  dealCode = (current, ori) => {
    ...
    return [oriResArr, currentResArr];
  };
      ...
      <Fragment>
        <div className={PageStyle.codeCompare}>
          <div className="outBox">
            ...
            <Button
              onClick={() => {
                this.props.changeScriptArea(currentCode);
                this.props.modal.close();
              }}
              className="button"
              color="primary"
            >
              {intl.get('spfm.codeCompare.button.view.useThisVersion').d('回滚至当前版本')}
            </Button>
