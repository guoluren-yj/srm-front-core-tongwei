// import { getFormUrl } from '@/services/mobileConfig';
...
// export function getMobileFormUrl(formCode, data) {
//    return getFormUrl({ templateCode: formCode, thirdPlatformCode: 'wechatService' }, data);
// }
// export function getMobileFormUrl(cardCode, serviceType) {
//   return getBindSupplierUrl(cardCode, serviceType);
// }
export class Events {
