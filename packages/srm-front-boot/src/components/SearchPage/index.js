...
export default class SearchPage extends Component {
  ...
  render() {
    ...
    const { [modelName]: searchPageData = {}, customizeTable = (code, comp) => comp } = this.props; // 根据 modelName 获取 Model 数据
    ...
    return (
      <React.Fragment>
        ...
        <Content {...this.contentProps()}>
          ...
          {editTable ? (
            customizeTable({ code: tableCode }, <EditTable {...tableProps} />)
          ) : (
            <CustomTable {...tableProps} tableCode={tableCode} customizeTable={customizeTable} />
          )}
        </Content>
        {this.renderOther()}
      </React.Fragment>
