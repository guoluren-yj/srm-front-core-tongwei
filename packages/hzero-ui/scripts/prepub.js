...
fs.readdir(componentsPath, function (err, files) {
  ...
  console.log('Built a entry less file to lib/style/components.less');

  if (fs.existsSync(path.join(__dirname, '../dist'))) {
    // Build less entry file: dist/antd.less
    fs.writeFileSync(
      path.join(process.cwd(), 'dist', 'hzero-ui.less'),
      '@import "../lib/style/index.less";\n@import "../lib/style/components.less";',
    );
    console.log('Built a entry less file to dist/hzero-ui.less');
  }
});
