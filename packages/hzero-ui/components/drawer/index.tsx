...
import RcDrawer from '../rc-components/drawer';


// @ts-ignore
if (!Symbols.DrawerContext) {
  // @ts-ignore
  Symbols.DrawerContext = Symbol('DrawerContext');
}
// @ts-ignore
const DrawerContext = getContext<Drawer | null>(Symbols.DrawerContext, null);
...
export default class Drawer extends React.Component<DrawerProps, IDrawerState> {
  ...
  renderProvider = (value: Drawer) => {
    const { zIndex, placement, ...rest } = this.props;
