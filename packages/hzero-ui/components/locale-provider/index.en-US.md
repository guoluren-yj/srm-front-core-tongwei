...
import fr_FR from 'hzero-ui/lib/locale-provider/fr_FR';
...
| -------- | ----------- | ---- | ------- |
| locale | language package setting, you can find the packages in this path: `hzero-ui/lib/locale-provider/` | object | - |
