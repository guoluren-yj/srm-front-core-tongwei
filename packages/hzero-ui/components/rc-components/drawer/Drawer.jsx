...
import { addEventListener, dataToArray, isNumeric, removeEventListener, transformArguments, transitionEnd, trnasitionStr } from './utils';
...
class Drawer extends React.PureComponent {
      ...
      >
        {showMask && (
          <div
            ...
            onDoubleClick={this.onMaskTouchEnd}
            style={maskStyle}
            ref={c => {
              this.maskDom = c;
            }}
  ...
  removeMoveHandler = e => {
    ...
    const differX = e.changedTouches[0].clientX - (this.startPos ? this.startPos.x : 0);
    const differY = e.changedTouches[0].clientY - (this.startPos ? this.startPos.y : 0);
    if (
