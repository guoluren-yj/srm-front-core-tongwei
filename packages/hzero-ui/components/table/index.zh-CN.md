...
| resizable | 是否启用列伸缩 | boolean | `true` |
...
| customCode | 个性化表格编码 | string | - |
| onColumnFilter | 列筛选回调函数 | Function(keys) | - |
| exported | 导出配置项目 参考[配置项](#Exported) | object | - |
...
| filterField | 设置是否为可筛选列 | boolean | false |
| filterBar | 设置是否显示筛选按钮 | boolean | false |
