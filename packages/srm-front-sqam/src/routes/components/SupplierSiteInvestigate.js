...
@withRouter
class SupplierSiteInvestigate extends PureComponent {
  @Bind()
  handleJumpDetail(record) {
    const { history } = this.props;
    const { evalHeaderId, evalType } = record;
    history.push(`/sslm/site-investigate-report/received/detail/${evalHeaderId}/${evalType}`);
  }
...
export default SupplierSiteInvestigate;
