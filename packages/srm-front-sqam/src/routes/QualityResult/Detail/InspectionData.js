      ...
      <Form>
        <Row {...EDIT_FORM_ROW_LAYOUT} className="read-row">
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              {getFieldDecorator('startDate')(<span>{dateTimeRender(startDate)}</span>)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item
              ...
              {...EDIT_FORM_ITEM_LAYOUT}
            >
              {getFieldDecorator('endDate')(<span>{dateTimeRender(endDate)}</span>)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT} className="read-row">
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item
              ...
              {...EDIT_FORM_ITEM_LAYOUT}
            >
              {getFieldDecorator('actualQuantity')(<span>{actualQuantity}</span>)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item
              ...
              {...EDIT_FORM_ITEM_LAYOUT}
            >
              {getFieldDecorator('sampleSize')(<span>{sampleSize}</span>)}
            </Form.Item>
          </Col>
        </Row>
        <Row {...EDIT_FORM_ROW_LAYOUT} className="read-row">
