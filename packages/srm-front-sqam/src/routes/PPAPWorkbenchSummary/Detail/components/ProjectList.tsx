...
const ProjectList = () => {
  const { stageLineDs, customizeTable, createFlag, headerDs, editFlag } = useContext<StoreValueType>(Store);
  ...
  const columns: ColumnProps[] = useMemo(() => {
    return [
      ...
      },
      {
        ...
        // @ts-ignore
        editor: editorFlag ? <DateTimePicker defaultTime={moment('23:59:59', 'HH:mm:ss')} /> : false,
        width: 150,
      },
      {
        name: 'companyName',
