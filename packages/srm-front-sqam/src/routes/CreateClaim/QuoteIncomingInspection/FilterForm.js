...
export default class FilterForm extends PureComponent {
  ...
  render() {
    ...
    return !isSelectTx
      ? customizeFilterForm(
          {
            code: 'SQAM.CREATE_CLAIM_LIST.QUOTE_FILTER',
            form,
            expand: expandForm,
          },
              ...
              <Col {...FORM_COL_3_4_LAYOUT}>
                ...
                <Row {...SEARCH_FORM_ROW_LAYOUT} style={{ display: expandForm ? 'block' : 'none' }}>
                  ...
                  <Col {...FORM_COL_3_LAYOUT}>
                    <Form.Item
                      {...SEARCH_FORM_ITEM_LAYOUT}
                      label={intl.get(`${promptCode}.inspectionTypeMeaning`).d('检验类型')}
                    >
                      {getFieldDecorator(
                        'inspectionType',
                        {}
      ...
      : customizeFilterForm(
          {
            code: 'SQAM.CREATE_CLAIM_LIST.TRX_QUOTE_FILTER',
            form,
            expand: expandForm,
          },
          <Form className="more-fields-search-form">
              ...
              <Col {...FORM_COL_3_4_LAYOUT}>
                <Row {...SEARCH_FORM_ROW_LAYOUT}>
                  <Col {...FORM_COL_3_LAYOUT}>
                    <Form.Item
                      {...SEARCH_FORM_ITEM_LAYOUT}
                      label={intl.get(`${promptCode}.trxNum`).d('事务编号')}
                    >
                      {getFieldDecorator('trxNum')(
                        <Input trim typeCase="upper" inputChinese={false} />
                      )}
                    </Form.Item>
                  </Col>
                  ...
                  <Col {...FORM_COL_3_LAYOUT}>
                    ...
                    >
                      {getFieldDecorator('rcvTrxTypeCode')(
                        <Lov
                          code="SINV.RECEIVE_TRX_TYPE_NEW"
                          lovOptions={{
                            valueField: 'rcvTrxTypeCode',
                            displayField: 'rcvTrxTypeName',
                          }}
                        />
                      )}
                    </Form.Item>
                  ...
                  <Col {...FORM_COL_3_LAYOUT}>
                    <Form.Item
                      ...
                      label={intl
                        ...
                        .d('事务来源单号')}
                    >
                      {getFieldDecorator('sourceHeaderNum')(
                        <Input trim typeCase="upper" inputChinese={false} />
                      )}
                    </Form.Item>
                  </Col>
