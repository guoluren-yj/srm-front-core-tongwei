...
import { ActiveKey, ActionType, ListTabsCustCode, ProjectListCode, ProjectSearchCode } from '../../utils/type';
...
const StoreProvider = flow(
  ...
  const handleToDetail = useCallback((projectHeaderId: string | number, operate: Operate) => {
    ...
    history.push({
      pathname: `/sqam/PPAPWorkbenchSummarySup/detail/${projectHeaderId}`,
