...
// @withCustomize({
//   unitCode: ['SQAM.RECEIVED_CLAIM_FORM_DETAIL.CLAIM_INFO_FILTER'],
// })
export default class StateDealFilter extends PureComponent {
  ...
  render() {
    ...
    const { fields = [] } = custConfig['SQAM.RECEIVED_CLAIM_FORM_DETAIL.CLAIM_INFO_FILTER'] || {};
    const searchShow = fields.some(item => item.visible === 1);
    return customizeFilterForm(
      {
        code: 'SQAM.RECEIVED_CLAIM_FORM_DETAIL.CLAIM_INFO_FILTER',
        form,
      },
