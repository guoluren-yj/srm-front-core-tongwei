...
const DocumentList = () => {
  const { documentLineDs, documentInfoDs, customizeTable, remoteProps } = useContext<StoreValueType>(Store);
    ...
    return [
      {
        ...
        renderer: ({ text, value, record }) => {
          ...
          return remoteProps.process ? remoteProps.process('SQAM_PPAPWORKBENCH_SUP_DETAIL_CUX_DOCUMENT_LIST_STATUS_RENDERER', statusTag, { text, value, record, TagColor, StatusTag }) : statusTag;
        },
      },
      {
        name: 'documentNum',
