...
@formatterCollections({ code: ['hiam.passwordPolicy', 'hiam.subAccount'] })
        ...
        dispatch({
          ...
          payload: values.enablePassword
            ? {
              ...passwordPolicyList,
              ...values,
              userAutoDisableDuration: values?.userAutoDisableDuration || 0,
              maxCheckCaptcha: values.maxCheckCaptcha || 0,
              enableThreeRole: threeRoleFlag,
              accountEnableDesensitize: values.accountEnableDesensitize ? 1 : 0,
              enableImageWatermark: values.enableImageWatermark ? 1 : 0,
            }
            : {
              ...passwordPolicyList,
              ...values,
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT} className="writable-row">
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              ...
              })(<Switch disabled={!!passwordPolicyList.enablePassword} />)}
            </FormItem>
          </Col>
        </Row>
        <Divider />
                    ...
                    ? [
                      {
                        validator: (_, value, callback) => {
                          callback(validatePasswordRuleNew(value, {}));
                        },
                      },
                    ]
                    : [
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              {getFieldDecorator('digitsCount', {
                ...
                <InputNumber
                  style={{ width: '100%' }}
                  min={passwordPolicyList.digitsCount === 0 ? 0 : 1}
                  precision={0}
                  disabled={getFieldValue('enablePassword') === false}
                />
              )}
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              {getFieldDecorator('lowercaseCount', {
                ...
                <InputNumber
                  style={{ width: '100%' }}
                  min={passwordPolicyList.lowercaseCount === 0 ? 0 : 1}
                  precision={0}
                  disabled={getFieldValue('enablePassword') === false}
                />
              )}
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              {getFieldDecorator('uppercaseCount', {
                ...
                <InputNumber
                  style={{ width: '100%' }}
                  min={passwordPolicyList.uppercaseCount === 0 ? 0 : 1}
                  precision={0}
                  disabled={getFieldValue('enablePassword') === false}
                />
              )}
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              {getFieldDecorator('specialCharCount', {
                ...
                <InputNumber
                  style={{ width: '100%' }}
                  min={passwordPolicyList.specialCharCount === 0 ? 0 : 1}
                  precision={0}
                  disabled={getFieldValue('enablePassword') === false}
                />
              )}
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT} className="writable-row">
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              ...
              })(<Switch disabled={!!passwordPolicyList.forceModifyPassword} />)}
            </FormItem>
          </Col>
        </Row>
        <Row {...EDIT_FORM_ROW_LAYOUT} className="writable-row">
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            <FormItem
              ...
              label={this.renderLabelWithHelp({
                label: intl
                  .get('hiam.passwordPolicy.model.passwordPolicy.updatePasswordLimited')
                  .d('密码修改控制'),
                help: intl
                  .get('hiam.passwordPolicy.view.message.updatePasswordLimited.tooltip')
                  .d(
                    '租户配置单点登录，开启该配置个人用户不允许更改密码（个人中心、忘记密码等），子账户管理功能不限制更改密码。该配置项可配合租户实现SRM登录不允许登录一起使用'
                  ),
              })}
            >
              {getFieldDecorator('updatePasswordLimited', {
                initialValue: passwordPolicyList.updatePasswordLimited,
              })(<Switch />)}
            </FormItem>
          </Col>
          <Col {...FORM_COL_3_LAYOUT}>
            <FormItem
              ...
              label={this.renderLabelWithHelp({
                label: intl
                  .get('hiam.passwordPolicy.model.passwordPolicy.enableCaptchaVerify')
                  .d('人机验证'),
                help: intl
                  .get('hiam.passwordPolicy.model.passwordPolicy.enableCaptchaVerify.help')
                  .d('人机验证'),
              })}
            >
              {getFieldDecorator('enableCaptchaVerify', {
                initialValue: passwordPolicyList.enableCaptchaVerify,
              })(<Switch />)}
            </FormItem>
          </Col>
        </Row>
        ...
        <Row {...EDIT_FORM_ROW_LAYOUT}>
          ...
          <Col {...FORM_COL_3_LAYOUT}>
            <FormItem
              ...
              label={this.renderLabelWithHelp({
                label: intl
                  .get('hiam.passwordPolicy.model.passwordPolicy.userAutoDisableDuration')
                  .d('子账户未登录自动冻结时长'),
                help: intl
                  .get('hiam.passwordPolicy.view.message.userAutoDisableDuration.tooltip')
                  .d('超过配置时长未登录，自动冻结子账户'),
              })}
            >
              {getFieldDecorator('userAutoDisableDuration', {
                initialValue: passwordPolicyList.userAutoDisableDuration || 0,
              })(
                <InputNumber
                  style={{ width: '100%' }}
                  min={0}
                  precision={0}
                  formatter={(value) =>
                    `${value}${intl.get('hiam.passwordPolicy.model.passwordPolicy.day').d('天')}`
                  }
                />
              )}
            </FormItem>
          ...
          <Row {...EDIT_FORM_ROW_LAYOUT}>
            <Col {...FORM_COL_3_LAYOUT}>
              <FormItem
                ...
                label={this.renderLabelWithHelp({
                  label: intl
                    .get('hiam.passwordPolicy.model.passwordPolicy.dataOperationProtection')
                    .d('数据操作保护'),
                  help: intl
                    .get('hiam.passwordPolicy.view.message.enableDesensitize.tooltip')
                    .d('开启后，系统中敏感信息进行脱敏处理，更新或查询需通过身份验证'),
                })}
              >
                {getFieldDecorator('enableDesensitize', {
                  initialValue: passwordPolicyList.enableDesensitize,
                })(<Switch />)}
              </FormItem>
            </Col>
            <Col {...FORM_COL_3_LAYOUT}>
              <FormItem
                ...
                label={this.renderLabelWithHelp({
                  label: intl
                    .get('hiam.passwordPolicy.model.passwordPolicy.enablePrivacyPolicy')
                    .d('初次登录隐私协议确认'),
                  help: intl
                    .get('hiam.passwordPolicy.view.message.enablePrivacyPolicy.tooltip')
                    .d('用户第一次登录需确认隐私协议，可登录系统'),
                })}
              >
                {getFieldDecorator('enablePrivacyPolicy', {
                  initialValue: passwordPolicyList.enablePrivacyPolicy,
                })(<Switch disabled={passwordPolicyList.enablePrivacyPolicy} />)}
              </FormItem>
            </Col>
            <Col {...FORM_COL_3_LAYOUT}>
              <FormItem
                ...
                label={this.renderLabelWithHelp({
                  label: intl
                    .get('hiam.passwordPolicy.model.passwordPolicy.enableFileWatermark')
                    .d('PDF文件增加水印'),
                  help: intl
                    .get('hiam.passwordPolicy.view.message.enableFileWatermark.tooltip')
                    .d('开启后，PDF文件进行预览与下载操作时增加水印，水印信息为当前用户账号与日期'),
                })}
              >
                {getFieldDecorator('enableFileWatermark', {
                  initialValue: passwordPolicyList.enableFileWatermark,
                })(<Switch />)}
              </FormItem>
            </Col>
          </Row>
          <Row {...EDIT_FORM_ROW_LAYOUT}>
            <Col {...FORM_COL_3_LAYOUT}>
              <FormItem
                ...
                label={this.renderLabelWithHelp({
                  label: intl
                    .get('hiam.passwordPolicy.model.passwordPolicy.safeLogoutTime')
                    .d('自动登出时长(MIN)'),
                  help: intl
                    .get('hiam.passwordPolicy.view.message.safeLogoutTime.tooltip')
                    .d('未做任何系统操作，自动退出系统时长'),
                })}
              >
                {getFieldDecorator('autoLogoutDuration', {
                  initialValue: passwordPolicyList.autoLogoutDuration,
                  rules: [
                    {
                      required: true,
                      message: intl.get('hzero.common.validation.notNull', {
            ...
            <Col {...FORM_COL_3_LAYOUT}>
              <FormItem
                ...
                label={this.renderLabelWithHelp({
                  label: intl
                    .get('hiam.passwordPolicy.model.passwordPolicy.accountEnableDesensitize')
                    .d('账号管理列表脱敏'),
                  help: intl
                    .get('hiam.passwordPolicy.view.message.accountEnableDesensitize.tooltip')
                    .d('开启配置，则子账户管理列表手机号码/邮箱脱敏展示'),
                })}
              >
                {getFieldDecorator('accountEnableDesensitize', {
                  initialValue: passwordPolicyList.accountEnableDesensitize,
                })(<Switch />)}
              </FormItem>
            </Col>
            <Col {...FORM_COL_3_LAYOUT}>
              <FormItem
                ...
                label={this.renderLabelWithHelp({
                  label: intl
                    .get('hiam.passwordPolicy.model.passwordPolicy.enableImageWatermark')
                    .d('图片文件增加水印'),
                  help: intl
                    .get('hiam.passwordPolicy.view.message.enableImageWatermark.tooltip')
                    .d(
                      '开启后，图片文件进行预览与下载操作时增加水印，水印信息为当前用户账号与租户'
                    ),
                })}
              >
                {getFieldDecorator('enableImageWatermark', {
                  initialValue: passwordPolicyList.enableImageWatermark,
                })(<Switch />)}
              </FormItem>
            </Col>
          </Row>
              ...
              <Panel
                ...
                header={
                  <>
                    <h3>
                      {intl
                        .get('hiam.passwordPolicy.view.message.subTitle.otherPasswordPolicy')
                        .d('其他密码策略')}
                    </h3>
                    <a>
                      {collapseKeys.includes('otherPasswordPolicy')
                        ? intl.get(`hzero.common.button.up`).d('收起')
                        : intl.get(`hzero.common.button.expand`).d('展开')}
                    </a>
                    <Icon type={collapseKeys.includes('otherPasswordPolicy') ? 'up' : 'down'} />
                  </>
                }
                key="otherPasswordPolicy"
              >
                {this.renderOtherPasswordForm()}
              </Panel>
              <Panel
                showArrow={false}
                header={
              ...
              <Panel
                ...
                header={
                  <>
                    <h3>
                      {intl
                        .get('hiam.passwordPolicy.view.message.subTitle.enableDesensitize')
                        .d('敏感操作配置')}
                    </h3>
                    <a>
                      {collapseKeys.includes('enableDesensitize')
                        ? intl.get(`hzero.common.button.up`).d('收起')
                        : intl.get(`hzero.common.button.expand`).d('展开')}
                      <Icon type={collapseKeys.includes('enableDesensitize') ? 'up' : 'down'} />
                    </a>
                  </>
                }
                key="enableDesensitize"
              >
                {this.renderDesensitizeForm()}
              </Panel>
            </Collapse>
            <Drawer
              visible={visible}
