      ...
      <Form>
        <Row gutter={24} type="flex" align="bottom" {...SEARCH_FORM_ROW_LAYOUT}>
          <Col {...FORM_COL_4_LAYOUT}>
            <Form.Item {...SEARCH_FORM_ITEM_LAYOUT} label={intl.get('entity.tenant.tag').d('租户')}>
              {form.getFieldDecorator('organizationId')(<Lov code="HPFM.TENANT" />)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_4_LAYOUT}>
            <FormItem
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        width: 90,
        render: (text, record) =>
          text ? <img alt={record.appName} src={text} width="24" height="24" /> : null,
      },
      {
