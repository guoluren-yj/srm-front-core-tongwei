  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        dataIndex: 'email',
        width: 300,
        render: (value, record) => record.emailDesensitize || value,
      },
      {
        ...
        width: 200,
        render: (value, record) => {
          const phone = record.phoneDesensitize || value;
          if (record.internationalTelMeaning && phone) {
            // todo 需要改成好看的样子
            return `${record.internationalTelMeaning} | ${phone}`;
          }
          return phone;
        },
      },
        ...
        render: (_, record) => {
          ...
          const operators = [
            ...
            },
            {
              ...
              len: 4,
              title: intl.get('hzero.common.button.viewEmployee').d('查看员工'),
            },
            {
              key: 'team',
              ele: (
                ...
                admin || record.id === currentUserId ? null : (
                  <ButtonPermission
                    ...
                    permissionList={[
                      {
                        code: isTenant
                          ? 'hzero.sys.account.button.reset'
                          : 'hzero.site.sys.account.button.reset',
                        type: 'button',
                        meaning: '子账户管理-重置密码',
                      },
                    ]}
