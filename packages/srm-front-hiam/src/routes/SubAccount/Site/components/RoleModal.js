...
import { createPagination, tableScrollWidth, getCurrentTenant } from 'utils/utils';
import {
  FORM_COL_3_LAYOUT,
          ...
          <Row type="flex" gutter={24} {...SEARCH_FORM_ROW_LAYOUT}>
            <Col {...FORM_COL_3_LAYOUT}>
              ...
              >
                ...
                })(<Lov code="HPFM.TENANT" textValue={this.tenantName} textField="tenantName" />)}
              </FormItem>
            </Col>
          </Row>
        </Form>
