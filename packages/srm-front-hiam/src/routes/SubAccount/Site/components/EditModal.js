...
export default class EditModal extends React.Component {
  ...
  getRoleColumns() {
    const { editRecord, isCreate, path } = this.props;
    return [
      {
          ...
          const operators = [
            {
              ...
              len: 4,
              title: intl.get(`hiam.subAccount.model.role.button.assignPermissions`).d('排除权限'),
            },
          ];
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {assignPerVisible && <PermissionModal {...permissionModalProps} />}
      </Modal>
    );
  }
}
