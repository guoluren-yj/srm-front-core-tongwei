...
export async function queryAssignPermissionOfMember(params) {
  return request(`${HZERO_IAM}/v1/member-permission/role-effective-permission`, {
    method: 'GET',
    query: { ...params },
  });
}
...
export async function shieldMemberPermission(params) {
  return request(`${HZERO_IAM}/v1/member-permission/shield-permission`, {
    method: 'POST',
    body: { ...params },
  });
}
...
export async function cancelShieldMemberPermission(params) {
  return request(`${HZERO_IAM}/v1/member-permission/unshield-permission`, {
    method: 'POST',
    body: { ...params },
  });
}
