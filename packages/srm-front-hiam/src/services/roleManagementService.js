...
export async function queryRoleAuth(params) {
  ...
  return request(
    organizationRoleLevel
      ? `${HZERO_IAM}/v1/${tenantId}/user/roles/${roleId}/role-auths`
      : `${HZERO_IAM}/v1/user/roles/${roleId}/role-auths`,
    {
      method: 'GET',
      query: body,
    }
 ...
 * @returns {object} fetch Promise
 */
export async function batchAssignPermissionSets(roleId, data, query) {
 ...
 * @returns {object} fetch Promise
 */
export async function batchUnassignPermissionSets(roleId, data, query) {
 ...
 * @param {number} secGrpId - 安全组ID
 */
export async function queryAssignPermissionOfMember(params) {
  return request(
    organizationRoleLevel
      ? `${HZERO_IAM}/v1/member-permission/${tenantId}/role-effective-permission`
      : `${HZERO_IAM}/v1/member-permission/role-effective-permission`,
    {
      method: 'GET',
      query: { ...params },
    }
 ...
 * @param {object} payload - 请求数据
 */
export async function shieldMemberPermission(params) {
  return request(
    organizationRoleLevel
      ? `${HZERO_IAM}/v1/member-permission/${tenantId}/shield-permission`
      : `${HZERO_IAM}/v1/member-permission/shield-permission`,
    {
      method: 'POST',
      body: { ...params },
    }
 ...
 * @param {object} payload - 请求数据
 */
export async function cancelShieldMemberPermission(params) {
  return request(
    organizationRoleLevel
      ? `${HZERO_IAM}/v1/member-permission/${tenantId}/unshield-permission`
      : `${HZERO_IAM}/v1/member-permission/unshield-permission`,
    {
      method: 'POST',
      body: { ...params },
    }
 ...
 * 查询 - 常用功能
 */
export async function queryFunctionService(roleId) {
  return request(
    `${SRM_PLATFORM}/v1/${tenantId}/dbd-user-menu-sets/${roleId}/queryFunctionExUser`,
    {
      method: 'GET',
    }
  );
...
export async function createMenuService(params) {
  // /{roleId}/createMenuExUser
  return request(
    `${SRM_PLATFORM}/v1/${tenantId}/dbd-user-menu-sets/${params.roleId}/createMenuExUser`,
    {
      method: 'POST',
      body: params.payload,
    }
