...
export async function querySubAccountOrgList(params) {
  ...
  return request(`${HZERO_IAM}/hzero/v1/${currentOrganizationId}/users/desensitization-paging`, {
    method: 'GET',
    query,
  });
}
...
export async function subAccountOrgRoleQueryAll(payload) {
  return request(`${HZERO_IAM}/v1/roles/user/assignable-roles`, {
    method: 'GET',
    query: {
      ...payload,
      memberType: 'user',
...
export async function queryAssignPermissionOfMember(params) {
  return request(
    `${HZERO_IAM}/v1/member-permission/${currentOrganizationId}/role-effective-permission`,
    {
      method: 'GET',
      query: { ...params },
    }
...
export async function shieldMemberPermission(params) {
  return request(`${HZERO_IAM}/v1/member-permission/${currentOrganizationId}/shield-permission`, {
    method: 'POST',
    body: { ...params },
  });
}
...
export async function cancelShieldMemberPermission(params) {
  return request(`${HZERO_IAM}/v1/member-permission/${currentOrganizationId}/unshield-permission`, {
    method: 'POST',
    body: { ...params },
  });
}
