...
import { downloadFile, initiateAsyncExport, queryIdpValue } from 'hzero-front/lib/services/api';
...
export default class ExcelExport extends React.PureComponent {
  ...
  queryColumn(params) {
    ...
    return request(`${params.requestUrl}`, {
      ...
      query: { exportType: 'COLUMN', ...queryData },
    });
  }
  ...
  queryColumnData(config) {
    ...
    this.queryColumn({ requestUrl, method })
      .then((res) => {
