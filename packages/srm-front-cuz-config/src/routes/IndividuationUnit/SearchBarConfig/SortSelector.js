...
export default class App extends Component {
  ...
  handleChangeFilterSort() {
    const { currentFilter, filterList = [], dispatch, onRefresh } = this.props;
  ...
  render() {
    const { originFields = [], unitInfo = {} } = this.props;
        ...
        <div className={styles['left-item']}>
          ...
          <div className={styles['left-item-content']}>
            ...
            {!multipleFlag && sortFieldCode && (
              ...
              >
                <span onClick={this.handleToogleSortFlag} className={styles['sort-icon']}>
