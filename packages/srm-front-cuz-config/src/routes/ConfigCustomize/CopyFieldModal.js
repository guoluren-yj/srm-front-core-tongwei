...
@connect(({ configCustomizeCuz, loading }) => ({
  configCustomizeCuz,
  fetchLoading: loading.effects['configCustomizeCuz/fetchSameModelUnit'],
  saveLoading: loading.effects['configCustomizeCuz/copyFiled'],
}))
...
export default class CopyFieldModal extends Component {
  ...
  fetchSourceData(params = {}) {
    ...
    dispatch({
      type: 'configCustomizeCuz/fetchSameModelUnit',
      params: {
  ...
  handleOk() {
    ...
    dispatch({
      type: 'configCustomizeCuz/copyFiled',
      payload: {
        configFieldIds,
        unitIds,
      },
