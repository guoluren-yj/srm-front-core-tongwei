...
const ImportDetail = ({ headerData = {} as any, lineRef }) => {
  ...
  const fetchData = () => {
    ...
    importUnitTableDs.setQueryParameter('headerData', headerData);
    ...
    detailModal = Modal.open({
      ...
      children: (
        <ImportFieldDetail
          ...
          externalFeildList={record.get("cnfLogList")}
        />
      ),
      footer: (
        <Button onClick={closeDetailModal} color={ButtonColor.primary}>
