...
import { queryImportLogHeaders } from '@/services/customizeConfigService';
      ...
      <div style={{ color: '#000' }}>
        ...
        <span>
          {isImporting
            ...
            : intl
                .get('hpfm.individual.import.summary', { name: count || 0 })
                .d(`共导入${count || 0}个单元`)}
        </span>
      </div>
    );
