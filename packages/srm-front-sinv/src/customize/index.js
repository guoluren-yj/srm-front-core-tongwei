import './customizeWorkflowApproveFrom';
...
function assignRouterData(router, route, options = {}) {
  ...
  if (route.coverPath !== undefined) {
    // eslint-disable-next-line no-param-reassign
    router.coverPath = route.coverPath;
  }
  if (route.FilterSupplier !== undefined) {
    // eslint-disable-next-line no-param-reassign
    router.FilterSupplier = route.FilterSupplier;
  }
}
