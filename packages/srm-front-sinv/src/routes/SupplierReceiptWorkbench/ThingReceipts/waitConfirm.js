...
export default class ReceiptExecution extends PureComponent {
      ...
      collect: [
        {
          ...
          width: 100,
          renderer: ({ value, record }) => this.colorRender(value, record),
        },
        {
          name: 'displayTrxNum',
          width: 160,
  ...
  render() {
    ...
    const customCode = !courseAsLine
      ? `SINV.RECEIPT_WORKBENCH_THING.CONFIRM.COURSE.${nodeConfigIndexAbc},SINV.SUPPLIER_RECEIPT_WORKBENCH_THING.CONFIRM.SEARCH`
      : `SINV.RECEIPT_WORKBENCH_THING.CONFIRM.ASN.${nodeConfigIndexAbc},SINV.SUPPLIER_RECEIPT_WORKBENCH_THING.CONFIRM.SEARCH`;
      ...
      <Fragment>
        {courseAsLine &&
          customizeTable(
            ...
            <SearchBarTable
              cacheState
              searchCode="SINV.SUPPLIER_RECEIPT_WORKBENCH_THING.CONFIRM.SEARCH"
              dataSet={cousrseDs}
              columns={columns}
