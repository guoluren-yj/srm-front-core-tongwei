...
import { Row, Col, Form, Input, Select, DatePicker, Drawer, Button } from 'hzero-ui';
...
export default class Search extends Component {
  ...
  renderForm() {
    ...
    return customizeForm(
      {
        form,
        code: 'SINV.SUPPLIER_DELIVERY_LIST.FILTER_BY_DETAIL',
      },
      <Form className="more-fields-form">
        ...
        <Row>
          <Col span={8}>
            <FormItem {...MODAL_FORM_ITEM_LAYOUT} label={intl.get(`entity.company.tag`).d('公司')}>
        ...
        <Row>
          <Col span={8}>
            <FormItem
              {...MODAL_FORM_ITEM_LAYOUT}
              label={intl.get(`sinv.common.model.common.expectedArriveTimeTo`).d('预计到货时间至')}
            >
