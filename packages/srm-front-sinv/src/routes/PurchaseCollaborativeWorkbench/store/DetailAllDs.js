...
const detailAllDataSet = (sureSupplier) => ({
  autoQuery: false,
  dataToJSON: 'all',
  cacheSelection: true,
  cacheModified: true,
  ...
  queryParameter: {
    customizeUnitCode: sureSupplier
      ? 'SINV.SUPPLIER.COLLABORATIVE.WORKBENCH.DETAIL.ALL.SEARCH,SINV.SUPPLIER.COLLABORATIVE.WORKBENCH.DETAIL.ALL.LIST'
      : 'SINV.PURCHASER.COLLABORATIVE.WORKBENCH.DETAIL.ALL.SEARCH,SINV.PURCHASER.COLLABORATIVE.WORKBENCH.DETAIL.ALL.LIST',
  },
  fields: [
    {
      name: 'invStatus',
  ...
  transport: {
    read: () => {
      return {
        url: sureSupplier
          ? `${SRM_SPUC}/v1/${organizationId}/stockout/inv/header/supplier/line/all`
          : `${SRM_SPUC}/v1/${organizationId}/stockout/inv/header/line/all`,
        method: 'GET',
      };
    },
  },
...
export default detailAllDataSet;
