...
import { Form, Button, Input, Col, Row, DatePicker, Select, Tooltip, Icon } from 'hzero-ui';
...
export default class Search extends PureComponent {
  ...
  render() {
    ...
    const { expandForm, organizationId, tenantId, tenantNum } = this.state;
    const { getFieldDecorator, getFieldValue } = form;
    const { flag = [], receiveStatus = [], status = [] } = enumMap;
    return customizeFilterForm(
      {
        form,
        expand: expandForm,
        code: 'SINV.PURCHASER_DELIVERY_LIST.FILTER_BY_DETAIL',
      },
          ...
          <Col span={18}>
            ...
            <Row {...SEARCH_FORM_ROW_LAYOUT} style={{ display: expandForm ? 'block' : 'none' }}>
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`sinv.common.model.common.isCancelledFlag`).d('是否取消')}
                >
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl.get(`sinv.common.model.common.isClosedFlag`).d('是否关闭')}
                >
              ...
              {/* <Col span={8}>
                ...
                >
                  {getFieldDecorator('supplierSite')(
                    <Lov
              ...
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={intl
                    .get(`hzero.common.date.creation.to`, {
              ...
              <Col span={8}>
                ...
                >
                  {getFieldDecorator('inventoryId')(
                    <Lov code="SODR.INVENTORY" queryParams={{ tenantId: organizationId }} />
                  )}
                </FormItem>
              </Col>
              <Col span={8}>
