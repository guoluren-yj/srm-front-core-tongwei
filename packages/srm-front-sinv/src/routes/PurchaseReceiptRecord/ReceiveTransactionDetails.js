...
export default class ReceiveTransactionDetails extends PureComponent {
  constructor(props) {
    super(props);
  ...
  // fetchDataSource(roleId, { page: 0, size: 10, menuId }).then(res => {
  //   const { dataSource, pagination } = res;
  //   this.setState({
  //     targetTableDataSource: dataSource,
  //     targetTablePagination: pagination,
  //   });
  // });
  ...
  render() {
    ...
    const tableProps = {
      ...
      columns: [
        ...
        {
          title: intl.get(`sinv.common.model.common.amount`).d('数量'),
          dataIndex: 'quantity',
          onCell: this.onCell.bind(this),
