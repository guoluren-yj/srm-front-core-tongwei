...
import { Table, Collapse, Icon } from 'hzero-ui';
...
export default class List extends Component {
  ...
  render() {
    ...
    return (
      <div className={classnames(DETAIL_DEFAULT_CLASSNAME, styles['detail-form'])}>
        <Collapse
          className="form-collapse"
          defaultActiveKey={['lineInfo']}
        ...
        >
          <Panel
            ...
            header={
              <React.Fragment>
                <h3>{intl.get(`sinv.common.model.common.acceptanceLine`).d('验收单行信息')}</h3>
