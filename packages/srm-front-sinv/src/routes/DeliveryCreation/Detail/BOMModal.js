...
const titlePrompt = 'sinv.common.view.title';
...
export default class BOMModal extends PureComponent {
  ...
  saveClick() {
    const { saveClick = (e) => e } = this.props;
    saveClick();
  }
  ...
  render() {
    ...
    const columns = [
      ...
      {
        title: intl.get(`sinv.common.model.common.refQuantity`).d('参考数量'),
        width: 120,
        dataIndex: 'refQuantity',
      },
      {
              ...
              rules: [
                {
                  ...
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get(`sinv.common.model.common.needQuantity`).d('需求数量'),
                  }),
                },
              ],
