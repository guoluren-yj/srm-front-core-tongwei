...
import { Table, NumberField, TextArea, Button, Modal, Tabs } from 'choerodon-ui/pro';
...
const List = (props) => {
  const {
    ...
    saveList = (e) => e,
    lineDelete = (e) => e,
    // onUploadSuccessList=e=>e,
    // onAttachmentsChangeList = (e) => e,
  } = props;
  ...
  const columns = [
    ...
    },
    {
      ...
      editor: (record) => (
        <NumberField
          min={0}
          numberGrouping
          precision={!isNil(record.uomPrecision) ? record.uomPrecision : 10}
          onBlur={() => {
    ...
    },
    {
      ...
      //     onUploadSuccess={()=>onUploadSuccessList()}
      //     openUploadModal={() => onAttachmentsChangeList(record, value)}
      //   />
      // ),
    },
    {
