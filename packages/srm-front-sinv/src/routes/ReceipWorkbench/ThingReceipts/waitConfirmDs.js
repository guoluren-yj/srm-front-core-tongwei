...
const waitConfirmTableDS = () => ({
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'string',
      label: intl
        .get('sinv.receiptExecution.model.receipt.orderTypeName.displayTrxHeaderAndLineNum')
        .d('收货单号'),
    },
    {
      name: 'nodeConfigName',
  ...
  transport: {
    read: ({ data }) => {
      ...
      return {
        url: `${SRM_SPUC}/v1/${organizationId}/sinv/rcv/trx/workbench/confirm/query`,
...
const waitConfirmAsnTableDS = () => ({
  ...
  transport: {
    read: ({ data }) => {
      ...
      const queryData = filterNullValueObject({ ...params, ...other });
      return {
        url: `${SRM_SPUC}/v1/${organizationId}/sinv/rcv/trx/workbench/confirm/line-query`,
        method: 'GET',
        data: queryData,
      };
    },
...
export { waitConfirmTableDS, waitConfirmAsnTableDS };
