...
export default class MaterialInfoList extends PureComponent {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        title: intl.get(`${commonModelPrompt}.quantity`).d('订单数量'),
        dataIndex: 'quantity',
        width: 100,
        render: (value) => showBigNumber(value),
      },
      {
        title: intl.get(`${commonModelPrompt}.canShipQuantity`).d('可发货'),
      ...
      {
        title: intl.get(`${commonModelPrompt}.theShipQuantity`).d('本次发货'),
      ...
      {
        title: intl.get(`${commonModelPrompt}.packageQuantity`).d('件数'),
        dataIndex: 'packageQuantity',
        width: 80,
        render: (value) => showBigNumber(value),
      },
      {
        title: intl.get(`${commonModelPrompt}.remainderQuantity`).d('尾数'),
        dataIndex: 'remainderQuantity',
        width: 80,
        render: (value) => showBigNumber(value),
      },
      {
        title: intl.get(`${commonModelPrompt}.lotNum`).d('批次号'),
        dataIndex: 'lotNum',
        width: 150,
      },
      {
        title: intl.get(`${commonModelPrompt}.productionDate`).d('生产日期'),
      ...
      {
        title: intl.get(`${commonModelPrompt}.serialNum`).d('序列号'),
        dataIndex: 'serialNum',
        width: 120,
      },
      {
        title: intl.get(`${commonModelPrompt}.invoiceNum`).d('发票号'),
      ...
      {
        title: intl.get(`${commonModelPrompt}.displayLineLocationNum`).d('发运号'),
      ...
      {
        title: intl.get(`${commonModelPrompt}.neededDate`).d('需求日期'),
      ...
      {
        title: intl.get(`${commonModelPrompt}.product.number`).d('商品编码'),
        dataIndex: 'productNum',
        width: 100,
      },
      {
        title: intl.get(`${commonModelPrompt}.product.name`).d('商品名称'),
        dataIndex: 'productName',
        width: 100,
      },
      {
        title: intl.get(`${commonModelPrompt}.catalog.name`).d('商品目录'),
        dataIndex: 'catalogName',
        width: 100,
      },
      {
        title: intl.get(`${commonModelPrompt}.purchaseRemark`).d('采购方行备注'),
      ...
      {
        title: intl.get(`${commonModelPrompt}.suppliersRemark`).d('供应商备注'),
        dataIndex: 'supplierRemark',
        width: 150,
      },
      {
        title: intl.get(`${commonModelPrompt}.lineAttachmentUuid`).d('行附件'),
