...
const Index = function Index({
  ...
  const renderWholeTable = () => {
    ...
    return customizeTable(
      {
        code: 'SMDM_ITEM_PENDING_FEEDBACK.LIST',
      },
      <SearchBarTable
        style={{ maxHeight: 'calc(100% - 22px)' }}
        searchCode="SMDM_ITEM_PENDING_FEEDBACK.SEARCH"
        dataSet={wholeListDs}
        columns={columns}
        data={[]}
        key="wholePending"
  ...
  const renderLineTable = () => {
    ...
    return customizeTable(
      {
        code: 'SMDM_ITEM_PENDING_FEEDBACK.LINE_LIST',
      },
      <SearchBarTable
        style={{ maxHeight: 'calc(100% - 22px)' }}
        searchCode="SMDM_ITEM_PENDING_FEEDBACK.LINE_SEARCH"
        dataSet={lineListDs}
        columns={lineColumns}
        data={[]}
        key="linePending"
