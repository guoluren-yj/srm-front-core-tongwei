          ...
          <Form>
            <Row>
              <Col span={24}>
                ...
                >
                  {getFieldDecorator('accountSubjectNum', {
                    initialValue: accountSubjectNum,
                    rules: [
                      {
                        required: true,
            ...
            <Row>
              <Col span={24}>
                <FormItem
                  {...formLayout}
                  label={intl.get('smdm.common.model.project.name').d('科目名称')}
                >
                  {getFieldDecorator('accountSubjectName', {
                    initialValue: accountSubjectName,
                    rules: [
                      {
                        required: true,
                        message: intl.get('hzero.common.validation.notNull', {
                          name: intl.get(`smdm.common.model.project.name`).d('科目名称'),
                        }),
                      },
                      {
                        max: 120,
