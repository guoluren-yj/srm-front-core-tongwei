...
// 导出树形列表input组件
export const TreeInput = ({ TreeInputProps, initialValue, setTreeInputData }) => {
  ...
  const submit = useCallback(
    (data) => {
      const { taxItemSimpleName, taxItemName, taxItemCode, parentId, taxItemId } = data;
      TreeInputProps.form.setFieldsValue({
        taxItemSimpleName,
        taxItemName,
      });
      setTreeInputData({
