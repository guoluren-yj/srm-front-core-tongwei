...
export default class ListTable extends Component {
  ...
  render() {
    ...
    const columns = [
      {
        title: intl.get(`smdm.uomType.model.uomType.uomTypeCode`).d('单位类别代码'),
        dataIndex: 'uomTypeCode',
        width: 150,
      },
      {
        title: intl.get(`smdm.uomType.model.uomType.uomTypeName`).d('单位类别名称'),
        dataIndex: 'uomTypeName',
        width: 150,
      },
      {
        title: intl.get(`smdm.uomType.model.uomType.baseUomCode`).d('基本单位代码'),
        dataIndex: 'baseUomCode',
        width: 150,
      },
      {
        title: intl.get(`smdm.uomType.model.uomType.baseUomName`).d('基本单位名称'),
