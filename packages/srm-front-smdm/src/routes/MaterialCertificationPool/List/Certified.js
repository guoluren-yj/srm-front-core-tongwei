...
const Index = function Index({
  ...
  const renderWholeTable = () => {
    ...
    return customizeTable(
      {
        code: 'SMDM.ITEM_CERTIFIED.LIST',
      },
      <SearchBarTable
        style={{ maxHeight: 'calc(100% - 22px)' }}
        searchCode="SMDM.ITEM_CERTIFIED.SEARCH"
        dataSet={wholeListDs}
        ...
        searchBarConfig={{
          ...
          right: {
            render: () => (
              <ViewFilter updateType={updateType} type={type} sourceType="certifiedType" />
            ),
          },
          fieldProps: {
  ...
  const renderLineTable = () => {
    ...
    return customizeTable(
      {
        code: 'SMDM.ITEM_CERTIFIED.LINE_LIST',
      },
      <SearchBarTable
        style={{ maxHeight: 'calc(100% - 22px)' }}
        searchCode="SMDM.ITEM_CERTIFIED.LINE_SEARCH"
        dataSet={linelListDs}
        columns={lineColumns}
        key="certifiedLine"
        data={[]}
