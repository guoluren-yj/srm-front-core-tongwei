 ...
 * @LastEditors: yanglin
 * @LastEditTime: 2022-10-31 19:55:15
 */
...
const Index = function Index(props) {
  ...
  const pubPathFlag = path.includes('/pub/smdm/material-certification-pool/read');

  return (
    <StoreProvider
      {...{ ...props, itemAuthReqHeaderId, node, readOnly: true, pubPathFlag, source, cuxDom }}
    >
