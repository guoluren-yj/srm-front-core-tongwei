  ...
  transport: {
    read: ({ data: { params = {}, tplInfo = {} } }) => {
      ...
      const param = {
        ...
        cuszTplPageCode,
        customizeUnitCode:
          'SIEC.PCN_MANAGEWORK_BENCH_DETAI.WORKS.HEADER,SIEC.PCN_MANAGEWORK_BENCH_DETAI.WORKS.ATTACHMENT',
      };
...
const pcnChangeInfoDS = (cuxUpdate, formDs) => ({
  ...
  fields: [
    ...
    //   name: 'industryCategoryId',
    //   type: 'string',
    //   bind: 'industryCategoryLOV.categoryId',
    // },
    {
      name: 'categoryName',
      type: 'string',
  ...
  transport: {
    read: ({ data: { params = {}, tplInfo = {} } }) => {
      ...
      const param = {
        ...
        cuszTplStageCode,
        cuszTplPageCode,
        customizeUnitCode: 'SIEC.PCN_MANAGEWORK_BENCH_DETAI.WORKS.LINE',
      };
      if (pcnHeaderId) {
        return {
