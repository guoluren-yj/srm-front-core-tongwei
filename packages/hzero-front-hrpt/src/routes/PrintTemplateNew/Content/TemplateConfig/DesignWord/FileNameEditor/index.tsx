import React, { useMemo, useState, useRef, useContext, useImperativeHandle, useEffect } from 'react';
...
const FileNameEditor = observer(({ templateFields, contentRef, templateName }) => {
