...
@DelCache({ cacheKey: '/small/mall-protocol-management/list3' })
@cacheComponent({ cacheKey: '/small/mall-protocol-management/list3' })
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <FormItem label={intl.get('small.common.model.createdByName').d('创建人')} {...formLayout}>
          {getFieldDecorator('createdByIds', {
            initialValue: dataValue.createdById,
          })(
            <MultipleLov
