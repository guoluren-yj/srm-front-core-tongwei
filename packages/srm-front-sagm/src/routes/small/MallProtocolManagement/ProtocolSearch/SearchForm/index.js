...
@DelCache({ cacheKey: '/small/mall-protocol-management/list5' })
@cacheComponent({ cacheKey: '/small/mall-protocol-management/list5' })
            ...
            <Col span={6}>
              ...
              >
                ...
                {getFieldDecorator('supplierCompanyId', {
                  initialValue: dataValue.supplierCompanyId,
                })(
                  <Lov
                    allowClear
