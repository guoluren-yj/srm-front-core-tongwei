  ...
  render() {
    ...
    return (
      <Modal
        ...
        title={intl.get('spcm.common.button.approval').d('审批通过')}
        onCancel={this.handleCancel}
        visible={visible}
      >
        <Form>
          <FormItem
            label={intl.get(`spcm.contractApproval.view.message.approvalOpinion`).d('审批意见')}
            labelCol={{ span: 7 }}
            wrapperCol={{ span: 17 }}
          >
              ...
              rules: [
                {
                  ...
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl
                      .get(`spcm.contractApproval.view.message.approvalOpinion`)
                      .d('审批意见'),
                  }),
                },
              ],
