 ...
 * @Date: 2019-05-23
 * @LastEditTime: 2022-12-01 17:45:17
...
export default class Search extends Component {
  ...
  render() {
    ...
    const { syncStatusResults = [] } = enumObj;
        ...
        <Row {...SEARCH_FORM_ROW_LAYOUT}>
          <Col span={18}>
            ...
            <Row style={{ display: expandForm ? 'block' : 'none' }} {...SEARCH_FORM_ROW_LAYOUT}>
              ...
              <Col span={8}>
                <Form.Item
                  label={intl.get('spcm.common.model.archiveDateFrom').d('归档日期从')}
                  {...formItemLayout}
                >
                  {getFieldDecorator('archiveDateFrom')(
                    <DatePicker
                      format={DEFAULT_DATE_FORMAT}
                      placeholder=""
                      disabledDate={(currentDate) =>
                        getFieldValue('archiveDateTo') &&
                        moment(getFieldValue('archiveDateTo')).isBefore(currentDate, 'day')
                      }
                    />
                  )}
                </Form.Item>
              ...
              <Col span={8}>
                <Form.Item
                  label={intl.get('spcm.common.model.archiveDateTo').d('归档日期至')}
                  {...formItemLayout}
                >
                  {getFieldDecorator('archiveDateTo')(
                    <DatePicker
                      format={DEFAULT_DATE_FORMAT}
                      placeholder=""
                      disabledDate={(currentDate) =>
                        getFieldValue('archiveDateFrom') &&
                        moment(getFieldValue('archiveDateFrom')).isAfter(currentDate, 'day')
                      }
                    />
                  )}
                </Form.Item>
              ...
              <Col span={8}>
                ...
                >
                  {getFieldDecorator('remainDate')(
                    <InputNumber maxLength={15} min={0} precision={0} />
                  )}
                </Form.Item>
              </Col>
              <Col span={8}>
              ...
              <Col span={8}>
                ...
                >
                  {getFieldDecorator('syncStatusResult')(
                    <Select style={{ width: '100%' }} allowClear>
                      {syncStatusResults.map((n) => (
                        <Option key={n.value} value={n.value}>
                          {n.meaning}
                        </Option>
                      ))}
