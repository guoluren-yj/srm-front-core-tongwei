...
export default {
  ...
  state: {
    ...
    directoryStrategyList: [], // 文件目录策略值集
  },

  effects: {
    * init(_, { put, call }) {
      const { prefixStrategyList, microsoftEndpointList, radioTypeList, directoryStrategyList } = yield getResponse(
        call(queryMapIdpValue, {
          ...
          directoryStrategyList: 'HFLE.FILE_DIRECTORY_STRATEGY',
        })
      );
