...
import { getDateTimeFormat, isTenantRoleLevel, getCurrentTenant } from 'utils/utils';
import {
  DEBOUNCE_TIME,
                    ...
                    rules: [
                      {
                        ...
                        message: intl.get('hzero.common.validation.notNull', {
                          name: intl
                            .get('hfile.fileAggregate.model.fileAggregate.tenantId')
                            .d('租户'),
                        }),
                      },
                    ],
                      ...
                      rules: [
                        {
                          required: true,
                          message: intl.get('hzero.common.validation.notNull', {
                            name: intl.get('hzero.common.time.creation.from').d('创建日期从'),
                          }),
                        },
                      ],
                    })(
