...
export async function fetchConfigList(params) {
  return request(`${SRM_SPCT}/v1/${organizationId}/configs`, {
    method: 'GET',
    query: params,
  });
}
...
export async function fetchConfigDetail(params) {
  return request(`${SRM_SPCT}/v1/${organizationId}/configs/${params.configId}`, {
    method: 'GET',
    query: params,
  });
}
...
export async function fetchCert(params) {
  return request(`${SRM_SPCT}/v1/${organizationId}/configs/query-cert`, {
    method: 'POST',
    query: params,
  });
}
...
export async function deleteCert(params) {
  return request(`${SRM_SPCT}/v1/${organizationId}/configs/clear-cert`, {
    method: 'POST',
    body: params,
  });
}
