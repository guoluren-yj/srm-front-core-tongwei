...
export async function fetchOrderList(params) {
  return request(`${SRM_SPCT}/v1/${organizationId}/refund-orders`, {
    method: 'GET',
    query: params,
  });
}
...
export async function getOrderDetail(params) {
  ...
  return request(`${SRM_SPCT}/v1/${organizationId}/refund-orders/${refundOrderId}`, {
    method: 'GET',
  });
}
...
export async function refuseOrder(params) {
  ...
  return request(`${SRM_SPCT}/v1/${organizationId}/refund-orders/refused`, {
    method: 'PUT',
    body: req,
  });
}
...
export async function confirmOrder(params) {
  ...
  switch (channelCode) {
    case 'alipay':
      return request(`${SRM_SPCT}/v1/${organizationId}/alipay/refund`, {
        method: 'POST',
        body: req,
      });
    case 'wxpay':
      return request(`${SRM_SPCT}/v1/${organizationId}/wxpay/refund`, {
        method: 'POST',
        body: req,
      });
    case 'unionpay':
      return request(`${SRM_SPCT}/v1/${organizationId}/unionpay/refund`, {
        method: 'POST',
        body: req,
      });
    default:
