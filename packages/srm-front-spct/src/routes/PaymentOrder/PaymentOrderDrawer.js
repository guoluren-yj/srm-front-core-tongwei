            ...
            <Row>
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  ...
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.paymentOrderNum')
                    .d('支付订单号')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.merchantOrderNum')
                    .d('商户订单号')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl.get('spct.paymentOrder.model.paymentOrder.channelCode').d('支付渠道')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.paymentSubject')
                    .d('订单标题')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl.get('spct.paymentOrder.model.paymentOrder.currencyCode').d('币种')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl.get('spct.paymentOrder.model.paymentOrder.paymentAmount').d('金额')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl.get('spct.paymentOrder.model.paymentOrder.status').d('状态')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.channelTradeNo')
                    .d('支付流水号')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.paymentDatetime')
                    .d('支付成功时间')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.paymentDescription')
                    .d('支付订单描述')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.paymentCustomer')
                    .d('支付用户')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.returnUrl')
                    .d('页面回调地址')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.cancelReason')
                    .d('订单撤销原因')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl.get('spct.paymentOrder.model.paymentOrder.expireTime').d('到期时间')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.channelRespCode')
                    .d('支付消息码')}
                >
              ...
              <Col {...FORM_COL_2_LAYOUT}>
                <FormItem
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('spct.paymentOrder.model.paymentOrder.channelRespMsg')
                    .d('支付消息')}
                >
