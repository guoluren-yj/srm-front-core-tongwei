...
export async function queryAttachmentList(params) {
  const { organizationId, supplierProserviceId, ...otherParams } = params;
  return request(
    `${SRM_SSLM}/v1/${organizationId}/supplier-proservice-atts/${supplierProserviceId}`,
    {
      method: 'GET',
      query: otherParams,
    }
...
export async function onAttachmentRemove(params) {
  return request(`${SRM_SSLM}/v1/${params.organizationId}/investg-proservice-atts/batch-remove`, {
    method: 'DELETE',
