...
const btnsPermissions = [
  {
    name: 'print',
    meaning: '推荐申请单查看-打印',
    code: `srm.partner.suplier-lifecycle.management.ps.button.recommend.print`,
  },
  {
    name: 'delete',
    meaning: '推荐申请单-删除',
    code: `srm.partner.suplier-lifecycle.management.ps.button.recommend.delete`,
  },
  {
    name: 'cancel',
    meaning: '推荐申请单-废弃',
    code: `srm.partner.suplier-lifecycle.management.ps.button.recommend.obsolete`,
  },
];
...
const HeaderBtns = ({
  ...
  return customizeBtnGroup(
    {
      code: 'SSLM.SUPPLIER_LIFE_MANAGE.RECOMMEND_HEADER_BTNGROUP',
      pro: true,
    },
    <DynamicButtons
      buttons={buttons}
      ...
      unitCode="SSLM.SUPPLIER_LIFE_MANAGE.RECOMMEND_HEADER_BTNGROUP"
    />
  );
};
