      ...
      <Form className="ued-edit-form" custLoading={custLoading}>
        <Row gutter={48} className="read-row">
          <Col span={8}>
            <FormItem
              {...formItemLayout}
              label={intl
                .get(`sslm.commonApplication.model.commonApplication.applyNum`)
                .d('申请单号')}
            >
              {getFieldDecorator('recommendNumber')(<span />)}
            </FormItem>
          </Col>
          <Col span={8}>
            <FormItem
        ...
        <Row gutter={48} className="read-row">
          <Col span={8}>
            <FormItem
              {...formItemLayout}
              label={intl.get(`sslm.commonApplication.model.recommend.remark`).d('说明')}
            >
