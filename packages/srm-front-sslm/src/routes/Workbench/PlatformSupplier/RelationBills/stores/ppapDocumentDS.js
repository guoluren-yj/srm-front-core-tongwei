...
import Process from '@/routes/SupplierLife/SupplierRelatedDoc/Components/Process';
import ExecuteProcess from '@/routes/SupplierLife/SupplierRelatedDoc/Components/ExecuteProcess';

const organizationId = getCurrentOrganizationId();

const ppapDocumentDS = params => {
  return {
    pageSize: 20,
    selection: false,
      ...
      read: ({ data }) => {
        ...
        return {
          ...
          data: filterNullValueObject({
            ...
            action: 'ALL',
            customizeUnitCode:
              'SSLM.SUPPLIER_WORKBENCH_RELATED_DOC.PPAP_DOCUMENT,SSLM.SUPPLIER_WORKBENCH_RELATED_DOC.PPAP_SEARCH_BAR',
            ...data,
          }),
        };
      },
