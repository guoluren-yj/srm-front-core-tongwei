...
@cacheComponent({ cacheKey: '/sslm/archive-filled' })
export default class Search extends Component {
  ...
  render() {
    ...
    return customizeFilterForm(
      {
        code: 'SSLM.ARCHIVE_FILLED_LIST.FILTER', // 单元编码，必传
        form,
        ...
        <Row gutter={24}>
          <Col span={18}>
            ...
            <Row style={{ display: !display ? 'none' : 'block' }}>
              ...
              <Col span={8}>
                <Form.Item
                  label={intl.get(`sslm.common.model.archive.evaluation.dimension`).d('考评维度')}
                  {...formLayout}
                >
              ...
              <Col span={8}>
                <Form.Item
                  label={intl.get(`sslm.common.model.archive.evaluation.charger`).d('考评负责人')}
                  {...formLayout}
                >
              ...
              <Col span={8}>
                <Form.Item
                  label={intl.get(`sslm.common.model.archive.evaluation.evalTplName`).d('考评模板')}
                  {...formLayout}
                >
              ...
              <Col span={8}>
                ...
                >
                  {getFieldDecorator('evalStatus')(
                    <ValueList lovCode="SSLM.KPI_EVAL_STATUS" allowClear />
                  )}
                </Form.Item>
              </Col>
            </Row>
