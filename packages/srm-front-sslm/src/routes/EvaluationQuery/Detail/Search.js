  ...
  render() {
    ...
    const dynamicItem = {
      ...
      'SU+CA': (
        <Col span={8}>
          <Form.Item
            label={intl.get(`sslm.evaluationQuery.model.purchase.category`).d('采购品类')}
            {...formLayout}
          >
      ...
      'SU+IT': (
        <Col span={8}>
          <Form.Item
            label={intl.get(`sslm.evaluationQuery.model.material.item`).d('物料')}
            {...formLayout}
          >
          ...
          <Row type="flex" justify="end" gutter={24}>
            <Col span={18}>
              <Row type="flex" justify="end">
                <Col span={8}>
                  <Form.Item
                    label={intl.get(`sslm.evaluationQuery.model.item.supplier`).d('供应商')}
                    {...formLayout}
                  >
            ...
            <Col
              ...
              style={{ textAlign: 'right', width: 180, paddingRight: 0 }}
            >
              <Form.Item>
