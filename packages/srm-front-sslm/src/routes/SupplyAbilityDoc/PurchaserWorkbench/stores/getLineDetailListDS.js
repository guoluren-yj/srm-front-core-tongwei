...
const getLineDetailAllDs = () => ({
  ...
  transport: {
    read: ({ params }) => {
      return {
        url: `${SRM_SSLM}/v1/${organizationId}/supply-ability-change-lines/all`,
        method: 'POST',
        params: {
          ...params,
          customizeUnitCode:
            'SUPPLY_ABILITY_DOC.PURCHASER_DETAIL_LIST.ALL_SEARCH,SUPPLY_ABILITY_DOC.PURCHASER_DETAIL_LIST.ALL_LIST',
        },
      };
    },
  },
