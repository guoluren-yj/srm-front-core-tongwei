...
const AttachmentModal = ({ dataSet, isEdit, custLoading, customizeTable, itemLineRecord }) => {
  // 新增附件
  ...
  const handleOk = fileList => {
    ...
    const { changeReqId, abilityLineId } = itemLineRecord.get(['changeReqId', 'abilityLineId']);
