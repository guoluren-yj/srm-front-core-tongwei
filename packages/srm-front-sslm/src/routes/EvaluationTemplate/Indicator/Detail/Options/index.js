...
export default class Editor extends PureComponent {
  constructor(props) {
    ...
    // 方法注册
    ['cancel', 'onTableChange', 'handleFetchOptionsList'].forEach((method) => {
  ...
  /**
   * handleFetchOptionsList - 查询公式列表数据
      ...
      <Drawer {...drawerProps}>
        <Row>
          ...
          <Col span={12}>
            <Row>
              <Col span={6}>
                {intl.get(`spfm.supplierKpiIndicator.model.suKpiIn.indicatorName`).d('指标名称')}:
              </Col>
