...
// import { forEach, isBoolean, isNumber, isUndefined, map, find, omit } from 'lodash';
...
// import { getCurrentOrganizationId, getCurrentRole, getResponse, resolveRequire, getCurrentTenant, getUserOrganizationId } from 'utils/utils';
// import {
//   queryCount,
//   queryMenu,
//   queryPromptLocale,
...
// import getReDevRouters from '../utils/getReDevRouters';

// /**
//  * 替换路由为二开路由
//  * @param {Object} routerConfig 路由对象
//  */
// function replaceRouter (app, routerConfig) {
//   const replaceRouterDatas = getReDevRouters(app);
//   //  const mergeRouter = {...routerConfig, ...reorganizeRouters(find(replaceRouterDatas, {tenantNum: getCurrentTenant().tenantNum}))};
//    const mergeRouter = {...routerConfig, ...reorganizeRouters(find(replaceRouterDatas, function(data) {return data.tenantNum && data.tenantNum.split(',').includes(getCurrentTenant().tenantNum)}))};
//    const omitKeys = [];
//    Object.entries(mergeRouter).forEach(([key, value]) => {
//      if(value.FilterSupplier && getUserOrganizationId() !== getCurrentOrganizationId()) {
//       omitKeys.push(key);
//      }
//    })
//    const filterRouter = omit(mergeRouter, omitKeys);
//    return filterRouter;
// }

// /**
//  * 重组二开路由结构
//  * @param {Object} routerData 二开路由数据
//  */
// function reorganizeRouters (routerData = {}) {
//   const data = {};
//   Object.values(routerData.routers || []).forEach(d => {
//     Object.assign(data, { [d.coverPath]: { ...omit(d, 'coverPath') } });
//   });
//   return data;
// }
...
//         ];
//         const [hzeroUILocale, promptLocale] = yield all(promiseAllLocale);
...
//         });
//         moment.locale(resolveRequire(hzeroUILocale).locale); // TODO: LocaleProvider 中会设置 moment.locale，为何突然不起作用了?
...
//         const routerConfig = replaceRouter(app || window.dvaApp, getWrapperRouterData(app || window.dvaApp));
//         const routerData = {};
